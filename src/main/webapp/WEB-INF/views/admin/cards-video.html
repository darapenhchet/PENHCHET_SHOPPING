...
<!-- Mirrored from teamfox.co/themes/pleasure/app/admin1/cards-video.html by HTTrack Website Copier/3.x [XR&CO'2013], Thu, 25 Jun 2015 06:31:58 GMT -->
<head>
	<meta charset="utf-8">
	<meta http-equiv="X-UA-Compatible" content="IE=edge">

	<title>PLEASURE - Video Cards</title>
	...
	<!-- BEGIN PLUGINS CSS -->
	<link rel="stylesheet" href="../../assets/globals/plugins/video.js/dist/video-js/video-js.min.css">
	<link rel="stylesheet" href="../../assets/globals/plugins/video.js/themes/sublime/videojs-sublime-skin.min.css">
...
<body>
	...
	<div class="content">
			...
			<div class="row">
				...
				<div class="col-sm-6">
					<ol class="breadcrumb">
						...
						<li><a href="#" class="active">Video Cards</a></li>
					</ol>
				</div><!--.col-->
			</div><!--.row-->
		</div><!--.page-header-->
		...
		<div class="row">
			<div class="col-md-6">
				<div class="card card-video card-player-blue">
					...
					<div class="card-heading">
						<video id="videojs1" class="video-js video-js-responsive vjs-default-skin vjs-big-play-centered" controls preload="auto" poster="../../assets/globals/img/picjumbo/10.jpg" data-width="640" data-height="264">
			...
			<div class="col-md-6">
				<div class="card card-video card-player-red">

					<div class="card-heading">
						<video id="videojs2" class="video-js video-js-responsive vjs-default-skin vjs-big-play-centered" controls preload="auto" poster="../../assets/globals/img/picjumbo/16.jpg">
							<source src="http://video-js.zencoder.com/oceans-clip.mp4" type="video/mp4">
							<source src="http://video-js.zencoder.com/oceans-clip.webm" type="video/webm">
							<source src="http://video-js.zencoder.com/oceans-clip.ogv" type="video/ogg">
							<p class="vjs-no-js">To view this video please enable JavaScript, and consider upgrading to a web browser that <a href="http://videojs.com/html5-video-support/" target="_blank">supports HTML5 video</a></p>
		...
		<div class="row">
			<div class="col-md-4">
				<div class="card card-video card-video-modal card-player-purple">
					<div class="bg-image sample-bg-image7"></div>
			...
			<div class="col-md-4">
				<div class="card card-video card-video-modal card-player-yellow">
					<div class="bg-image sample-bg-image11"></div>

					<div class="card-body">
						<a href="#" class="play-button-container" data-toggle="modal" data-target="#videojs-modal-2">
							<div class="play-button"></div>
						</a>
					</div><!--.card-body-->
					...
					<!-- In order to use different colors, write modal codes in card window -->
					<!-- If you want the video starts automatically after modal window shown, use data-modal-autoplay="true" in video markup -->
					<div class="modal fade video-js-modal" id="videojs-modal-2" tabindex="-1" role="dialog" aria-hidden="true">
						<div class="modal-dialog">
							<div class="modal-content">
								<div class="modal-body">
									<video id="videojs4" class="video-js video-js-responsive vjs-default-skin vjs-big-play-centered" controls preload="none" poster="../../assets/globals/img/picjumbo/2.jpg" data-modal-autoplay="true">
										<source src="http://video-js.zencoder.com/oceans-clip.mp4" type="video/mp4">
										<source src="http://video-js.zencoder.com/oceans-clip.webm" type="video/webm">
										<source src="http://video-js.zencoder.com/oceans-clip.ogv" type="video/ogg">
										<p class="vjs-no-js">To view this video please enable JavaScript, and consider upgrading to a web browser that <a href="http://videojs.com/html5-video-support/" target="_blank">supports HTML5 video</a></p>
			...
			<div class="col-md-4">
				<div class="card card-video card-video-modal card-player-teal">
					<div class="bg-image sample-bg-image5"></div>

					<div class="card-body">
						<a href="#" class="play-button-container" data-toggle="modal" data-target="#videojs-modal-3">
							<div class="play-button"></div>
						</a>
					</div><!--.card-body-->
					...
					<!-- In order to use different colors, write modal codes in card window -->
					<!-- If you want the video starts automatically after modal window shown, use data-modal-autoplay="true" in video markup -->
					<div class="modal fade video-js-modal" id="videojs-modal-3" tabindex="-1" role="dialog" aria-hidden="true">
						<div class="modal-dialog">
							<div class="modal-content">
								<div class="modal-body">
									<video id="videojs5" class="video-js video-js-responsive vjs-default-skin vjs-big-play-centered" controls preload="none" poster="../../assets/globals/img/picjumbo/5.jpg">
										<source src="http://video-js.zencoder.com/oceans-clip.mp4" type="video/mp4">
										<source src="http://video-js.zencoder.com/oceans-clip.webm" type="video/webm">
										<source src="http://video-js.zencoder.com/oceans-clip.ogv" type="video/ogg">
										<p class="vjs-no-js">To view this video please enable JavaScript, and consider upgrading to a web browser that <a href="http://videojs.com/html5-video-support/" target="_blank">supports HTML5 video</a></p>
		...
		<div class="row full-video card-player-light-blue no-gutters">
			<div class="col-md-8">
				<video id="playlist" class="video-js vjs-default-skin vjs-big-play-centered" controls data-setup="" ></video>
			</div><!--.col-md-8-->

			<div class="col-md-4">
				<div class="playlist-heading">Web Development Tutorials</div>

				<ul class="video-playlist" style="max-height: 480px; overflow-y: auto;">
				</ul>
			</div><!--.col-md-4-->
		</div><!--.row-->
		...
		<div class="row">
			<div class="col-md-6">
				<div class="card card-video card-player-orange">
					...
					<div class="card-heading">
						...
						<video id="youtube" class="video-js video-js-responsive vjs-default-skin vjs-big-play-centered" controls preload="none" data-width="640" data-height="360" data-setup='{ "techOrder": ["youtube"], "src": "http://www.youtube.com/watch?v=Q8TXgCzxEnw" }'></video>
			...
			<div class="col-md-6">
				<div class="card card-video">
					...
					<div class="card-heading">
						<video id="videojs6" class="video-js video-js-responsive vjs-sublime-skin" controls preload="auto" poster="../../assets/globals/img/picjumbo/16.jpg">
							<source src="http://video-js.zencoder.com/oceans-clip.mp4" type="video/mp4">
							<source src="http://video-js.zencoder.com/oceans-clip.webm" type="video/webm">
							<source src="http://video-js.zencoder.com/oceans-clip.ogv" type="video/ogg">
						</video>
			...
			<ul>
				...
				<li>
					...
					<ul class="child-menu">
						...
						<li data-open-after="true"><a href="cards-video.html">Video Cards</a></li>
	...
	<!-- BEGIN PLUGINS AREA -->
	<script src="../../assets/globals/plugins/video.js/dist/video-js/video.js"></script>
	<script src="../../assets/globals/plugins/video.js/plugins/playlist/videojs-playlists.min.js"></script>
	<script src="../../assets/globals/plugins/video.js/plugins/youtube/youtube.js"></script>
	<!-- END PLUGINS AREA -->

	<!-- PLUGINS INITIALIZATION AND SETTINGS -->
	<script src="../../assets/globals/scripts/widget-video.js"></script>
...
<!-- Mirrored from teamfox.co/themes/pleasure/app/admin1/cards-video.html by HTTrack Website Copier/3.x [XR&CO'2013], Thu, 25 Jun 2015 06:32:28 GMT -->
</html>