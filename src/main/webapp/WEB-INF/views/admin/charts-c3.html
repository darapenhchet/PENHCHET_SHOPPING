...
<!-- Mirrored from teamfox.co/themes/pleasure/app/admin1/charts-c3.html by HTTrack Website Copier/3.x [XR&CO'2013], Thu, 25 Jun 2015 06:37:47 GMT -->
<head>
	<meta charset="utf-8">
	<meta http-equiv="X-UA-Compatible" content="IE=edge">

	<title>PLEASURE - C3 Charts</title>
	...
	<!-- BEGIN PLUGINS CSS -->
	<link rel="stylesheet" href="../../assets/globals/plugins/c3js-chart/c3.min.css">
...
<body>
	...
	<div class="content">
		...
		<div class="page-header full-content bg-deep-purple">
			<div class="row">
				<div class="col-sm-6">
					<h1>C3 Charts <small>short description</small></h1>
				</div><!--.col-->
				<div class="col-sm-6">
					<ol class="breadcrumb">
						<li><a href="#"><i class="ion-home"></i></a></li>
						<li><a href="#">Charts</a></li>
						<li><a href="#" class="active">C3 Charts</a></li>
					</ol>
				</div><!--.col-->
			</div><!--.row-->
		</div><!--.page-header-->
			...
			<div class="col-md-12">
				...
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>SIMPLE XY LINE CHART</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">
						<div class="c3-line c3-charts"></div>
					</div><!--.panel-body-->
				</div><!--.panel-->
		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class="panel">
					...
					<div class="panel-body">
						<div class="c3-bar c3-charts"></div>
					</div><!--.panel-body-->
				</div><!--.panel-->
		...
		<div class="row">
			...
			<div class="col-md-6">
				...
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>DONUT CHART</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">
						<div class="c3-donut c3-charts"></div>
					</div><!--.panel-body-->
				</div><!--.panel-->
		...
		<div class="row">
			<div class="col-md-6">
				...
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>GAUGE CHART</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">
						<div class="c3-gauge c3-charts"></div>
					</div><!--.panel-body-->
				</div><!--.panel-->
			...
			<div class="col-md-6">
				...
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>SPLINE CHART</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">
						<div class="c3-spline c3-charts"></div>
					</div><!--.panel-body-->
				</div><!--.panel-->
		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>COMBINATION CHART</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">
						<div class="c3-combination c3-charts"></div>
					</div><!--.panel-body-->
				</div><!--.panel-->
		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>AREA CHART</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">
						<div class="c3-area-chart c3-charts"></div>
					</div><!--.panel-body-->
				</div><!--.panel-->
		...
		<div class="menu-layer">
			<ul>
				...
				<li>
					...
					<ul class="child-menu">
						<li data-open-after="true"><a href="charts-c3.html">C3 Charts</a></li>
...
<!-- Mirrored from teamfox.co/themes/pleasure/app/admin1/charts-c3.html by HTTrack Website Copier/3.x [XR&CO'2013], Thu, 25 Jun 2015 06:37:52 GMT -->
</html>