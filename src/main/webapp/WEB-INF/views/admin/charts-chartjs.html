...
<!-- Mirrored from teamfox.co/themes/pleasure/app/admin1/charts-chartjs.html by HTTrack Website Copier/3.x [XR&CO'2013], Thu, 25 Jun 2015 06:37:52 GMT -->
<head>
	<meta charset="utf-8">
	<meta http-equiv="X-UA-Compatible" content="IE=edge">

	<title>PLEASURE - ChartJS</title>
...
<body>
	...
	<div class="content">
		...
		<div class="page-header full-content bg-deep-purple">
			<div class="row">
				<div class="col-sm-6">
					<h1>ChartJS <small>short description</small></h1>
				</div><!--.col-->
				<div class="col-sm-6">
					<ol class="breadcrumb">
						<li><a href="#"><i class="ion-home"></i></a></li>
						<li><a href="#">Charts</a></li>
						<li><a href="#" class="active">ChartJS</a></li>
					</ol>
				</div><!--.col-->
			</div><!--.row-->
		</div><!--.page-header-->
		...
		<div class="row">
			<div class="col-md-6">
				...
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>LINE CHART</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">
						<canvas class="chartjs-line chartjs-charts" width="320" height="280"></canvas>
					</div><!--.panel-body-->
				</div><!--.panel-->
			...
			<div class="col-md-6">
				...
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>BAR CHART</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">
						<canvas class="chartjs-bar chartjs-charts" width="320" height="280"></canvas>
					</div><!--.panel-body-->
				</div><!--.panel-->
		...
		<div class="row">
			<div class="col-md-6">
				...
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>RADAR CHART</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">
						<canvas class="chartjs-radar chartjs-charts" width="320" height="280"></canvas>
					</div><!--.panel-body-->
				</div><!--.panel-->
			...
			<div class="col-md-6">
				...
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>POLAR AREA CHART</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">
						<canvas class="chartjs-polar chartjs-charts" width="320" height="280"></canvas>
					</div><!--.panel-body-->
				</div><!--.panel-->
		...
		<div class="row">
			<div class="col-md-6">
				...
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>PIE CHART</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">
						<canvas class="chartjs-pie chartjs-charts" width="320" height="280"></canvas>
					</div><!--.panel-body-->
				</div><!--.panel-->
			...
			<div class="col-md-6">
				...
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>DOUGHNUT CHART</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">
						<canvas class="chartjs-doughnut chartjs-charts" width="320" height="280"></canvas>
					</div><!--.panel-body-->
				</div><!--.panel-->
			...
			<ul>
				...
				<li>
					...
					<ul class="child-menu">
						...
						<li data-open-after="true"><a href="charts-chartjs.html">Chart JS</a></li>
	...
	<script src="../../assets/globals/plugins/chartjs/Chart.min.js"></script>
	<!-- END PLUGINS AREA -->

	<!-- PLUGINS INITIALIZATION AND SETTINGS -->
	<script src="../../assets/globals/scripts/charts-chartjs.js"></script>
...
<!-- Mirrored from teamfox.co/themes/pleasure/app/admin1/charts-chartjs.html by HTTrack Website Copier/3.x [XR&CO'2013], Thu, 25 Jun 2015 06:38:02 GMT -->
</html>