...
<!-- Mirrored from teamfox.co/themes/pleasure/app/admin1/charts-flot.html by HTTrack Website Copier/3.x [XR&CO'2013], Thu, 25 Jun 2015 06:38:02 GMT -->
<head>
	<meta charset="utf-8">
	<meta http-equiv="X-UA-Compatible" content="IE=edge">

	<title>PLEASURE - Flot Charts</title>
...
<body>
	...
	<div class="content">
		...
		<div class="page-header full-content bg-deep-purple">
			<div class="row">
				<div class="col-sm-6">
					<h1>Flot Charts <small>short description</small></h1>
				</div><!--.col-->
				<div class="col-sm-6">
					<ol class="breadcrumb">
						<li><a href="#"><i class="ion-home"></i></a></li>
						<li><a href="#">Charts</a></li>
						<li><a href="#" class="active">Flot Charts</a></li>
					</ol>
				</div><!--.col-->
			</div><!--.row-->
		</div><!--.page-header-->
		...
		<div class="row">
			<div class="col-md-6">
				...
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>BASIC</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">
						<div class="flot-basic flot-charts"></div>
					</div><!--.panel-body-->
				</div><!--.panel-->
			...
			<div class="col-md-6">
				...
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>CATEGORIES &amp; TEXTUAL DATA</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">
						<div class="flot-categories flot-charts"></div>
					</div><!--.panel-body-->
				</div><!--.panel-->
		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>SETTING OPTIONS</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">
						<div class="flot-options flot-charts"></div>
					</div><!--.panel-body-->
				</div><!--.panel-->
		...
		<div class="row">
			<div class="col-md-6">
				...
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>STACKING BARS</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">
						<div class="flot-stacking-bars flot-charts"></div>
					</div><!--.panel-body-->
				</div><!--.panel-->
			...
			<div class="col-md-6">
				...
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>STACKING LINES</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">
						<div class="flot-stacking-lines flot-charts"></div>
					</div><!--.panel-body-->
				</div><!--.panel-->
		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>REAL TIME</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">
						<div class="flot-realtime flot-charts"></div>
					</div><!--.panel-body-->
				</div><!--.panel-->
		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>TOGGLE SERIES</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">
						<div class="clearfix">
							<div class="flot-toggle flot-charts" style="float:left; width: 80%;"></div>
		...
		<div class="row">
			<div class="col-md-6">
				...
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>PIE CHART DEFAULT</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">
						<div class="flot-pie-default flot-charts"></div>
					</div><!--.panel-body-->
				</div><!--.panel-->
			...
			<div class="col-md-6">
				...
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>PIE CHART WITHOUT LEGEND</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">
						<div class="flot-pie-without-legend flot-charts"></div>
					</div><!--.panel-body-->
				</div><!--.panel-->
		...
		<div class="row">
			<div class="col-md-6">
				...
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>PIE CHART LABEL FORMATTER</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">
						<div class="flot-pie-label-formatter flot-charts"></div>
					</div><!--.panel-body-->
				</div><!--.panel-->
			...
			<div class="col-md-6">
				...
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>PIE CHART LABEL RADIUS</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">
						<div class="flot-pie-label-radius flot-charts"></div>
					</div><!--.panel-body-->
				</div><!--.panel-->
		...
		<div class="row">
			<div class="col-md-6">
				...
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>PIE CHART LABEL STYLE 1</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">
						<div class="flot-pie-label-style1 flot-charts"></div>
					</div><!--.panel-body-->
				</div><!--.panel-->
			...
			<div class="col-md-6">
				...
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>PIE CHART LABEL STYLE 2</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">
						<div class="flot-pie-label-style2 flot-charts"></div>
					</div><!--.panel-body-->
				</div><!--.panel-->
		...
		<div class="row">
			<div class="col-md-6">
				...
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>PIE CHART HIDDEN LABEL</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">
						<div class="flot-pie-hidden-labels flot-charts"></div>
					</div><!--.panel-body-->
				</div><!--.panel-->
			...
			<div class="col-md-6">
				...
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>PIE CHART COMBINED SLICE</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">
						<div class="flot-pie-combined-slice flot-charts"></div>
					</div><!--.panel-body-->
				</div><!--.panel-->
		...
		<div class="row">
			<div class="col-md-6">
				...
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>RECTANGULAR PIE</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">
						<div class="flot-pie-rectangular flot-charts"></div>
					</div><!--.panel-body-->
				</div><!--.panel-->
			...
			<div class="col-md-6">
				...
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>TILTED PIE</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">
						<div class="flot-pie-tilted flot-charts"></div>
					</div><!--.panel-body-->
				</div><!--.panel-->
		...
		<div class="row">
			<div class="col-md-6">
				...
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>DONUT HOLE</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">
						<div class="flot-pie-donut flot-charts"></div>
					</div><!--.panel-body-->
				</div><!--.panel-->
			...
			<div class="col-md-6">
				...
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>INTERACTIVITY</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">
						<div class="flot-pie-interactivity flot-charts"></div>
					</div><!--.panel-body-->
				</div><!--.panel-->
			...
			<ul>
				...
				<li>
					...
					<ul class="child-menu">
						...
						<li data-open-after="true"><a href="charts-flot.html">Flot Charts</a></li>
	...
	<!-- BEGIN PLUGINS AREA -->
	<!--[if lte IE 8]><script language="javascript" type="text/javascript" src="../../assets/globals/plugins/flot/excanvas.min.js"></script><![endif]-->
	<script src="../../assets/globals/plugins/flot/jquery.flot.js"></script>
	<script src="../../assets/globals/plugins/flot/jquery.flot.resize.js"></script>
	<script src="../../assets/globals/plugins/flot/jquery.flot.stack.js"></script>
	<script src="../../assets/globals/plugins/flot/jquery.flot.categories.js"></script>
	<script src="../../assets/globals/plugins/flot/jquery.flot.pie.js"></script>
	<!-- END PLUGINS AREA -->

	<!-- PLUGINS INITIALIZATION AND SETTINGS -->
	<script src="../../assets/globals/scripts/charts-flot.js"></script>
...
<!-- Mirrored from teamfox.co/themes/pleasure/app/admin1/charts-flot.html by HTTrack Website Copier/3.x [XR&CO'2013], Thu, 25 Jun 2015 06:38:21 GMT -->
</html>