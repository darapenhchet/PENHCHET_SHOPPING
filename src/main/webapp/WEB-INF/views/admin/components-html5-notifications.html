...
<!-- Mirrored from teamfox.co/themes/pleasure/app/admin1/components-html5-notifications.html by HTTrack Website Copier/3.x [XR&CO'2013], Thu, 25 Jun 2015 06:37:44 GMT -->
<head>
	<meta charset="utf-8">
	<meta http-equiv="X-UA-Compatible" content="IE=edge">

	<title>PLEASURE - HTML5 Desktop Notifications</title>
...
<body>
	...
	<div class="content">
		...
		<div class="page-header full-content bg-cyan">
			<div class="row">
				<div class="col-sm-6">
					<h1>HTML5 Notifications <small>short description</small></h1>
				</div><!--.col-->
				<div class="col-sm-6">
					<ol class="breadcrumb">
						<li><a href="#"><i class="ion-home"></i></a></li>
						<li><a href="#">Components</a></li>
						<li><a href="#" class="active">HTML5 Notifications</a></li>
					</ol>
				</div><!--.col-->
			</div><!--.row-->
		</div><!--.page-header-->
		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class="note note-primary note-left-striped">
					<h4>HTML5 Desktop Notifications</h4>
					<p>A small library that unifies the HTML5 Notifications APIs accross different browsers including IE9 &amp; IE10.</p>
				</div><!--.note-->
			...
			<div class="col-md-8 col-centered">
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>NATIVE NOTIFICATIONS</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">

						<div class="row margin-bottom-20">
							<div class="col-md-8">Permission request</div><!--.col-->
							<div class="col-md-4">
								<button class="btn btn-primary pull-right html5-request-permission">Request</button>
							</div><!--.col-->
						</div><!--.row-->

						<div class="row margin-bottom-20">
							<div class="col-md-8">Sample notification with all options</div><!--.col-->
							<div class="col-md-4">
								<button class="btn btn-primary pull-right html5-create-notification"
								data-notification-title="TeamFox"
								data-notification-body="Check out our profile page"
								data-notification-icon="../../assets/globals/img/icons/favicon.ico"
								data-notification-href="http://themeforest.net/user/teamfox">Request &amp; Show</button>
							</div><!--.col-->
						</div><!--.row-->
		...
		<div class="footer-links margin-top-40">
			<div class="row no-gutters">
				...
				<div class="col-xs-6 bg-orange">
					<a href="layout-flexible-space.html">
			...
			<ul>
				...
				<li>
					...
					<ul class="child-menu">
						...
						<li data-open-after="true"><a href="components-html5-notifications.html">HTML5 Notifications</a></li>
					</ul>
				</li>
				<li>
	...
	<!-- BEGIN PLUGINS AREA -->
	<script src="../../assets/globals/plugins/html5-desktop-notifications/desktop-notify.js"></script>
	<!-- END PLUGINS AREA -->

	<!-- PLUGINS INITIALIZATION AND SETTINGS -->
	<script src="../../assets/globals/scripts/html5-notifications.js"></script>
...
<!-- Mirrored from teamfox.co/themes/pleasure/app/admin1/components-html5-notifications.html by HTTrack Website Copier/3.x [XR&CO'2013], Thu, 25 Jun 2015 06:37:46 GMT -->
</html>