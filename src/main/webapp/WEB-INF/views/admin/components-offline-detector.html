...
<!-- Mirrored from teamfox.co/themes/pleasure/app/admin1/components-offline-detector.html by HTTrack Website Copier/3.x [XR&CO'2013], Thu, 25 Jun 2015 06:37:25 GMT -->
<head>
	<meta charset="utf-8">
	<meta http-equiv="X-UA-Compatible" content="IE=edge">

	<title>PLEASURE - Offline Detector</title>
	...
	<!-- BEGIN PLUGINS CSS -->
	<link rel="stylesheet" href="../../assets/globals/plugins/offline/themes/offline-theme-chrome.css">
	<link rel="stylesheet" href="../../assets/globals/plugins/offline/themes/offline-language-english.css">
...
<body>
	...
	<div class="content">
		...
		<div class="page-header full-content bg-cyan">
			<div class="row">
				<div class="col-sm-6">
					<h1>Offline Detector <small>short description</small></h1>
				</div><!--.col-->
				<div class="col-sm-6">
					<ol class="breadcrumb">
						<li><a href="#"><i class="ion-home"></i></a></li>
						<li><a href="#">Components</a></li>
						<li><a href="#" class="active">Offline Detector</a></li>
					</ol>
				</div><!--.col-->
			</div><!--.row-->
		</div><!--.page-header-->
		...
		<div class="menu-layer">
			<ul>
				...
				<li>
					...
					<ul class="child-menu">
						<li data-open-after="true"><a href="components-offline-detector.html">Offline Detector</a></li>
	...
	<!-- BEGIN PLUGINS AREA -->
	<script src="../../assets/globals/plugins/offline/offline.min.js"></script>
	<!-- END PLUGINS AREA -->

	<!-- PLUGINS INITIALIZATION AND SETTINGS -->
	<script src="../../assets/globals/scripts/panel-offline.js"></script>
...
<!-- Mirrored from teamfox.co/themes/pleasure/app/admin1/components-offline-detector.html by HTTrack Website Copier/3.x [XR&CO'2013], Thu, 25 Jun 2015 06:37:29 GMT -->
</html>