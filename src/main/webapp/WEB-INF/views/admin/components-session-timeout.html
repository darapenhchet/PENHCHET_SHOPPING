...
<!-- Mirrored from teamfox.co/themes/pleasure/app/admin1/components-session-timeout.html by HTTrack Website Copier/3.x [XR&CO'2013], Thu, 25 Jun 2015 06:37:29 GMT -->
<head>
	<meta charset="utf-8">
	<meta http-equiv="X-UA-Compatible" content="IE=edge">

	<title>PLEASURE - Session Timeout</title>
...
<body>
	...
	<div class="content">
		...
		<div class="page-header full-content bg-cyan">
			<div class="row">
				<div class="col-sm-6">
					<h1>Session Timeout <small>short description</small></h1>
				</div><!--.col-->
				<div class="col-sm-6">
					<ol class="breadcrumb">
						<li><a href="#"><i class="ion-home"></i></a></li>
						<li><a href="#">Components</a></li>
						<li><a href="#" class="active">Session Timeout</a></li>
					</ol>
				</div><!--.col-->
			</div><!--.row-->
		</div><!--.page-header-->
		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class="note note-primary note-left-striped">
					<h4>Bootstrap Seesion Timeout</h4>
					<p>As long as the user is doing something on the page, he will never get a timeout. The original plugin launched a timeout warning dialog in a fixed amount of time regardless of user activity.</p>
			...
			<ul>
				...
				<li>
					...
					<ul class="child-menu">
						...
						<li data-open-after="true"><a href="components-session-timeout.html">Session Timeout</a></li>
	...
	<!-- BEGIN PLUGINS AREA -->
	<script src="../../assets/globals/plugins/bootstrap-session-timeout/dist/bootstrap-session-timeout.min.js"></script>
	<!-- END PLUGINS AREA -->

	<!-- PLUGINS INITIALIZATION AND SETTINGS -->
	<script src="../../assets/globals/scripts/panel-session-timeout.js"></script>
...
<!-- Mirrored from teamfox.co/themes/pleasure/app/admin1/components-session-timeout.html by HTTrack Website Copier/3.x [XR&CO'2013], Thu, 25 Jun 2015 06:37:31 GMT -->
</html>