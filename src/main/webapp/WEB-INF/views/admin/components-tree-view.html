...
<!-- Mirrored from teamfox.co/themes/pleasure/app/admin1/components-tree-view.html by HTTrack Website Copier/3.x [XR&CO'2013], Thu, 25 Jun 2015 06:37:31 GMT -->
<head>
	<meta charset="utf-8">
	<meta http-equiv="X-UA-Compatible" content="IE=edge">

	<title>PLEASURE - Tree View</title>
	...
	<!-- BEGIN PLUGINS CSS -->
	<link rel="stylesheet" href="../../assets/globals/plugins/jstree/dist/themes/default/style.min.css">
...
<body>
	...
	<div class="content">
		...
		<div class="page-header full-content bg-cyan">
			<div class="row">
				<div class="col-sm-6">
					<h1>Tree View <small>short description</small></h1>
				</div><!--.col-->
				<div class="col-sm-6">
					<ol class="breadcrumb">
						<li><a href="#"><i class="ion-home"></i></a></li>
						<li><a href="#">Components</a></li>
						<li><a href="#" class="active">Tree View</a></li>
					</ol>
				</div><!--.col-->
			</div><!--.row-->
		</div><!--.page-header-->
			...
			<div class="col-md-12">
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>TREE VIEW</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">

						<div class="row example-row">
							<div class="col-md-3">Default Tree</div><!--.col-md-3-->
							<div class="col-md-9">

								<div class="treejs treejs-simple">
									<ul>
										<li>Root node
											<ul>
												<li data-jstree='{ "selected" : true }'>
													<a href="#">Initially selected</a>
												</li>
												<li data-jstree='{ "icon" : "fa fa-cloud" }'>Custom icon (ion icon)</li>
												<li data-jstree='{ "opened" : true }'>Initially open
													<ul>
														...
														<li data-jstree='{ "type" : "file" }'>Third node</li>
													</ul>
												</li>
												<li data-jstree='{ "icon" : "fa fa-pie-chart" }'>Custom icon (ion icon)</li>
											</ul>
										</li>
										<li data-jstree='{ "type" : "file" }'>
											<a href="http://www.themeforest.net/" target="_blank">Clickable link node</a>
										</li>
									</ul>
								</div><!--.treejs-->
						...
						<div class="row example-row">
							<div class="col-md-3">Context View</div><!--.col-md-3-->
							<div class="col-md-9">

								<div class="treejs treejs-context">
								</div><!--.treejs-->
						...
						<div class="row example-row">
							...
							<div class="col-md-9">
								...
								<div class="treejs treejs-dragdrop">
								</div><!--.treejs-->
						...
						<div class="row example-row">
							<div class="col-md-3">Checkable</div><!--.col-md-3-->
							<div class="col-md-9">

								<div class="treejs treejs-checkable">
								</div><!--.treejs-->
						...
						<div class="row example-row">
							<div class="col-md-3">Sortable</div><!--.col-md-3-->
							<div class="col-md-9">

								<div class="treejs treejs-sortable">
								</div><!--.treejs-->
						...
						<div class="row example-row">
							<div class="col-md-3">Ajax Tree</div><!--.col-md-3-->
							<div class="col-md-9">

								<div class="treejs treejs-ajax">
								</div><!--.treejs-->
		...
		<div class="footer-links margin-top-40">
			<div class="row no-gutters">
				<div class="col-xs-6 bg-cyan">
					<a href="components-sound-library.html">
			...
			<ul>
				...
				<li>
					...
					<ul class="child-menu">
						...
						<li data-open-after="true"><a href="components-tree-view.html">Tree View</a></li>
					</ul>
				</li>
				<li>
	...
	<!-- BEGIN PLUGINS AREA -->
	<script src="../../assets/globals/plugins/jstree/dist/jstree.min.js"></script>
	<!-- END PLUGINS AREA -->

	<!-- PLUGINS INITIALIZATION AND SETTINGS -->
	<script src="../../assets/globals/scripts/tree-view.js"></script>
...
<!-- Mirrored from teamfox.co/themes/pleasure/app/admin1/components-tree-view.html by HTTrack Website Copier/3.x [XR&CO'2013], Thu, 25 Jun 2015 06:37:44 GMT -->
</html>