...
<!-- Mirrored from teamfox.co/themes/pleasure/app/admin1/email-basic.html by HTTrack Website Copier/3.x [XR&CO'2013], Thu, 25 Jun 2015 06:38:50 GMT -->
<head>
												...
												<table class="twelve columns">
													<tr>
														<td class="six sub-columns">
															<a href="#"><img src="../../assets/globals/img/email/logo.png" alt=""></a>
														</td>
														<td class="six sub-columns last" style="text-align:right; vertical-align:middle;">
															<a href="#" class="white-link">London</a> | <a href="#" class="white-link">Newyork</a> | <a href="#" class="white-link">Istanbul</a>
														</td>
										...
										<td class="wrapper last">
											...
											<table class="twelve columns">
												<tr>
													<td>
														<h1>Hi, John Doe</h1>
														<p class="lead">Thank your for downloading <strong>our admin panel</strong> from themeforest.net. Your files will be sent your e-mail address in 10 minutes.</p>
													</td>
													<td class="expander"></td>
												</tr>
												<tr>
													<td class="panel">
														<p style="text-align:right;">View our latest products on <a href="#">themeforest</a></p>
														<img src="../../assets/globals/img/picjumbo/27.jpg">
													</td>
													<td class="expander"></td>
												</tr>
											</table>
									...
									<tr>
										<td class="wrapper last">
											...
											<table class="twelve columns">
												<tr>
													<td align="center">
														<p class="small" style="text-align:center;">If you have a question or have a problem about our themes, do not hesitate to <a href="#">contact us</a>. We will try to solve your problem as soon as possible.</p>
													</td>
													<td class="expander"></td>
												</tr>
											</table>
...
<!-- Mirrored from teamfox.co/themes/pleasure/app/admin1/email-basic.html by HTTrack Website Copier/3.x [XR&CO'2013], Thu, 25 Jun 2015 06:38:53 GMT -->
</html>