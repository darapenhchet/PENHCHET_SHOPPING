...
<!-- Mirrored from teamfox.co/themes/pleasure/app/admin1/forms-custom-file-input.html by HTTrack Website Copier/3.x [XR&CO'2013], Thu, 25 Jun 2015 06:36:03 GMT -->
<head>
	<meta charset="utf-8">
	<meta http-equiv="X-UA-Compatible" content="IE=edge">

	<title>PLEASURE - Custom File Input</title>
			...
			<div class="row">
				...
				<div class="col-sm-6">
					<ol class="breadcrumb">
						...
						<li><a href="#" class="active">Custom File Input</a></li>
					</ol>
				</div><!--.col-->
			</div><!--.row-->
		</div><!--.page-header-->
			...
			<div class="col-md-12">
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>FILE INPUTS</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">
						...
						<div class="row example-row">
							<div class="col-md-3">Only Button</div><!--.col-md-3-->
							<div class="col-md-9">
						...
						<div class="row example-row">
							<div class="col-md-3">Image Upload 1</div><!--.col-md-3-->
							<div class="col-md-9">
						...
						<div class="row example-row">
							<div class="col-md-3">Image Upload 2</div><!--.col-md-3-->
							<div class="col-md-9">

								<div class="fileinput fileinput-new" data-provides="fileinput">
									<div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
										<img data-src="holder.js/100%x100%" src="holder.js/100x100.html" alt="...">
									</div>
					...
					<ul class="child-menu">
						...
						<li>
							...
							<ul class="child-menu">
								...
								<li data-open-after="true"><a href="forms-custom-file-input.html">Custom File Input</a></li>
							</ul>
						</li>
					</ul>
				</li>
...
<!-- Mirrored from teamfox.co/themes/pleasure/app/admin1/forms-custom-file-input.html by HTTrack Website Copier/3.x [XR&CO'2013], Thu, 25 Jun 2015 06:36:04 GMT -->
</html>