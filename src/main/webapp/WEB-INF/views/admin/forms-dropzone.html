...
<!-- Mirrored from teamfox.co/themes/pleasure/app/admin1/forms-dropzone.html by HTTrack Website Copier/3.x [XR&CO'2013], Thu, 25 Jun 2015 06:35:44 GMT -->
<head>
	<meta charset="utf-8">
	<meta http-equiv="X-UA-Compatible" content="IE=edge">

	<title>PLEASURE - Dropzone Uploader</title>
	...
	<!-- BEGIN PLUGINS CSS -->
	<link rel="stylesheet" href="../../assets/globals/plugins/dropzone/downloads/css/dropzone.css">
...
<body>
	...
	<div class="content">
		...
		<div class="page-header full-content bg-brown">
			<div class="row">
				<div class="col-sm-6">
					<h1>Dropzone <small>short description</small></h1>
				</div><!--.col-->
				<div class="col-sm-6">
					<ol class="breadcrumb">
						<li><a href="#"><i class="ion-home"></i></a></li>
						<li><a href="#">Forms</a></li>
						<li><a href="#" class="active">Dropzone</a></li>
					</ol>
				</div><!--.col-->
			</div><!--.row-->
		</div><!--.page-header-->
		...
		<div class="row">
			<div class="col-md-12">
				...
				<table class="table table-striped dropzone-table">
					<thead>
						<tr>
							<th>File name</th>
							<th>Type</th>
				...
				<li>
					...
					<ul class="child-menu">
						...
						<li>
							...
							<ul class="child-menu">
								<li data-open-after="true"><a href="forms-dropzone.html">Dropzone</a></li>
	...
	<!-- BEGIN PLUGINS AREA -->
	<script src="../../assets/globals/plugins/dropzone/downloads/dropzone.min.js"></script>
	<!-- END PLUGINS AREA -->

	<!-- PLUGINS INITIALIZATION AND SETTINGS -->
	<script src="../../assets/globals/scripts/drop-to-upload.js"></script>
...
<!-- Mirrored from teamfox.co/themes/pleasure/app/admin1/forms-dropzone.html by HTTrack Website Copier/3.x [XR&CO'2013], Thu, 25 Jun 2015 06:35:47 GMT -->
</html>