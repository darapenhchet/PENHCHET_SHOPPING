...
<!-- Mirrored from teamfox.co/themes/pleasure/app/admin1/forms-image-cropper.html by HTTrack Website Copier/3.x [XR&CO'2013], Thu, 25 Jun 2015 06:35:42 GMT -->
<head>
	<meta charset="utf-8">
	<meta http-equiv="X-UA-Compatible" content="IE=edge">

	<title>PLEASURE - Image Cropper</title>
	...
	<!-- BEGIN PLUGINS CSS -->
	<link rel="stylesheet" href="../../assets/globals/plugins/cropper/dist/cropper.min.css">
...
<body>
	...
	<div class="content">
		...
		<div class="page-header full-content bg-brown">
			<div class="row">
				<div class="col-sm-6">
					<h1>Image Cropper <small>short description</small></h1>
				</div><!--.col-->
				<div class="col-sm-6">
					<ol class="breadcrumb">
						<li><a href="#"><i class="ion-home"></i></a></li>
						<li><a href="#">Forms</a></li>
						<li><a href="#" class="active">Image Cropper</a></li>
					</ol>
				</div><!--.col-->
			</div><!--.row-->
		</div><!--.page-header-->
			...
			<div class="col-md-12">
				...
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>IMAGE CROPPER</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">

						<div class="croppper-container">
							<div class="row cropper-main">
								<div class="col-sm-8">
									<div class="cropper-wrapper">
										<img class="cropper" src="../../assets/globals/img/picjumbo/1.jpg" alt="Picture">
									</div>
								</div>
								<div class="col-sm-4">
									...
									<div class="cropper-data">
										<form action="http://teamfox.co/themes/pleasure/app/admin1/demo/image-cropper.php" method="post" target="_blank">
											...
											<div class="input-group">
												...
												<div class="inputer">
													<div class="input-wrapper">
														<input class="form-control" id="dataW" name="dataW" type="text" placeholder="width">
													</div>
												</div>
											</div>
											<div class="input-group">
												...
												<div class="inputer inputer-light-blue">
													<div class="input-wrapper">
														<input class="form-control" id="dataH" name="dataH" type="text" placeholder="height">
													</div>
												</div>
											</div>
											<input id="dataS" name="dataS" type="hidden" value="1">
											<button type="submit" class="btn btn-primary btn-block margin-bottom-20">Crop</button>
										</form>
									</div>
								</div>
							</div>
							<div class="clearfix">
								<div class="row cropper-input">
									<div class="col-md-6">
										<div class="input-group">
											<div class="inputer inputer-light-blue">
												<div class="input-wrapper">
									...
									<div class="col-md-6">
										...
										<div class="input-group">
											<div class="inputer inputer-light-blue">
												<div class="input-wrapper">
													<input type="text" id="sourcePath" class="form-control" disabled value="../../assets/globals/img/picjumbo/1.jpg">
												</div>
											</div>
											<div class="input-group-btn">
												<button type="button" class="btn btn-info dropdown-toggle" data-toggle="dropdown">Change image <span class="caret"></span></button>
												<ul class="dropdown-menu" role="menu">
													<li><a href="javascript:;" class="changeImage" data-img-source="1">Image 1</a></li>
													<li><a href="javascript:;" class="changeImage" data-img-source="2">Image 2</a></li>
												</ul>
											</div><!--.input-group-btn-->
										</div><!--.input-group-->
									</div>
		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>IN A MODAL WINDOW</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">
						<button class="btn btn-primary" type="button" data-toggle="modal" data-target="#bs-modal">Launch the demo</button>
					</div><!--.panel-body-->
				</div><!--.panel-->
		...
		<div class="modal scale fade" id="bs-modal" tabindex="-1" role="dialog" aria-labelledby="bs-modal-label" aria-hidden="true">
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						<h4 class="modal-title" id="bs-modal-label">Cropper</h4>
					</div>
					<div class="modal-body">
						<div class="bs-modal-cropper"><img src="../../assets/globals/img/picjumbo/1.jpg" alt="Picture 1"></div>
					</div>
					...
					<ul class="child-menu">
						...
						<li>
							...
							<ul class="child-menu">
								...
								<li data-open-after="true"><a href="forms-image-cropper.html">Image Cropper</a></li>
							</ul>
						</li>
						<li>
	...
	<!-- BEGIN PLUGINS AREA -->
	<script src="../../assets/globals/plugins/cropper/dist/cropper.min.js"></script>
	<!-- END PLUGINS AREA -->

	<!-- PLUGINS INITIALIZATION AND SETTINGS -->
	<script src="../../assets/globals/scripts/forms-image-cropper.js"></script>
...
<!-- Mirrored from teamfox.co/themes/pleasure/app/admin1/forms-image-cropper.html by HTTrack Website Copier/3.x [XR&CO'2013], Thu, 25 Jun 2015 06:35:43 GMT -->
</html>