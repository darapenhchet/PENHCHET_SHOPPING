...
<!-- Mirrored from teamfox.co/themes/pleasure/app/admin1/forms-jcrop.html by HTTrack Website Copier/3.x [XR&CO'2013], Thu, 25 Jun 2015 06:35:25 GMT -->
<head>
	<meta charset="utf-8">
	<meta http-equiv="X-UA-Compatible" content="IE=edge">

	<title>PLEASURE - J Crop</title>
	...
	<!-- BEGIN PLUGINS CSS -->
	<link rel="stylesheet" href="../../assets/globals/plugins/Jcrop/css/jquery.Jcrop.min.css">
...
<body>
	...
	<div class="content">
		...
		<div class="page-header full-content bg-brown">
			<div class="row">
				<div class="col-sm-6">
					<h1>J Crop <small>short description</small></h1>
				</div><!--.col-->
				<div class="col-sm-6">
					<ol class="breadcrumb">
						<li><a href="#"><i class="ion-home"></i></a></li>
						<li><a href="#">Forms</a></li>
						<li><a href="#" class="active">J Crop</a></li>
					</ol>
				</div><!--.col-->
			</div><!--.row-->
		</div><!--.page-header-->
				...
				<div class="panel">
					<div class="panel-heading">
						...
						<ul class="nav nav-tabs with-panel">
							<li class="active"><a href="#j-basic" data-toggle="tab">Basic</a></li>
							<li><a href="#j-handler" data-toggle="tab">Handler</a></li>
							<li><a href="#j-preview" data-toggle="tab">Preview Pane</a></li>
							<li><a href="#j-animations" data-toggle="tab">Animations</a></li>
							<li><a href="#j-api" data-toggle="tab">API</a></li>
							<li><a href="#j-nonimage" data-toggle="tab">Non-image</a></li>
							<li><a href="#j-css" data-toggle="tab">CSS</a></li>
							<li><a href="#j-server" data-toggle="tab">Server</a></li>
						</ul>
					</div><!--.panel-heading-->
					<div class="panel-body">
						<div class="tab-content with-panel">

							<div id="j-basic" class="tab-pane active">
								<img src="../../assets/globals/img/picjumbo/3.jpg" class="jcrop-basic" alt="">
							</div><!--.tab-pane-->

							<div id="j-handler" class="tab-pane">
								<div class="row">
									<div class="col-md-8">
										<img src="../../assets/globals/img/picjumbo/4.jpg" class="jcrop-handler" alt="[Jcrop Example]" />
									</div>
									<div class="col-md-4">
										<form id="example2-coords" class="cropper-data" action="#">
											<div class="input-group">
												<span class="input-group-addon">X1</span>
												<input type="text" class="form-control" size="4" id="x1" name="x1">
											</div>
											<div class="input-group">
												<span class="input-group-addon">Y1</span>
												<input type="text" class="form-control" size="4" id="y1" name="y1">
											</div>
											<div class="input-group">
												<span class="input-group-addon">X2</span>
												<input type="text" class="form-control" size="4" id="x2" name="x2">
											</div>
											<div class="input-group">
												<span class="input-group-addon">Y2</span>
												<input type="text" class="form-control" size="4" id="y2" name="y2">
											</div>
											<div class="input-group">
												<span class="input-group-addon">Width</span>
												<input type="text" class="form-control" size="4" id="w" name="w">
											</div>
											<div class="input-group">
												<span class="input-group-addon">Height</span>
												<input type="text" class="form-control" size="4" id="h" name="h">
											</div>
										</form>
									</div>
								</div><!--.row-->
							...
							<div id="j-preview" class="tab-pane">
								<div class="row">
									<div class="col-md-8">
										<img src="../../assets/globals/img/picjumbo/5.jpg" class="jcrop-preimage" alt="[Jcrop Example]">
									</div>
									<div class="col-md-4">
										<div id="preview-pane">
											<div class="preview-container">
												<img src="../../assets/globals/img/picjumbo/5.jpg" class="jcrop-preview" alt="Preview">
											</div>
										</div>
									</div>
								</div><!--.row-->
							...
							<div id="j-animations" class="tab-pane">
								<div class="row">
									<div class="col-md-8">
										<img src="../../assets/globals/img/picjumbo/6.jpg" class="jcrop-extras" alt="[Jcrop Example]">
									</div>
									<div class="col-md-4">
										<div id="interface">
											<div class="checkbox">
							...
							<div id="j-api" class="tab-pane">
								<div class="row">
									<div class="col-md-8">
										<img src="../../assets/globals/img/picjumbo/7.jpg" class="jcrop-api" alt="[Jcrop Example]">
										<div class="margin-top-10">
											<span class="requiresjcrop">
												<button id="setSelect" class="btn btn-default btn-sm">setSelect</button>
												<button id="animateTo" class="btn btn-default btn-sm">animateTo</button>
												<button id="release" class="btn btn-default btn-sm">Release</button>
												<button id="disable" class="btn btn-default btn-sm">Disable</button>
											</span>
											<button id="enable" class="btn btn-default btn-sm" style="display:none;">Re-Enable</button>
											<button id="unhook" class="btn btn-default btn-sm">Destroy!</button>
											<button id="rehook" class="btn btn-default btn-sm" style="display:none;">Attach Jcrop</button>
										</div>
									</div>
									<div class="col-md-4">
										<fieldset class="optdual requiresjcrop margin-bottom-10">
										...
										<fieldset class="requiresjcrop">
											...
											<div class="btn-group btn-merged">
												<button class="btn btn-default" id="img2">Pool</button>
												<button class="btn btn-default active" id="img1">Sago</button>
												<button class="btn btn-default" id="img3">Sago w/ outerImage</button>
											</div>
										</fieldset>
									</div>
								</div><!--.row-->
							...
							<div id="j-nonimage" class="tab-pane">
								<p class="jcrop-nonimage jcrop-example-nonimage">
									<strong>This is an example of attaching Jcrop to a target that is not an image. You are now cropping a paragraph tag.</strong>
								</p>
							</div><!--.tab-pane-->

							<div id="j-css" class="tab-pane">
								<div class="row">
									<div class="col-md-8">
										<img src="../../assets/globals/img/picjumbo/8.jpg" class="jcrop-styling" alt="[Jcrop Example]">
									</div>
									<div class="col-md-4">
										<fieldset>
											<legend>Manipulate classes</legend>
											<div class="btn-group btn-merged" id="buttonbar">
							...
							<div id="j-server" class="tab-pane">
								<div class="row">
									<div class="col-md-8">
										<img src="../../assets/globals/img/picjumbo/24.jpg" class="jcrop-server" alt="[Jcrop Example]" />
									</div>
									<div class="col-md-4 cropper-data">
										<form action="http://teamfox.co/themes/pleasure/app/admin1/demo/jcrop.php" method="post" onsubmit="return FormsJCrop.checkCoords();">
											<div class="input-group">
												<span class="input-group-addon">X</span>
												<input type="text" class="form-control" size="4" id="f_x" name="f_x">
											</div>
											<div class="input-group">
												<span class="input-group-addon">Y</span>
												<input type="text" class="form-control" size="4" id="f_y" name="f_y">
											</div>
											<div class="input-group">
												<span class="input-group-addon">Width</span>
												<input type="text" class="form-control" size="4" id="f_w" name="f_w">
											</div>
											<div class="input-group">
												<span class="input-group-addon">Height</span>
												<input type="text" class="form-control" size="4" id="f_h" name="f_h">
											</div>
											<input type="submit" value="Crop Image" class="btn btn-primary btn-block" />
										</form>
									</div>
								</div><!--.row-->
							</div><!--.tab-pane-->
		...
		<div class="footer-links margin-top-40">
			<div class="row no-gutters">
				<div class="col-xs-6 bg-brown">
					<a href="forms-wysiwyg-editors.html">
				...
				<li>
					...
					<ul class="child-menu">
						...
						<li>
							...
							<ul class="child-menu">
								<li data-open-after="true"><a href="forms-jcrop.html">J Crop</a></li>
	...
	<!-- BEGIN PLUGINS AREA -->
	<script src="../../assets/globals/plugins/Jcrop/js/jquery.color.js"></script>
	<script src="../../assets/globals/plugins/Jcrop/js/jquery.Jcrop.min.js"></script>
	<!-- END PLUGINS AREA -->

	<!-- PLUGINS INITIALIZATION AND SETTINGS -->
	<script src="../../assets/globals/scripts/forms-jcrop.js"></script>
...
<!-- Mirrored from teamfox.co/themes/pleasure/app/admin1/forms-jcrop.html by HTTrack Website Copier/3.x [XR&CO'2013], Thu, 25 Jun 2015 06:35:42 GMT -->
</html>