...
<!-- Mirrored from teamfox.co/themes/pleasure/app/admin1/forms-layouts.html by HTTrack Website Copier/3.x [XR&CO'2013], Thu, 25 Jun 2015 06:32:48 GMT -->
<head>
	<meta charset="utf-8">
	<meta http-equiv="X-UA-Compatible" content="IE=edge">

	<title>PLEASURE - Form Layouts</title>
...
<body>
	...
	<div class="content">
		...
		<div class="page-header full-content bg-brown">
			<div class="row">
				<div class="col-sm-6">
					<h1>Form Layouts <small>short description</small></h1>
				</div><!--.col-->
				<div class="col-sm-6">
					<ol class="breadcrumb">
						<li><a href="#"><i class="ion-home"></i></a></li>
						<li><a href="#">Forms</a></li>
						<li><a href="#" class="active">Layouts</a></li>
					</ol>
				</div><!--.col-->
			</div><!--.row-->
		</div><!--.page-header-->
			...
			<div class="col-md-12">
				...
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>DEFAULT BUTTON POSITION</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">
						...
						<form action="#" class="form-horizontal">
							<div class="form-content">
								...
								<div class="form-group">
									...
									<div class="col-md-5">
										...
										<div class="radioer">
											...
											<label for="radioColor1b">Passive</label>
										</div>
									</div>
								</div><!--.form-group-->
								...
								<div class="form-group">
									<label class="control-label col-md-3">Approved salary</label>
									<div class="col-md-5">
		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>BUTTONS ON TOP</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">

						<form action="#" class="form-horizontal">
							<div class="form-buttons buttons-on-top">
								<div class="row">
									<div class="col-md-offset-3 col-md-9">
										<button type="submit" class="btn btn-blue">Submit</button>
										<button type="button" class="btn btn-flat btn-default">Cancel</button>
							...
							<div class="form-content">
								...
								<div class="form-group">
									...
									<div class="col-md-5">
										<div class="radioer">
											<input type="radio" name="radioOption2" id="radioColor3" value="option1" checked="checked">
											<label for="radioColor3">Active</label>
										</div>
										<div class="radioer">
											<input type="radio" name="radioOption2" id="radioColor4" value="option1">
											<label for="radioColor4">Passive</label>
										</div>
									</div>
								</div><!--.form-group-->
		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>BUTTONS ON TOP &amp; BOTTOM</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">
						...
						<form action="#" class="form-horizontal">
							...
							<div class="form-content">
								...
								<div class="form-group">
									...
									<div class="col-md-5">
										<div class="radioer">
											<input type="radio" name="radioOption3" id="radioColor5" value="option1" checked="checked">
											<label for="radioColor5">Active</label>
										</div>
										<div class="radioer">
											<input type="radio" name="radioOption3" id="radioColor6" value="option1">
											<label for="radioColor6">Passive</label>
										</div>
									</div>
								</div><!--.form-group-->
		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>ALIGNED BUTTONS</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">
						...
						<form action="#" class="form-horizontal">
							...
							<div class="form-content">
								...
								<div class="form-group">
									...
									<div class="col-md-5">
										<div class="radioer">
											<input type="radio" name="radioOption4" id="radioColor7" value="option1" checked="checked">
											<label for="radioColor7">Active</label>
										</div>
										<div class="radioer">
											<input type="radio" name="radioOption4" id="radioColor8" value="option1">
											<label for="radioColor8">Passive</label>
										</div>
									</div>
								</div><!--.form-group-->
		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>STRIPED ROWS</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">
						...
						<form action="#" class="form-horizontal form-striped">
							<div class="form-content">
								...
								<div class="form-group">
									...
									<div class="col-md-5">
										<div class="radioer">
											<input type="radio" name="radioOption5" id="radioColor9" value="option1" checked="checked">
											<label for="radioColor9">Active</label>
										</div>
										<div class="radioer">
											<input type="radio" name="radioOption5" id="radioColor10" value="option1">
											<label for="radioColor10">Passive</label>
										</div>
									</div>
								</div><!--.form-group-->
		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>BORDERED ROWS</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">
						...
						<form action="#" class="form-horizontal form-bordered">
							<div class="form-content">
								...
								<div class="form-group">
									...
									<div class="col-md-5">
										<div class="radioer">
											<input type="radio" name="radioOption6" id="radioColor11" value="option1" checked="checked">
											<label for="radioColor11">Active</label>
										</div>
										<div class="radioer">
											<input type="radio" name="radioOption6" id="radioColor12" value="option1">
											<label for="radioColor12">Passive</label>
										</div>
									</div>
								</div><!--.form-group-->
		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>BORDERED &amp; STRIPED ROWS</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">

						<form action="#" class="form-horizontal form-striped form-bordered">
							<div class="form-content">
								<div class="form-group">
									<label class="control-label col-md-3">Full name</label>
									<div class="col-md-5">
								...
								<div class="form-group">
									...
									<div class="col-md-5">
										<div class="radioer">
											<input type="radio" name="radioOption7" id="radioColor13" value="option1" checked="checked">
											<label for="radioColor13">Active</label>
										</div>
										<div class="radioer">
											<input type="radio" name="radioOption7" id="radioColor14" value="option1">
											<label for="radioColor14">Passive</label>
										</div>
									</div>
								</div><!--.form-group-->
		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>TWO COLUMNS FORM</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">
										...
										<div class="form-group">
											...
											<div class="clearfix">
												<div class="radioer form-inline">
													<input type="radio" name="radioOption8" id="radioColor15" value="option1" checked="checked">
													<label for="radioColor15">Active</label>
												</div>
												<div class="radioer form-inline">
													<input type="radio" name="radioOption8" id="radioColor16" value="option1">
													<label for="radioColor16">Passive</label>
												</div>
											</div>
										</div>
									</div>
			...
			<ul>
				...
				<li>
					...
					<ul class="child-menu">
						...
						<li data-open-after="true"><a href="forms-layouts.html">Layouts</a></li>
