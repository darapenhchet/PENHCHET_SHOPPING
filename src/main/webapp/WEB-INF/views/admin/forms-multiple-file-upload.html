...
<!-- Mirrored from teamfox.co/themes/pleasure/app/admin1/forms-multiple-file-upload.html by HTTrack Website Copier/3.x [XR&CO'2013], Thu, 25 Jun 2015 06:35:47 GMT -->
<head>
	<meta charset="utf-8">
	<meta http-equiv="X-UA-Compatible" content="IE=edge">

	<title>PLEASURE - Multiple File Upload</title>
	...
	<div class="content">
			...
			<div class="row">
				...
				<div class="col-sm-6">
					<ol class="breadcrumb">
						...
						<li><a href="#" class="active">Multiple File Upload</a></li>
					</ol>
				</div><!--.col-->
			</div><!--.row-->
		</div><!--.page-header-->
			...
			<div class="col-md-12">
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>MULTIPLE FILE UPLOAD</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">
						...
						<form id="fileupload" action="http://teamfox.co/themes/pleasure/app/admin1/assets/plugins/jquery-file-upload/server/php/" method="POST" enctype="multipart/form-data">
		...
		<div class="footer-links margin-top-40">
			<div class="row no-gutters">
				...
				<div class="col-xs-6 bg-brown">
					<a href="forms-custom-file-input.html">
						<span class="state">Forms</span>
		...
		<!-- End of The template to display files available for download -->
					...
					<ul class="child-menu">
						...
						<li>
							...
							<ul class="child-menu">
								...
								<li data-open-after="true"><a href="forms-multiple-file-upload.html">Multiple File Upload</a></li>
...
<!-- Mirrored from teamfox.co/themes/pleasure/app/admin1/forms-multiple-file-upload.html by HTTrack Website Copier/3.x [XR&CO'2013], Thu, 25 Jun 2015 06:36:03 GMT -->
</html>