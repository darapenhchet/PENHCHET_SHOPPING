...
<!-- Mirrored from teamfox.co/themes/pleasure/app/admin1/forms-pickers.html by HTTrack Website Copier/3.x [XR&CO'2013], Thu, 25 Jun 2015 06:33:57 GMT -->
<head>
	<meta charset="utf-8">
	<meta http-equiv="X-UA-Compatible" content="IE=edge">

	<title>PLEASURE - Form Pickers</title>
...
<body>
	...
	<div class="content">
		...
		<div class="page-header full-content bg-brown">
			<div class="row">
				<div class="col-sm-6">
					<h1>Form Pickers <small>short description</small></h1>
				</div><!--.col-->
				<div class="col-sm-6">
					<ol class="breadcrumb">
						<li><a href="#"><i class="ion-home"></i></a></li>
						<li><a href="#">Forms</a></li>
						<li><a href="#" class="active">Pickers</a></li>
					</ol>
				</div><!--.col-->
			</div><!--.row-->
		</div><!--.page-header-->
			...
			<div class="col-md-12">
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>COLOR PICKERS</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">
							...
							<div class="col-md-9">
								<div class="inputer">
									<div class="input-wrapper">
										<input type="text" class="bs-colorpicker form-control" value="#5367ce">
									</div>
								</div>
							</div><!--.col-md-9-->
						</div><!--.row-->
						...
						<div class="row example-row">
							<div class="col-md-3">As a Component</div><!--.col-md-3-->
							<div class="col-md-9">
								<div class="input-group bs-colorpicker">
						...
						<div class="row example-row">
							<div class="col-md-3">RGBA</div><!--.col-md-3-->
							<div class="col-md-9">
								<div class="input-group bs-colorpicker-rgba">
									<span class="input-group-addon"><i></i></span>
									<div class="inputer">
										<div class="input-wrapper">
											<input type="text" value="rgba(178,79,194,1)" class="form-control">
										</div>
									</div>
								</div>
							</div><!--.col-md-9-->
						...
						<div class="row example-row">
							...
							<div class="col-md-9">
								...
								<button type="button" class="btn btn-default button-striped button-full-striped" data-toggle="modal" data-target="#bs-colorpicker-modal">Show in Modal Window</button>

								<div class="modal scale fade" id="bs-colorpicker-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
						...
						<div class="row example-row">
							<div class="col-md-3">Wheel</div><!--.col-md-3-->
							<div class="col-md-9">
								<div class="inputer">
									<div class="input-wrapper">
										<input type="text" class="form-control minicolors" data-control="wheel" value="#ff99ee">
									</div>
								</div>
							</div><!--.col-md-9-->
						</div><!--.row-->
						...
						<div class="row example-row">
							<div class="col-md-3">Opacity</div><!--.col-md-3-->
							<div class="col-md-9">
								<div class="inputer">
									<div class="input-wrapper">
										<input type="text" class="form-control minicolors" data-opacity=".5" value="#766fa8">
									</div>
								</div>
							</div><!--.col-md-9-->
						</div><!--.row-->
						...
						<div class="row example-row">
							<div class="col-md-3">Letter Case</div><!--.col-md-3-->
							<div class="col-md-9">
								<div class="inputer">
									<div class="input-wrapper">
										<input type="text" class="form-control minicolors" data-letterCase="uppercase" value="#abcdef">
									</div>
								</div>
							</div><!--.col-md-9-->
						</div><!--.row-->
						...
						<div class="row example-row">
							...
							<div class="col-md-9">
								<div class="inputer">
									<div class="input-wrapper">
										<input type="text" class="form-control minicolors" data-position="bottom right" value="#0088cc">
									</div>
								</div>
							</div><!--.col-md-9-->
						</div><!--.row-->
		...
		<div class="row">
			<div class="col-md-12">
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>DATE RANGE PICKERS</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">

						<div class="row example-row">
							<div class="col-md-3">Date Picker</div><!--.col-md-3-->
							<div class="col-md-9">
								...
								<div class="control-group">
									<div class="controls">
										<div class="input-group">
											...
											<div class="inputer">
												<div class="input-wrapper">
													<input type="text" style="width: 200px" name="birthday" class="form-control bootstrap-daterangepicker-basic" value="03/18/2013" />
												</div>
											</div>
										</div>
									</div>
						...
						<div class="row example-row">
							<div class="col-md-3">Range Picker</div><!--.col-md-3-->
							<div class="col-md-9">
								...
								<div class="control-group">
									<div class="controls">
										<div class="input-group">
											...
											<div class="inputer">
												<div class="input-wrapper">
													<input type="text" style="width: 200px" name="reservation" class="form-control bootstrap-daterangepicker-basic-range" value="03/18/2013 - 03/23/2013" />
												</div>
											</div>
										</div>
									</div>
						...
						<div class="row example-row">
							<div class="col-md-3">Range &amp; Time Picker</div><!--.col-md-3-->
							<div class="col-md-9">
								...
								<div class="control-group">
									<div class="controls">
										<div class="input-group">
											...
											<div class="inputer">
												<div class="input-wrapper">
													<input type="text" style="width: 400px" name="reservation" class="form-control bootstrap-daterangepicker-date-time" value="08/01/2013 1:00 PM - 08/01/2013 1:30 PM">
												</div>
											</div>
										</div>
									</div>
						...
						<div class="row example-row">
							<div class="col-md-3">Bootstrap Dropdown</div><!--.col-md-3-->
							<div class="col-md-9">

								<div class="btn btn-danger bootstrap-daterangepicker-dropdown" >
						...
						<div class="row example-row">
							<div class="col-md-3">Only Specific Ranges</div><!--.col-md-3-->
							<div class="col-md-9">

								<div class="btn btn-success bootstrap-daterangepicker-specific">
									<i class="glyphicon glyphicon-calendar fa fa-calendar"></i>
									<span>October 11, 2014 - October 17, 2014</span>
									<b class="caret"></b>
								</div>
		...
		<div class="row">
			<div class="col-md-12">
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>TIME PICKERS</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">

						<div class="row example-row">
							<div class="col-md-3">In Input</div><!--.col-md-3-->
							<div class="col-md-9">
								<div class="inputer">
									<div class="input-wrapper">
										<input type="text" id="clockface1" value="2:30 PM" data-format="hh:mm A" class="form-control">
									</div>
								</div>
							</div><!--.col-md-9-->
						</div><!--.row-->
						...
						<div class="row example-row">
							<div class="col-md-3">Button</div><!--.col-md-3-->
							<div class="col-md-9">

								<div class="input-group">
									<span id="clockface-toggle" class="input-group-addon">
										<i class="ion-android-calendar"></i>
									</span>
									<div class="inputer">
										<div class="input-wrapper">
											<input type="text" id="clockface2" value="14:30" class="form-control" readonly="">
										</div>
									</div>
								</div>
						...
						<div class="row example-row">
							<div class="col-md-3">Inline</div><!--.col-md-3-->
							<div class="col-md-9">
								<div id="clockface3" class="well" style="width: 210px;"></div>
							</div><!--.col-md-9-->
						</div><!--.row-->
			...
			<ul>
				...
				<li>
					...
					<ul class="child-menu">
						...
						<li data-open-after="true"><a href="forms-pickers.html">Pickers</a></li>
...
<!-- Mirrored from teamfox.co/themes/pleasure/app/admin1/forms-pickers.html by HTTrack Website Copier/3.x [XR&CO'2013], Thu, 25 Jun 2015 06:34:22 GMT -->
</html>