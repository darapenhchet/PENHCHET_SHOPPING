...
<!-- Mirrored from teamfox.co/themes/pleasure/app/admin1/forms-range-sliders.html by HTTrack Website Copier/3.x [XR&CO'2013], Thu, 25 Jun 2015 06:34:25 GMT -->
<head>
	<meta charset="utf-8">
	<meta http-equiv="X-UA-Compatible" content="IE=edge">

	<title>PLEASURE - Range Sliders</title>
	...
	<!-- BEGIN PLUGINS CSS -->
	<link rel="stylesheet" href="../../assets/globals/plugins/ion.rangeSlider/css/ion.rangeSlider.css">
	<link rel="stylesheet" href="../../assets/globals/plugins/ion.rangeSlider/css/ion.rangeSlider.skinFlat.css">

	<link rel="stylesheet" href="../../assets/globals/plugins/nouislider/distribute/jquery.nouislider.min.css">
	<link rel="stylesheet" href="../../assets/globals/plugins/nouislider/distribute/jquery.nouislider.pips.min.css">
...
<body>
	...
	<div class="content">
		...
		<div class="page-header full-content bg-brown">
			<div class="row">
				<div class="col-sm-6">
					<h1>Range Sliders <small>short description</small></h1>
				</div><!--.col-->
				<div class="col-sm-6">
					<ol class="breadcrumb">
						<li><a href="#"><i class="ion-home"></i></a></li>
						<li><a href="#">Forms</a></li>
						<li><a href="#" class="active">Range Sliders</a></li>
					</ol>
				</div><!--.col-->
			</div><!--.row-->
		</div><!--.page-header-->
			...
			<div class="col-md-12">
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>NO UI RANGE SLIDER</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">
						...
						<div class="row example-row">
							...
							<div class="col-md-9">
								<div class="nouislider nouislider-basic"></div>
							</div><!--.col-md-9-->
						</div><!--.row-->
						...
						<div class="row example-row">
							...
							<div class="col-md-9">
								<div class="nouislider nouislider-basic success margin-bottom-20"></div>
								<div class="nouislider nouislider-basic info margin-bottom-20"></div>
								<div class="nouislider nouislider-basic warning margin-bottom-20"></div>
								<div class="nouislider nouislider-basic danger margin-bottom-20"></div>
							</div><!--.col-md-9-->
						</div><!--.row-->

						<div class="row example-row">
							<div class="col-md-3">Range</div><!--.col-md-3-->
							<div class="col-md-9">
								<div class="nouislider nouislider-range"></div>
								<div class="well well-sm example-val nouislider-range-value"></div>
							</div><!--.col-md-9-->
						</div><!--.row-->

						<div class="row example-row">
							<div class="col-md-3">Stepping and Snapping to Value</div><!--.col-md-3-->
							<div class="col-md-9">
								<div class="nouislider nouislider-step"></div>
								<div class="well well-sm example-val nouislider-step-value"></div>
							</div><!--.col-md-9-->
						</div><!--.row-->

						<div class="row example-row">
							<div class="col-md-3">Getter and Setter Functions</div><!--.col-md-3-->
							<div class="col-md-9">
								<div class="nouislider nouislider-handle margin-bottom-10"></div>
								<button type="button" id="nouislider-handle-read" class="btn btn-xs btn-primary button-striped button-full-striped">Read slider value</button>
								<button type="button" id="nouislider-handle-set" class="btn btn-xs btn-danger button-striped button-full-striped">Set to 20</button>
							</div><!--.col-md-9-->
						</div><!--.row-->

						<div class="row example-row">
							<div class="col-md-3">Number Formatting</div><!--.col-md-3-->
							<div class="col-md-9">
								<div class="nouislider nouislider-formatting"></div>
								<div class="well well-sm example-val nouislider-formatting-value"></div>
							</div><!--.col-md-9-->
						</div><!--.row-->

						<div class="row example-row">
							<div class="col-md-3">Configurable Limits</div><!--.col-md-3-->
							<div class="col-md-9">
								<div class="nouislider nouislider-limit"></div>
								<div class="well well-sm">
									<ul>
										<li><span class="example-val nouislider-limit-value-min"></span></li>
										<li><span class="example-val nouislider-limit-value-max"></span></li>
									</ul>
								</div>
							</div><!--.col-md-9-->
						</div><!--.row-->
						...
						<div class="row example-row">
							<div class="col-md-3">Right to Left</div><!--.col-md-3-->
							<div class="col-md-9">
								<div class="nouislider nouislider-rtl"></div>
								<div class="well well-sm example-val nouislider-rtl-value"></div>
							</div><!--.col-md-9-->
						</div><!--.row-->

						<div class="row example-row">
							<div class="col-md-3">Toggle</div><!--.col-md-3-->
							<div class="col-md-9">

								<div class="pull-left">
									<div class="nouislider nouislider-toggle"></div>
								</div>
								<div class="pull-left margin-left-10">
									<div class="well well-sm example-val nouislider-toggle-value"></div>
								</div>
						...
						<div class="row example-row">
							<div class="col-md-3">Vertical</div><!--.col-md-3-->
							<div class="col-md-9">

								<div class="pull-left example-vertical">
									<div class="nouislider nouislider-vertical"></div>
								</div>
								<div class="pull-left margin-left-10">
									<div class="well well-sm example-val nouislider-vertical-value"></div>
								</div>
						...
						<div class="row example-row">
							<div class="col-md-3">Date</div><!--.col-md-3-->
							<div class="col-md-9">

								<div class="nouislider nouislider-date"></div>
								<div class="well well-sm">
									<ul>
										<li><span class="example-val nouislider-date-value-min"></span></li>
										<li><span class="example-val nouislider-date-value-max"></span></li>
									</ul>
								</div>
						...
						<div class="row example-row">
							<div class="col-md-3">Pips Addon</div><!--.col-md-3-->
							<div class="col-md-9">

								<div class="margin-bottom-50">
									<div class="nouislider nouislider-pips nouislider-pips-range-basic nouislider-pips-range"></div>
								</div>
						...
						<div class="row example-row">
							<div class="col-md-3">Pips Addon RTL</div><!--.col-md-3-->
							<div class="col-md-9">

								<div class="margin-bottom-50">
									<div class="nouislider nouislider-pips nouislider-pips-range-rtl nouislider-pips-range"></div>
								</div>
						...
						<div class="row example-row">
							<div class="col-md-3">Pips Addon Vertical</div><!--.col-md-3-->
							<div class="col-md-9">
								<div class="example-vertical margin-bottom-50">
									<div class="nouislider nouislider-pips nouislider-pips-range-vertical nouislider-pips-range"></div>
								</div>
							</div><!--.col-md-9-->
						</div><!--.row-->

						<div class="row example-row">
							<div class="col-md-3">Pips Addon Vertical RTL</div><!--.col-md-3-->
							<div class="col-md-9">
								<div class="example-vertical margin-bottom-50">
									<div class="nouislider nouislider-pips nouislider-pips-range-vertical-rtl nouislider-pips-range"></div>
								</div>
							</div><!--.col-md-9-->
						</div><!--.row-->

						<div class="row example-row">
							<div class="col-md-3">Pips Values</div><!--.col-md-3-->
							<div class="col-md-9">
								<div class="margin-bottom-50">
									<div class="nouislider nouislider-pips nouislider-pips-value-basic nouislider-pips-value"></div>
								</div>
							</div><!--.col-md-9-->
						</div><!--.row-->

						<div class="row example-row">
							<div class="col-md-3">Pips Positions</div><!--.col-md-3-->
							<div class="col-md-9">
								<div class="margin-bottom-50">
									<div class="nouislider nouislider-pips nouislider-pips-positions-basic nouislider-pips-positions"></div>
								</div>
							</div><!--.col-md-9-->
						</div><!--.row-->
		...
		<div class="row">
			<div class="col-md-12">
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>ION RANGE SLIDER</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">
						...
						<div class="row example-row">
							<div class="col-md-3">Basic</div><!--.col-md-3-->
							<div class="col-md-9">
								<input type="text" name="" class="ionrange-basic">
							</div><!--.col-md-9-->
						</div><!--.row-->

						<div class="row example-row">
							<div class="col-md-3">Money Range 1</div><!--.col-md-3-->
							<div class="col-md-9">
								<input type="text" name="" class="ionrange-money1">
							</div><!--.col-md-9-->
						</div><!--.row-->

						<div class="row example-row">
							<div class="col-md-3">Money Range 2</div><!--.col-md-3-->
							<div class="col-md-9">
								<input type="text" name="" class="ionrange-money2">
							</div><!--.col-md-9-->
						</div><!--.row-->

						<div class="row example-row">
							<div class="col-md-3">Measurement Range</div><!--.col-md-3-->
							<div class="col-md-9">
								<input type="text" name="" class="ionrange-carat">
							</div><!--.col-md-9-->
						</div><!--.row-->

						<div class="row example-row">
							<div class="col-md-3">Temperature Range</div><!--.col-md-3-->
							<div class="col-md-9">
								<input type="text" name="" class="ionrange-temperature">
							</div><!--.col-md-9-->
						</div><!--.row-->

						<div class="row example-row">
							<div class="col-md-3">Month Range</div><!--.col-md-3-->
							<div class="col-md-9">
								<input type="text" name="" class="ionrange-month">
							</div><!--.col-md-9-->
						</div><!--.row-->
						...
						<div class="row example-row">
							...
							<div class="col-md-9">
								<input type="text" name="" class="ionrange-callbacks margin-bottom-10">
								<div class="well well-sm">
									<ul>
										<li><span class="example-val ionrange-callbacks-value-min"></span></li>
										<li><span class="example-val ionrange-callbacks-value-max"></span></li>
									</ul>
								</div><!--.well-->
							</div><!--.col-md-9-->
						</div><!--.row-->
		...
		<div class="footer-links margin-top-40">
			<div class="row no-gutters">
				...
				<div class="col-xs-6 bg-brown">
					<a href="forms-selects.html">
						<span class="state">Forms</span>
						<span>Selectboxes</span>
			...
			<ul>
				...
				<li>
					...
					<ul class="child-menu">
						...
						<li data-open-after="true"><a href="forms-range-sliders.html">Range Slider</a></li>
	...
	<!-- BEGIN PLUGINS AREA -->
	<script src="../../assets/globals/plugins/ion.rangeSlider/js/ion.rangeSlider.min.js"></script>
	<script src="../../assets/globals/plugins/nouislider/distribute/jquery.nouislider.all.min.js"></script>
	<!-- END PLUGINS AREA -->

	<!-- PLUGINS INITIALIZATION AND SETTINGS -->
	<script src="../../assets/globals/scripts/forms-ion-range-slider.js"></script>
	<script src="../../assets/globals/scripts/forms-no-ui-slider.js"></script>
...
<!-- Mirrored from teamfox.co/themes/pleasure/app/admin1/forms-range-sliders.html by HTTrack Website Copier/3.x [XR&CO'2013], Thu, 25 Jun 2015 06:34:32 GMT -->
</html>