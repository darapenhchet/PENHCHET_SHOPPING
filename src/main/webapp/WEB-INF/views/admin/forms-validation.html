...
<!-- Mirrored from teamfox.co/themes/pleasure/app/admin1/forms-validation.html by HTTrack Website Copier/3.x [XR&CO'2013], Thu, 25 Jun 2015 06:34:50 GMT -->
<head>
	<meta charset="utf-8">
	<meta http-equiv="X-UA-Compatible" content="IE=edge">

	<title>PLEASURE - Form Validation</title>
...
<body>
	...
	<div class="content">
		...
		<div class="page-header full-content bg-brown">
			<div class="row">
				<div class="col-sm-6">
					<h1>Validation <small>short description</small></h1>
				</div><!--.col-->
				<div class="col-sm-6">
					<ol class="breadcrumb">
			...
			<div class="col-md-12">
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>FORM STATES</h4></div>
					</div><!--.panel-heading-->
						...
						<form action="#" class="form-horizontal">
							<div class="row">
								<div class="form-group has-success">
									<label class="control-label col-md-3" for="inputSuccess1">Input with success</label>
									<div class="col-md-5">
										<div class="inputer">
								...
								<div class="form-group has-warning">
									<label class="control-label col-md-3" for="inputWarning1">Input with warning</label>
									<div class="col-md-5">
										<div class="inputer">
											<div class="input-wrapper">
								...
								<div class="form-group has-error">
									<label class="control-label col-md-3" for="inputError1">Input with error</label>
									<div class="col-md-5">
										<div class="inputer">
											<div class="input-wrapper">
												<input type="text" class="form-control" id="inputError1" placeholder="Input with error">
											</div>
											<span class="help-block"><small>Please correct the error</small></span>
										</div>
									</div>
								</div>
							</div><!--.row-->
							...
							<div class="row">
								<div class="form-group has-success has-feedback">
									<label class="control-label col-md-3" for="inputSuccess2">Input with success</label>
									<div class="col-md-5">
										<div class="inputer">
											<div class="input-wrapper">
								...
								<div class="form-group has-warning has-feedback">
									<label class="control-label col-md-3" for="inputWarning2">Input with warning</label>
									<div class="col-md-5">
										<div class="inputer">
											<div class="input-wrapper">
								...
								<div class="form-group has-error has-feedback">
									<label class="control-label col-md-3" for="inputError2">Input with error</label>
									<div class="col-md-5">
										<div class="inputer">
											<div class="input-wrapper">
												<input type="text" class="form-control" id="inputError2">
												<span class="ion-android-alert tooltips form-control-feedback" data-toggle="tooltip" data-placement="top" title="Error tooltip"></span>
											</div>
										</div>
									</div>
								</div>
		...
		<div class="row">
			<div class="col-md-12">
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>BASIC VALIDATION</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">
							...
							<form action="#" class="form-horizontal parsley-validate">
								<div class="form-body">
									...
									<div class="form-group">
										<label class="control-label col-md-3">Input field</label>
										<div class="col-md-5">
											<div class="inputer">
												<div class="input-wrapper">
													<input type="text" name="basic-input" class="form-control" placeholder="type something" required>
												</div>
											</div>
										</div>
									</div><!--.form-group-->
									...
									<div class="form-group">
										...
										<div class="col-md-5">
											<div class="inputer">
												<div class="input-wrapper">
													<input type="email" name="basic-email" class="form-control" placeholder="someone@exmail.org" required>
												</div>
											</div>
										</div>
									</div><!--.form-group-->
									...
									<div class="form-group">
										...
										<div class="col-md-5">
											<div class="inputer">
												<div class="input-wrapper">
													<input type="number" name="basic-digits" class="form-control" placeholder="ex: 1,2,3" required>
												</div>
											</div>
										</div>
									</div><!--.form-group-->
									...
									<div class="form-group">
										...
										<div class="col-md-5">
											<div class="inputer">
												<div class="input-wrapper">
													<input type="url" name="basic-url" class="form-control" placeholder="http://www.themeforest.com" required>
												</div>
											</div>
										</div>
									</div><!--.form-group-->
									...
									<div class="form-group">
										...
										<div class="col-md-5">
											<div class="inputer">
												<div class="input-wrapper">
													<input type="text" name="minmax-limit" class="form-control" placeholder="age should be between 10 and 100" required>
												</div>
											</div>
										</div>
									</div><!--.form-group-->
									...
									<div class="form-group">
										...
										<div class="col-md-5">
											<div class="checkboxer">
												<input type="checkbox" id="check1" name="checkboxes1" value="" data-parsley-mincheck="2">
									...
									<div class="form-group">
										...
										<div class="col-md-5">
												...
												<div class="radioer">
													<input type="radio" name="radio1" id="radio3" value="option3" required>
									...
									<div class="form-group">
										...
										<div class="col-md-5">
											<div class="inputer">
												<div class="input-wrapper">
													<textarea name="basic-textarea" class="form-control" rows="3" placeholder="type minimum 5 characters" required></textarea>
												</div>
											</div>
										</div>
									</div><!--.form-group-->
		...
		<div class="row">
			<div class="col-md-12">
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>VALIDATION WITH ONLY ICONS</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">

						<div class="row">
							<form action="#" class="form-horizontal parsley-validate-icon">
								<div class="form-body">
									...
									<div class="form-group">
										...
										<div class="col-md-5">
											<div class="inputer">
												<div class="input-wrapper">
													<input type="text" name="form2-name" class="form-control" placeholder="write your name" required>
												</div>
											</div>
										</div>
									</div><!--.form-group-->
									...
									<div class="form-group">
										...
										<div class="col-md-5">
											<div class="inputer">
												<div class="input-wrapper">
													<input type="email" name="form2-email" class="form-control" placeholder="someone@exmail.org" required>
												</div>
											</div>
										</div>
									</div><!--.form-group-->
		...
		<div class="row">
			<div class="col-md-12">
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>PLUGIN INTEGRATION</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">
						...
						<div class="row">
							<form action="#" class="form-horizontal parsley-validate">
								<div class="form-body">
									...
									<div class="form-group">
										<label class="control-label col-md-3">Summernote WYSIWYG</label>
										<div class="col-md-9">
											<textarea class="form-control summernote-default" name="" required></textarea>
										</div>
									</div><!--.form-group-->
			...
			<ul>
				...
				<li>
					...
					<ul class="child-menu">
						...
						<li data-open-after="true"><a href="forms-validation.html">Form Validation</a></li>
...
<!-- Mirrored from teamfox.co/themes/pleasure/app/admin1/forms-validation.html by HTTrack Website Copier/3.x [XR&CO'2013], Thu, 25 Jun 2015 06:35:00 GMT -->
</html>