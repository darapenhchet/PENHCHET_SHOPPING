...
<!-- Mirrored from teamfox.co/themes/pleasure/app/admin1/forms-wizard.html by HTTrack Website Copier/3.x [XR&CO'2013], Thu, 25 Jun 2015 06:35:00 GMT -->
<head>
	<meta charset="utf-8">
	<meta http-equiv="X-UA-Compatible" content="IE=edge">

	<title>PLEASURE - Form Wizard</title>
	...
	<link rel="stylesheet" href="../../assets/globals/css/elements18db.css?v12">
	<!-- END CORE CSS -->
...
<body>
	...
	<div class="content">
		...
		<div class="page-header full-content bg-brown">
			<div class="row">
				<div class="col-sm-6">
					<h1>Wizard <small>short description</small></h1>
				</div><!--.col-->
				<div class="col-sm-6">
					<ol class="breadcrumb">
						<li><a href="#"><i class="ion-home"></i></a></li>
						<li><a href="#">Forms</a></li>
						<li><a href="#" class="active">Wizard</a></li>
					</ol>
				</div><!--.col-->
			</div><!--.row-->
		</div><!--.page-header-->
				...
				<div class="panel bs-wizard bs-wizard-progress">
						<div class="panel-heading">
							<div class="panel-title">
								<h4>FORM WIZARD WITH PROGRESS BAR</h4>
							...
							<form id="form1" method="post" action="#" class="form-horizontal">
								...
								<div class="tab-content">
									<div class="tab-pane" id="tab1">
										...
										<div class="form-group">
											...
											<div class="col-md-5">
												<div class="inputer">
													<div class="input-wrapper">
														<input id="mirror-password" type="password" name="password" class="form-control" placeholder="password" required>
													</div>
												</div>
											</div>
										</div><!--.form-group-->
									...
									<div class="tab-pane" id="tab2">
										<div class="form-group">
											<label class="control-label col-md-4">Facebook account</label>
											<div class="col-md-5">
												<div class="inputer">
													<div class="input-wrapper">
														<input type="text" name="facebook" class="form-control" placeholder="facebook username" required>
													</div>
												</div>
											</div>
										</div><!--.form-group-->
										<div class="form-group">
											<label class="control-label col-md-4">Twitter account</label>
											<div class="col-md-5">
												<div class="inputer">
													<div class="input-wrapper">
														<input type="text" name="twitter" class="form-control" placeholder="twitter username" required>
													</div>
												</div>
											</div>
										</div><!--.form-group-->
									...
									<div class="tab-pane" id="tab3">
										...
										<div class="form-group">
											<label class="control-label col-md-4">Your address</label>
											<div class="col-md-5">
												<div class="inputer">
													<div class="input-wrapper">
														<input type="text" name="address" class="form-control" placeholder="your postal address" required>
													</div>
												</div>
											</div>
										</div><!--.form-group-->
		...
		<div class="row">
			<div class="col-md-6">
				<div class="panel bs-wizard bs-wizard-steps">
							...
							<div class="panel-title">
								...
								<div class="steps-pull-right">
									<ul class="wizard-steps">
										<li class="step"><a href="#form2_tab1" data-toggle="tab" class="btn btn-primary">1</a></li>
										<li class="step"><a href="#form2_tab2" data-toggle="tab" class="btn btn-white">2</a></li>
										<li class="step"><a href="#form2_tab3" data-toggle="tab" class="btn btn-white">3</a></li>
									</ul>
						...
						<div class="panel-body">
							...
							<form id="form2" method="post" action="#" class="">

								<div class="tab-content">
									<div class="tab-pane" id="form2_tab1">
										...
										<div class="form-group">
											<div class="inputer">
												<div class="input-wrapper">
													<input id="mirror-password2" type="password" name="password" placeholder="Password" class="form-control" required>
												</div>
											</div>
										</div><!--.form-group-->
										<div class="form-group">
											<div class="inputer">
												<div class="input-wrapper">
													<input type="password" name="rpassword" class="form-control" placeholder="Password confirmation" required>
												</div>
											</div>
										</div><!--.form-group-->
									</div><!--.tab-pane-->
									...
									<div class="tab-pane" id="form2_tab2">
										<div class="form-group">
											<div class="inputer">
												<div class="input-wrapper">
													<input type="text" name="facebook" class="form-control" placeholder="Facebook account" required>
												</div>
											</div>
										</div><!--.form-group-->
										<div class="form-group">
											<div class="inputer">
												<div class="input-wrapper">
													<input type="text" name="twitter" class="form-control" placeholder="Twitter account" required>
												</div>
											</div>
										</div><!--.form-group-->
									</div><!--.tab-pane-->
			...
			<div class="col-md-6">
				<div class="panel bs-wizard bs-wizard-steps-with-progress">
						<div class="panel-heading">
							<div class="panel-title text-center"><h4>CUSTOM ICONS &amp; TITLE CONTROL</h4></div>
								...
								<div class="tab-content">
									<div class="tab-pane" id="form3_tab1">
										...
										<div class="form-group">
											<div class="inputer">
												<div class="input-wrapper">
													<input id="mirror-password3" type="password" name="password" class="form-control" placeholder="Password" required>
												</div>
											</div>
										</div><!--.form-group-->
		...
		<div class="row">
			<div class="col-md-12">
				<div class="panel bs-wizard bs-wizard-justified">
						<div class="panel-heading padding-0">
							<div class="panel-title text-center"><h4>JUSTIFIED STEPS</h4></div>
							<ul class="nav nav-justified">
								<li>
									<a href="#form4_tab1" data-toggle="tab">
										<p class="list-group-item-heading">Account Setup</p>
										<p class="list-group-item-text">Create your account</p>
									</a>
								</li>
								<li>
									<a href="#form4_tab2" data-toggle="tab">
										<p class="list-group-item-heading">Social Profiles</p>
										<p class="list-group-item-text">Your social accounts</p>
									</a>
								</li>
								<li>
									<a href="#form4_tab3" data-toggle="tab">
										<p class="list-group-item-heading">Personal Details</p>
										<p class="list-group-item-text">Your personal information</p>
									</a>
								</li>
							</ul>
						</div><!--.panel-heading-->
						<div class="panel-body">
							...
							<form id="form4" method="post" action="#" class="form-horizontal">
								<div class="tab-content">
									<div class="tab-pane" id="form4_tab1">
										<div class="form-group">
											<label class="control-label col-md-4">Email</label>
											<div class="col-md-5">
												<div class="inputer">
										...
										<div class="form-group">
											...
											<div class="col-md-5">
												<div class="inputer">
													<div class="input-wrapper">
														<input id="mirror-password4" type="password" name="password" class="form-control" placeholder="password" required>
													</div>
												</div>
											</div>
										</div><!--.form-group-->
									...
									<div class="tab-pane" id="form4_tab2">
										<div class="form-group">
											<label class="control-label col-md-4">Facebook account</label>
											<div class="col-md-5">
												<div class="inputer">
									...
									<div class="tab-pane" id="form4_tab3">
										<div class="form-group">
											<label class="control-label col-md-4">Your name</label>
											<div class="col-md-5">
												<div class="inputer">
			...
			<ul>
				...
				<li>
					...
					<ul class="child-menu">
						...
						<li data-open-after="true"><a href="forms-wizard.html">Wizard</a></li>
...
<!-- Mirrored from teamfox.co/themes/pleasure/app/admin1/forms-wizard.html by HTTrack Website Copier/3.x [XR&CO'2013], Thu, 25 Jun 2015 06:35:04 GMT -->
</html>