...
<!-- Mirrored from teamfox.co/themes/pleasure/app/admin1/forms-wysiwyg-editors.html by HTTrack Website Copier/3.x [XR&CO'2013], Thu, 25 Jun 2015 06:35:04 GMT -->
<head>
	<meta charset="utf-8">
	<meta http-equiv="X-UA-Compatible" content="IE=edge">

	<title>PLEASURE - Text Editors</title>
	...
	<link rel="stylesheet" href="../../assets/globals/plugins/bootstrap3-wysihtml5-bower/dist/bootstrap3-wysihtml5.min.css">
	<link rel="stylesheet" href="../../assets/globals/plugins/bootstrap-markdown/css/bootstrap-markdown.min.css">

	<link rel="stylesheet" href="../../assets/globals/plugins/medium-editor/dist/css/medium-editor.min.css">
	<link rel="stylesheet" href="../../assets/globals/plugins/medium-editor/dist/css/themes/default.min.css">
...
<body>
	...
	<div class="content">
		...
		<div class="page-header full-content bg-brown">
			<div class="row">
				<div class="col-sm-6">
					<h1>Text Editors <small>short description</small></h1>
				</div><!--.col-->
				<div class="col-sm-6">
					<ol class="breadcrumb">
						<li><a href="#"><i class="ion-home"></i></a></li>
						<li><a href="#">Forms</a></li>
						<li><a href="#" class="active">Text Editors</a></li>
					</ol>
				</div><!--.col-->
			</div><!--.row-->
		</div><!--.page-header-->
			...
			<div class="col-md-12">
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>SUMMERNOTE</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">
						...
						<div class="row example-row">
							...
							<div class="col-md-9">
								...
								<div class="summernote summernote-default">
									<strong>Lorem Ipsum</strong> is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took <a href="#">a galley of</a> type and scrambled it to make a type specimen book.
								</div>
						...
						<div class="row example-row">
							<div class="col-md-3">Click to Edit</div><!--.col-md-3-->
							<div class="col-md-9">

								<button id="summernote-edit" class="btn btn-xs btn-primary button-striped button-full-striped margin-bottom-10" type="button">Edit the text below</button>
								<button id="summernote-save" class="btn btn-xs btn-danger button-striped button-full-striped margin-bottom-10" type="button">Save</button>
								<div class="summernote summernote-click2edit">
									<strong>Lorem Ipsum</strong> is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took <a href="#">a galley of</a> type and scrambled it to make a type specimen book.
								</div>
						...
						<div class="row example-row">
							<div class="col-md-3">Air Mode</div><!--.col-md-3-->
							<div class="col-md-9">

								<div class="summernote summernote-airmode">
						...
						<div class="row example-row">
							<div class="col-md-3">RTL</div><!--.col-md-3-->
							<div class="col-md-9">

								<div class="rtl-support">
									<div class="summernote summernote-rtl">
										<strong>Lorem Ipsum</strong> is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took <a href="#">a galley of</a> type and scrambled it to make a type specimen book.
									</div>
								</div>
						...
						<div class="row example-row">
							<div class="col-md-3">In a Modal Window</div><!--.col-md-3-->
							<div class="col-md-9">

								<button type="button" class="btn btn-default button-striped button-full-striped" data-toggle="modal" data-target="#bs-summernote-modal">Show in Modal Window</button>

								<div class="modal fade" id="bs-summernote-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
									<div class="modal-dialog">
										<div class="modal-content">
											...
											<div class="modal-body">
												<div class="summernote summernote-modal">
													<strong>Lorem Ipsum</strong> is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took <a href="#">a galley of</a> type and scrambled it to make a type specimen book.
												</div><!--.summernote-->
											</div>
		...
		<div class="row">
			<div class="col-md-12">
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>BOOTSTRAP WYSIHTML5 EDITOR</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">
						...
						<div class="row example-row">
							...
							<div class="col-md-9">
								...
								<textarea class="bs-wysihtml5 form-control">
									<strong>Lorem Ipsum</strong> is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took <a href="#">a galley of</a> type and scrambled it to make a type specimen book.
								</textarea>
		...
		<div class="row">
			<div class="col-md-12">
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>MARKDOWN EDITOR</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">
						...
						<div class="row example-row">
							...
							<div class="col-md-9">
								...
								<textarea name="" data-provide="markdown" class="form-control example-textarea"></textarea>

							</div><!--.col-md-9-->
						</div><!--.row-->

						<div class="row example-row">
							<div class="col-md-3">Inline Editing</div><!--.col-md-3-->
							<div class="col-md-9">
		...
		<div class="row">
			<div class="col-md-12">
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>MEDIUM EDITOR</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">
						...
						<div class="row example-row">
							...
							<div class="col-md-9">
								...
								<div class="medium-editor medium-editor-basic">
			...
			<ul>
				...
				<li>
					...
					<ul class="child-menu">
						...
						<li data-open-after="true"><a href="forms-wysiwyg-editors.html">Text Editors</a></li>
						<li>
	...
	<script src="../../assets/globals/plugins/bootstrap3-wysihtml5-bower/dist/bootstrap3-wysihtml5.all.min.js"></script>

	<script src="../../assets/globals/plugins/bootstrap-markdown/js/bootstrap-markdown.js"></script>

	<script src="../../assets/globals/plugins/medium-editor/dist/js/classList.min.js"></script>
	<script src="../../assets/globals/plugins/medium-editor/dist/js/medium-editor.min.js"></script>
	<!-- END PLUGINS AREA -->

	<!-- PLUGINS INITIALIZATION AND SETTINGS -->
	<script src="../../assets/globals/scripts/forms-wysiwyg.js"></script>
...
<!-- Mirrored from teamfox.co/themes/pleasure/app/admin1/forms-wysiwyg-editors.html by HTTrack Website Copier/3.x [XR&CO'2013], Thu, 25 Jun 2015 06:35:25 GMT -->
</html>