...
<!-- Mirrored from teamfox.co/themes/pleasure/app/admin1/grids-bootstrap-extra.html by HTTrack Website Copier/3.x [XR&CO'2013], Thu, 25 Jun 2015 06:37:46 GMT -->
<head>
	<meta charset="utf-8">
	<meta http-equiv="X-UA-Compatible" content="IE=edge">

	<title>PLEASURE - Bootstrap Extra</title>
...
<body>
	...
	<div class="content">
		...
		<div class="page-header full-content bg-pink">
			<div class="row">
				<div class="col-sm-6">
					<h1>Bootstrap Extra <small>short description</small></h1>
				</div><!--.col-->
				<div class="col-sm-6">
					<ol class="breadcrumb">
						<li><a href="#"><i class="ion-home"></i></a></li>
						<li><a href="#">Grids</a></li>
						<li><a href="#" class="active">Bootstrap Extra</a></li>
					</ol>
				</div><!--.col-->
			</div><!--.row-->
		</div><!--.page-header-->
			...
			<div class="col-md-6 col-centered">
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>CENTERED ONE HALF</h4></div>
					</div><!--.panel-heading-->
		...
		<div class="row no-gutters">
			<div class="col-md-6">
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>NO GUTTERS ONE HALF</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">
						<p>Collaboratively administrate empowered markets via plug-and-play networks. Dynamically procrastinate B2C users after installed base benefits. Dramatically visualize customer directed convergence without revolutionary ROI.</p>
					</div><!--.panel-body-->
		...
		<div class="row">
			<div class="col-md-3 col-sm-4 col-xs-6">
				<div class="square-helper"></div>
				<div class="square-content">Square Column</div>
			...
			<ul>
				...
				<li>
					...
					<ul class="child-menu">
						...
						<li data-open-after="true"><a href="grids-bootstrap-extra.html">Extra Grids</a></li>
