...
<!-- Mirrored from teamfox.co/themes/pleasure/app/admin1/layout-fixed-footer-links.html by HTTrack Website Copier/3.x [XR&CO'2013], Thu, 25 Jun 2015 06:37:46 GMT -->
<head>
	<meta charset="utf-8">
	<meta http-equiv="X-UA-Compatible" content="IE=edge">

	<title>PLEASURE - Fixed Footer Links</title>
...
<body class="fixed-footer">
	...
	<div class="content">
		...
		<div class="page-header full-content bg-orange">
			<div class="row">
				<div class="col-sm-6">
					<h1>Fixed Footer Links <small>short description</small></h1>
				</div><!--.col-->
				<div class="col-sm-6">
					<ol class="breadcrumb">
						<li><a href="#"><i class="ion-home"></i></a></li>
						<li><a href="#">Layouts</a></li>
						<li><a href="#" class="active">Fixed Footer Links</a></li>
					</ol>
				</div><!--.col-->
			</div><!--.row-->
		</div><!--.page-header-->
			...
			<ul>
				...
				<li>
					...
					<ul class="child-menu">
						...
						<li data-open-after="true"><a href="layout-fixed-footer-links.html">Fixed Footer Links</a></li>
