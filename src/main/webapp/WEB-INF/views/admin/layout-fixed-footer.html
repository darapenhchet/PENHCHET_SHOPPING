...
<!-- Mirrored from teamfox.co/themes/pleasure/app/admin1/layout-fixed-footer.html by HTTrack Website Copier/3.x [XR&CO'2013], Thu, 25 Jun 2015 06:37:46 GMT -->
<head>
	<meta charset="utf-8">
	<meta http-equiv="X-UA-Compatible" content="IE=edge">

	<title>PLEASURE - Fixed Footer</title>
...
<body class="fixed-footer">
	...
	<div class="content">
		...
		<div class="page-header full-content bg-orange">
			<div class="row">
				<div class="col-sm-6">
					<h1>Fixed Footer <small>short description</small></h1>
				</div><!--.col-->
				<div class="col-sm-6">
					<ol class="breadcrumb">
						<li><a href="#"><i class="ion-home"></i></a></li>
						<li><a href="#">Layouts</a></li>
						<li><a href="#" class="active">Fixed Footer</a></li>
					</ol>
				</div><!--.col-->
			</div><!--.row-->
		</div><!--.page-header-->
		...
		<div class="row">
			<div class="col-md-2">
				<h2>Very Long Content for Fixed Footers</h2>
		...
		<div class="footer bg-grey margin-top-40">
			PLEASURE Material Design Dashboard Panel
			<ul class="social">
				<li><a href="layout-fixed-footer-links.html"><i class="ion-arrow-left-c"></i></a></li>
				<li><a href="layout-settings.html"><i class="ion-arrow-right-c"></i></a></li>
			</ul>
		</div><!--.footer-->
			...
			<ul>
				...
				<li>
					...
					<ul class="child-menu">
						...
						<li data-open-after="true"><a href="layout-fixed-footer.html">Fixed Footer</a></li>
