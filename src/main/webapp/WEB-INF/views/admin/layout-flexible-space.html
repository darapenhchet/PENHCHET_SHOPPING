<!DOCTYPE html>
<!--[if lt IE 7]>      <html class="no-js lt-ie9 lt-ie8 lt-ie7 flexible-space"> <![endif]-->
<!--[if IE 7]>         <html class="no-js lt-ie9 lt-ie8 flexible-space"> <![endif]-->
<!--[if IE 8]>         <html class="no-js lt-ie9 flexible-space"> <![endif]-->
<!--[if gt IE 8]><!--> <html class="no-js flexible-space"> <!--<![endif]-->

<!-- Mirrored from teamfox.co/themes/pleasure/app/admin1/layout-flexible-space.html by HTTrack Website Copier/3.x [XR&CO'2013], Thu, 25 Jun 2015 06:37:46 GMT -->
<head>
	<meta charset="utf-8">
	<meta http-equiv="X-UA-Compatible" content="IE=edge">

	<title>PLEASURE - Flexible Space</title>
...
<body class="fixed-footer">
	...
	<div class="content">
		...
		<div class="page-header full-content bg-orange">
			<div class="row">
				<div class="col-sm-6">
					<h1>Flexible Space <small>short description</small></h1>
				</div><!--.col-->
				<div class="col-sm-6">
					<ol class="breadcrumb">
						<li><a href="#"><i class="ion-home"></i></a></li>
						<li><a href="#">Layouts</a></li>
						<li><a href="#" class="active">Flexible Space</a></li>
					</ol>
				</div><!--.col-->
			</div><!--.row-->
		</div><!--.page-header-->
		...
		<div class="flexible-content">
			<div class="row row-centered">
				<div class="col-md-8 col-centered">
					...
					<p>Sometimes a page doesnt have enough space to push the footer at the bottom. For this time, you need flexible space. </p>
					<p>Add flexible-space to html element and put your content inside flexible-content div.</p>
				</div><!--.col-->
			</div><!--.row-->
		...
		<div class="menu-layer">
			<ul>
				...
				<li>
					...
					<ul class="child-menu">
						<li data-open-after="true"><a href="layout-flexible-space.html">Flexible Space</a></li>
