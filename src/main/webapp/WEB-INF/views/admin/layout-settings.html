...
<!-- Mirrored from teamfox.co/themes/pleasure/app/admin1/layout-settings.html by HTTrack Website Copier/3.x [XR&CO'2013], Thu, 25 Jun 2015 06:37:46 GMT -->
<head>
	<meta charset="utf-8">
	<meta http-equiv="X-UA-Compatible" content="IE=edge">

	<title>PLEASURE - Layout Settings</title>
...
<body>
	...
	<div class="content">
		...
		<div class="page-header full-content bg-orange">
			<div class="row">
				<div class="col-sm-6">
					<h1>Layout Settings <small>short description</small></h1>
				</div><!--.col-->
				<div class="col-sm-6">
					<ol class="breadcrumb">
						<li><a href="#"><i class="ion-home"></i></a></li>
						<li><a href="#">Layouts</a></li>
						<li><a href="#" class="active">Layout Settings</a></li>
					</ol>
				</div><!--.col-->
			</div><!--.row-->
		</div><!--.page-header-->
			...
			<div class="col-md-8 col-centered">
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>CHANGE LAYOUT SETTINGS</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">

						<div class="row margin-bottom-20">
							<div class="col-md-8">Theme Colors <br><small class="text-muted">Check nav, search, messages after change the theme color</small></div><!--.col-->
							<div class="col-md-4">
								<select class="selecter" id="theme-color" data-style="btn-indigo">
						...
						<div class="row margin-bottom-20">
							<div class="col-md-8">Right to Left Support</div><!--.col-->
							<div class="col-md-4">
								<div class="checkboxer checkboxer-indigo pull-right">
									<input type="checkbox" id="rtl-support" value="option1">
									<label for="rtl-support"></label>
								</div>
							</div><!--.col-->
						</div><!--.row-->

						<div class="row margin-bottom-20">
							<div class="col-md-8">Improve Opening Performance <br><small class="text-muted">Content area won't be scaled while opening nav, search, messages</small></div><!--.col-->
							<div class="col-md-4">
								<div class="checkboxer checkboxer-indigo pull-right">
									<input type="checkbox" id="improve-performance" value="option1" checked="checked">
									<label for="improve-performance"></label>
								</div>
							</div><!--.col-->
						</div><!--.row-->
			...
			<ul>
				...
				<li>
					...
					<ul class="child-menu">
						...
						<li data-open-after="true"><a href="layout-settings.html">Layout Settings</a></li>
					</ul>
				</li>
				<li>
