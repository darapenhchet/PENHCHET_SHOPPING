...
<!-- Mirrored from teamfox.co/themes/pleasure/app/admin1/maps-google.html by HTTrack Website Copier/3.x [XR&CO'2013], Thu, 25 Jun 2015 06:38:21 GMT -->
<head>
	<meta charset="utf-8">
	<meta http-equiv="X-UA-Compatible" content="IE=edge">

	<title>PLEASURE - Google Maps</title>
...
<body>
	...
	<div class="content">
		...
		<div class="page-header full-content bg-purple">
			<div class="row">
				<div class="col-sm-6">
					<h1>Google Maps <small>short description</small></h1>
				</div><!--.col-->
				<div class="col-sm-6">
					<ol class="breadcrumb">
						<li><a href="#"><i class="ion-home"></i></a></li>
						<li><a href="#">Maps</a></li>
						<li><a href="#" class="active">Google Maps</a></li>
					</ol>
				</div><!--.col-->
			</div><!--.row-->
		</div><!--.page-header-->
		...
		<div class="row">
			<div class="col-md-6">
				<div class="panel">
					...
					<div class="panel-body">
						<div id="gmaps_1" class="example-map"></div>
					</div><!--.panel-body-->
				</div><!--.panel-->
			</div><!--.col-md-6-->
			...
			<div class="col-md-6">
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>CONTEXTUAL MENU</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">
						<div id="gmaps_2" class="example-map"></div>
					</div><!--.panel-body-->
				</div><!--.panel-->
			</div><!--.col-md-6-->
		...
		<div class="row">
			...
			<div class="col-md-6">
				<div class="panel">
							...
							<div class="panel-inputs">
								<form method="post" id="geocoding_form">
									<div class="input-group">
										<input type="text" id="address" name="address" class="form-control input-circle-left" placeholder="Place">
					...
					<div class="panel-body">
						<div id="gmaps_3" class="example-map"></div>
					</div><!--.panel-body-->
				</div><!--.panel-->
			</div><!--.col-md-6-->
		...
		<div class="row">
			...
			<div class="col-md-6">
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>CLOUD LAYER</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">
						<div id="gmaps_7" class="example-map"></div>
					</div><!--.panel-body-->
				</div><!--.panel-->
			</div><!--.col-md-6-->
			...
			<div class="col-md-6">
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>TRAFFIC LAYER</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">
						<div id="gmaps_8" class="example-map"></div>
					</div><!--.panel-body-->
				</div><!--.panel-->
			</div><!--.col-md-6-->
		...
		<div class="row">
			...
			<div class="col-md-6">
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>EVENTS</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">
						<div id="gmaps_9" class="example-map"></div>
					</div><!--.panel-body-->
				</div><!--.panel-->
			</div><!--.col-md-6-->
			...
			<div class="col-md-6">
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>STYLED</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">
						<div id="gmaps_10" class="example-map"></div>
					</div><!--.panel-body-->
				</div><!--.panel-->
			</div><!--.col-md-6-->
		...
		<div class="menu-layer">
			<ul>
				...
				<li>
					...
					<ul class="child-menu">
						<li data-open-after="true"><a href="maps-google.html">Google Maps</a></li>
