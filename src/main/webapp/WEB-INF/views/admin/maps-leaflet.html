...
<!-- Mirrored from teamfox.co/themes/pleasure/app/admin1/maps-leaflet.html by HTTrack Website Copier/3.x [XR&CO'2013], Thu, 25 Jun 2015 06:38:21 GMT -->
<head>
	<meta charset="utf-8">
	<meta http-equiv="X-UA-Compatible" content="IE=edge">

	<title>PLEASURE - Leaflet Maps</title>
	...
	<!-- BEGIN PLUGINS CSS -->
	<link rel="stylesheet" href="../../assets/globals/plugins/leaflet/dist/leaflet.css">
...
<body>
	...
	<div class="content">
		...
		<div class="page-header full-content bg-purple">
			<div class="row">
				<div class="col-sm-6">
					<h1>Leaflet Maps <small>short description</small></h1>
				</div><!--.col-->
				<div class="col-sm-6">
					<ol class="breadcrumb">
						<li><a href="#"><i class="ion-home"></i></a></li>
						<li><a href="#">Maps</a></li>
						<li><a href="#" class="active">Leaflet Maps</a></li>
					</ol>
				</div><!--.col-->
			</div><!--.row-->
		</div><!--.page-header-->
			...
			<div class="col-md-12">
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>CUSTOM ICONS</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">
						<div id="lm_2" class="example-map"></div>
					</div><!--.panel-body-->
				</div><!--.panel-->
			</div><!--.col-md-12-->
		...
		<div class="row">
			...
			<div class="col-md-12">
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>LAYER GROUPS</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">
						<div id="lm_3" class="example-map"></div>
					</div><!--.panel-body-->
				</div><!--.panel-->
			</div><!--.col-md-12-->
			...
			<ul>
				...
				<li>
					...
					<ul class="child-menu">
						...
						<li data-open-after="true"><a href="maps-leaflet.html">Leaflet Maps</a></li>
	...
	<!-- BEGIN PLUGINS AREA -->
	<script src="../../assets/globals/plugins/leaflet/dist/leaflet.js"></script>
	<!-- END PLUGINS AREA -->

	<!-- PLUGINS INITIALIZATION AND SETTINGS -->
	<script src="../../assets/globals/scripts/maps-leaflet.js"></script>
...
<!-- Mirrored from teamfox.co/themes/pleasure/app/admin1/maps-leaflet.html by HTTrack Website Copier/3.x [XR&CO'2013], Thu, 25 Jun 2015 06:38:22 GMT -->
</html>