...
<!-- Mirrored from teamfox.co/themes/pleasure/app/admin1/maps-vector.html by HTTrack Website Copier/3.x [XR&CO'2013], Thu, 25 Jun 2015 06:38:23 GMT -->
<head>
	<meta charset="utf-8">
	<meta http-equiv="X-UA-Compatible" content="IE=edge">

	<title>PLEASURE - Vector Maps</title>
	...
	<!-- BEGIN PLUGINS CSS -->
	<link rel="stylesheet" href="../../assets/globals/plugins/jqvmap/jqvmap/jqvmap.css">
...
<body>
	...
	<div class="content">
		...
		<div class="page-header full-content bg-purple">
			<div class="row">
				<div class="col-sm-6">
					<h1>Vector Maps <small>short description</small></h1>
				</div><!--.col-->
				<div class="col-sm-6">
					<ol class="breadcrumb">
						<li><a href="#"><i class="ion-home"></i></a></li>
						<li><a href="#">Maps</a></li>
						<li><a href="#" class="active">Vector Maps</a></li>
					</ol>
				</div><!--.col-->
			</div><!--.row-->
		</div><!--.page-header-->
			...
			<div class="col-md-12">
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>WORLD</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">
						<div id="vmaps_1" class="example-map"></div>
					</div><!--.panel-body-->
				</div><!--.panel-->
			</div><!--.col-md-12-->
		</div><!--.row-->
		...
		<div class="row">
			<div class="col-md-12">
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>EUROPE</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">
						<div id="vmaps_2" class="example-map"></div>
					</div><!--.panel-body-->
				</div><!--.panel-->
			</div><!--.col-md-12-->
		</div><!--.row-->
		...
		<div class="row">
			...
			<div class="col-md-6">
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>USA</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">
						<div id="vmaps_3" class="example-map"></div>
					</div><!--.panel-body-->
				</div><!--.panel-->
			</div><!--.col-md-6-->
			...
			<div class="col-md-6">
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>GERMANY</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">
						<div id="vmaps_4" class="example-map"></div>
					</div><!--.panel-body-->
				</div><!--.panel-->
			</div><!--.col-md-6-->
		...
		<div class="footer-links margin-top-40 bg-purple">
			...
			<ul>
				...
				<li>
					...
					<ul class="child-menu">
						...
						<li data-open-after="true"><a href="maps-vector.html">Vector Maps</a></li>
					</ul>
				</li>
				<li>
	...
	<!-- BEGIN PLUGINS AREA -->
	<script src="../../assets/globals/plugins/jqvmap/jqvmap/jquery.vmap.min.js"></script>
	<script src="../../assets/globals/plugins/jqvmap/jqvmap/maps/jquery.vmap.world.js"></script>
	<script src="../../assets/globals/plugins/jqvmap/jqvmap/maps/continents/jquery.vmap.europe.js"></script>
	<script src="../../assets/globals/plugins/jqvmap/jqvmap/maps/jquery.vmap.usa.js"></script>
	<script src="../../assets/globals/plugins/jqvmap/jqvmap/maps/jquery.vmap.germany.js"></script>

	<script src="../../assets/globals/plugins/jqvmap/jqvmap/data/jquery.vmap.sampledata.js"></script>
	<!-- END PLUGINS AREA -->

	<!-- PLUGINS INITIALIZATION AND SETTINGS -->
	<script src="../../assets/globals/scripts/maps-vector.js"></script>
...
<!-- Mirrored from teamfox.co/themes/pleasure/app/admin1/maps-vector.html by HTTrack Website Copier/3.x [XR&CO'2013], Thu, 25 Jun 2015 06:38:50 GMT -->
</html>