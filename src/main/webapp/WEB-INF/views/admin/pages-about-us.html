...
<!-- Mirrored from teamfox.co/themes/pleasure/app/admin1/pages-about-us.html by HTTrack Website Copier/3.x [XR&CO'2013], Thu, 25 Jun 2015 06:36:44 GMT -->
<head>
	<meta charset="utf-8">
	<meta http-equiv="X-UA-Compatible" content="IE=edge">

	<title>PLEASURE - About Us</title>
...
<body>
	...
	<div class="content">
		...
		<div class="page-header full-content">
			<div class="row">
				<div class="col-sm-6">
					<h1>About Us <small>short description</small></h1>
				</div><!--.col-->
				<div class="col-sm-6">
					<ol class="breadcrumb">
					...
					<div class="panel-body">
						...
						<div class="row client-list">
							<div class="col-md-3 col-sm-6 col-xs-6">
								<a href="#"><img src="../../assets/globals/img/brands/1.png" alt=""></a>
							</div>
							<div class="col-md-3 col-sm-6 col-xs-6">
								<a href="#"><img src="../../assets/globals/img/brands/2.png" alt=""></a>
							</div>
							<div class="col-md-3 col-sm-6 col-xs-6">
								<a href="#"><img src="../../assets/globals/img/brands/3.png" alt=""></a>
							</div>
							<div class="col-md-3 col-sm-6 col-xs-6">
								<a href="#"><img src="../../assets/globals/img/brands/4.png" alt=""></a>
							</div>
							<div class="col-md-3 col-sm-6 col-xs-6">
								<a href="#"><img src="../../assets/globals/img/brands/5.png" alt=""></a>
							</div>
							<div class="col-md-3 col-sm-6 col-xs-6">
								<a href="#"><img src="../../assets/globals/img/brands/6.png" alt=""></a>
							</div>
							<div class="col-md-3 col-sm-6 col-xs-6">
								<a href="#"><img src="../../assets/globals/img/brands/7.png" alt=""></a>
							</div>
							<div class="col-md-3 col-sm-6 col-xs-6">
								<a href="#"><img src="../../assets/globals/img/brands/8.png" alt=""></a>
							</div>
						</div><!--.row.client-list-->
						...
						<div class="row no-gutters">
							...
							<div class="col-md-3 col-sm-4 col-xs-6">
								<div class="card card-user-new">
									<img src="../../assets/globals/img/faces/large/1.jpg" class="member-image" alt="">
									<div class="card-body">
										<h5>James Ramos</h5>
										<h6>Web Developer</h6>
							...
							<div class="col-md-3 col-sm-4 col-xs-6">
								<div class="card card-user-new">
									<img src="../../assets/globals/img/faces/large/2.jpg" class="member-image" alt="">
									<div class="card-body">
							...
							<div class="col-md-3 col-sm-4 col-xs-6">
								<div class="card card-user-new">
									<img src="../../assets/globals/img/faces/large/3.jpg" class="member-image" alt="">
									<div class="card-body">
							...
							<div class="col-md-3 col-sm-4 col-xs-6">
								<div class="card card-user-new">
									<img src="../../assets/globals/img/faces/large/4.jpg" class="member-image" alt="">
									<div class="card-body">
										<h5>Justin Bowman</h5>
							...
							<div class="col-md-3 col-sm-4 col-xs-6">
								<div class="card card-user-new">
									<img src="../../assets/globals/img/faces/large/5.jpg" class="member-image" alt="">
									<div class="card-body">
										<h5>Eric Santos</h5>
										<h6>Integration Designer</h6>
										<ul class="social-links list-inline">
											<li><a href="#"><i class="fa fa-github"></i></a></li>
											<li><a href="#"><i class="fa fa-twitter"></i></a></li>
											<li><a href="#"><i class="fa fa-linkedin"></i></a></li>
							...
							<div class="col-md-3 col-sm-4 col-xs-6">
								<div class="card card-user-new">
									<img src="../../assets/globals/img/faces/large/6.jpg" class="member-image" alt="">
									<div class="card-body">
										<h5>Mildred Bennett</h5>
										<h6>Usability Architect</h6>
										<ul class="social-links list-inline">
											<li><a href="#"><i class="fa fa-github"></i></a></li>
											<li><a href="#"><i class="fa fa-twitter"></i></a></li>
											<li><a href="#"><i class="fa fa-linkedin"></i></a></li>
							...
							<div class="col-md-3 col-sm-4 col-xs-6">
								<div class="card card-user-new">
									<img src="../../assets/globals/img/faces/large/7.jpg" class="member-image" alt="">
									<div class="card-body">
										<h5>Peter Hicks</h5>
										<h6>Implementation Executive</h6>
										<ul class="social-links list-inline">
											<li><a href="#"><i class="fa fa-github"></i></a></li>
											<li><a href="#"><i class="fa fa-twitter"></i></a></li>
											<li><a href="#"><i class="fa fa-linkedin"></i></a></li>
							...
							<div class="col-md-3 col-sm-4 col-xs-6">
								<div class="card card-user-new">
									<img src="../../assets/globals/img/faces/large/8.jpg" class="member-image" alt="">
									<div class="card-body">
										<h5>Brittany Kelley</h5>
										<h6>Usability Director</h6>
										<ul class="social-links list-inline">
											<li><a href="#"><i class="fa fa-github"></i></a></li>
											<li><a href="#"><i class="fa fa-twitter"></i></a></li>
											<li><a href="#"><i class="fa fa-linkedin"></i></a></li>
			...
			<ul>
				...
				<li>
					...
					<ul class="child-menu">
						...
						<li data-open-after="true"><a href="pages-about-us.html">About Us</a></li>
...
<!-- Mirrored from teamfox.co/themes/pleasure/app/admin1/pages-about-us.html by HTTrack Website Copier/3.x [XR&CO'2013], Thu, 25 Jun 2015 06:37:18 GMT -->
</html>