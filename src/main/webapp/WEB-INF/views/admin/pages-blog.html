...
<!-- Mirrored from teamfox.co/themes/pleasure/app/admin1/pages-blog.html by HTTrack Website Copier/3.x [XR&CO'2013], Thu, 25 Jun 2015 06:36:28 GMT -->
<head>
	<meta charset="utf-8">
	<meta http-equiv="X-UA-Compatible" content="IE=edge">

	<title>PLEASURE - Blog</title>
	...
	<!-- BEGIN PLUGINS CSS -->
	<link rel="stylesheet" href="../../assets/globals/plugins/fluidbox/css/fluidbox.css">
...
<body>
	...
	<div class="content">
		...
		<div class="page-header brown full-content parallax opacity-hero" style="height: 600px; overflow: hidden">
			<div class="parallax-bg" style="background: url('../../assets/globals/img/picjumbo/large/29.jpg') 50% 50%; background-size: cover; width: 100%; height: 100%; position: absolute; left: 0; top: 0;">
			</div>

			<div class="row">
				<div class="col-sm-6">
					<h1>Blog <small>short description</small></h1>
				</div><!--.col-->
				<div class="col-sm-6">
					<ol class="breadcrumb">
		...
		<div class="row">
			<div class="col-md-12">
				<h1 class="text-center margin-bottom-40">Fox and its family</h1>
			</div><!--.col-->
		</div><!--.row-->
		...
		<div class="row">
			<div class="col-md-8 col-md-offset-2">
				...
				<p><span class="drop-caps drop-caps-borderless">E</span>fficiently unleash cross-media information without cross-media value. Quickly maximize timely deliverables for real-time schemas. Dramatically maintain clicks-and-mortar solutions without functional solutions.</p>

				<p>Completely synergize resource sucking relationships via premier niche markets. Professionally cultivate one-to-one customer service with robust ideas. Dynamically innovate resource-leveling customer service for state of the art customer service.</p>

				<blockquote class="blockquote-primary">
					"Have some shots on the popular page of dribbble and assume yourself as a celebrity in design community."
					<small>by <cite>Ben Jacob</cite></small>
				</blockquote>

				<p>Seems simple, right? You’re constantly recharging your phone because you’re running apps that keep sending and receiving data, which consumes power. So turn off some of those apps.</p>

				<p>But first you have to find them. Then you have to catch them red-handed. Those are the hard parts.</p>
		...
		<div class="row image-row margin-top-40 margin-bottom-40">
			...
			<div class="col-md-4">
				<a href="../../assets/globals/img/picjumbo/5.jpg" data-fluidbox><img src="../../assets/globals/img/picjumbo/5.jpg" alt=""></a>
			</div><!--.col-->

			<div class="col-md-4">
				<a href="../../assets/globals/img/picjumbo/6.jpg" data-fluidbox><img src="../../assets/globals/img/picjumbo/6.jpg" alt=""></a>
			</div><!--.col-->

			<div class="col-md-4">
				<a href="../../assets/globals/img/picjumbo/7.jpg" data-fluidbox><img src="../../assets/globals/img/picjumbo/7.jpg" alt=""></a>
			</div><!--.col-->
		...
		<div class="row">
			<div class="col-md-8 col-md-offset-2">
				...
				<ul class="inline-list">
					<li><span class="badge">WORLD</span></li>
					<li><span class="badge">CULTURE</span></li>
					<li><span class="badge">POLITICS</span></li>
					<li><span class="badge">SPORT</span></li>
				</ul>
				...
				<div class="col-md-8 col-md-offset-2">
					...
					<div class="comments">
						...
						<div class="comment comment-box">
							<div class="user-photo"><img src="../../assets/globals/img/faces/19.jpg" alt=""></div>
							<div class="comment-body">

								<div class="input-group">
									<div class="inputer">
										<div class="input-wrapper">
											<textarea rows="1" class="form-control js-auto-size" placeholder="Join the discussion"></textarea>
										</div>
									</div><!--.inputer-->
						...
						<div class="comment">
							...
							<div class="comment-body">
								...
								<div class="comment">
									<div class="user-photo"><img src="../../assets/globals/img/faces/10.jpg" alt=""></div>
									<div class="comment-body">
										<div class="user">
											<ul class="inline-list dot-seperator">
												<li><a href="#">Daniel Lawson</a></li>
												<li class="small">1 hour ago</li>
											</ul>
										</div><!--.user-->
										<p>Efficiently unleash cross-media information without cross-media value. Quickly maximize timely deliverables for real-time schemas. Dramatically maintain clicks-and-mortar solutions without functional solutions.</p>
										<div class="comment-footer">
								...
								<div class="comment">
									<div class="user-photo"><img src="../../assets/globals/img/faces/11.jpg" alt=""></div>
									<div class="comment-body">
									<div class="user">
										<ul class="inline-list dot-seperator">
											<li><a href="#">Linda Adams</a></li>
											<li class="small">2 minutes ago</li>
										</ul>
									</div><!--.user-->
										<p>Completely synergize resource sucking relationships via premier niche markets. Professionally cultivate one-to-one customer service with robust ideas. Dynamically innovate resource-leveling customer service for state of the art customer service.</p>
										<div class="comment-footer">
						...
						<div class="comment">
							<div class="user-photo"><img src="../../assets/globals/img/faces/14.jpg" alt=""></div>
							<div class="comment-body">
								<ul class="inline-list dot-seperator">
									<li><a href="#">Russell Jackson</a></li>
									<li class="small">1 week ago</li>
								</ul>
			...
			<ul>
				...
				<li>
					...
					<ul class="child-menu">
						...
						<li data-open-after="true"><a href="pages-blog.html">Blog</a></li>
	...
	<script src="../../assets/globals/plugins/fluidbox/jquery.fluidbox.min.js"></script>
	<script src="../../assets/globals/scripts/fluidbox.js"></script>
...
<!-- Mirrored from teamfox.co/themes/pleasure/app/admin1/pages-blog.html by HTTrack Website Copier/3.x [XR&CO'2013], Thu, 25 Jun 2015 06:36:44 GMT -->
</html>