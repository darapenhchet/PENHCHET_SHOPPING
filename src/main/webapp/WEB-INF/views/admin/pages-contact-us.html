...
<!-- Mirrored from teamfox.co/themes/pleasure/app/admin1/pages-contact-us.html by HTTrack Website Copier/3.x [XR&CO'2013], Thu, 25 Jun 2015 06:37:22 GMT -->
<head>
	<meta charset="utf-8">
	<meta http-equiv="X-UA-Compatible" content="IE=edge">

	<title>PLEASURE - Contact Us</title>
...
<body>
	...
	<div class="content">
		...
		<div class="page-header full-content">
			<div class="row">
				<div class="col-sm-6">
					<h1>Contact Us <small>short description</small></h1>
				</div><!--.col-->
				<div class="col-sm-6">
					<ol class="breadcrumb">
									...
									<div class="col-md-6">
										...
										<div class="clearfix">
											<div class="radioer form-inline">
												<input type="radio" name="radioContact" id="radioContact1" value="option1">
												<label for="radioContact1">Active</label>
											</div>
											<div class="radioer form-inline">
												<input type="radio" name="radioContact" id="radioContact2" value="option1">
												<label for="radioContact2">Passive</label>
											</div>
										</div>
			...
			<ul>
				...
				<li>
					...
					<ul class="child-menu">
						...
						<li data-open-after="true"><a href="pages-contact-us.html">Contact Us</a></li>
	...
	<script src="../../assets/globals/scripts/contact-us.js"></script>
...
<!-- Mirrored from teamfox.co/themes/pleasure/app/admin1/pages-contact-us.html by HTTrack Website Copier/3.x [XR&CO'2013], Thu, 25 Jun 2015 06:37:23 GMT -->
</html>