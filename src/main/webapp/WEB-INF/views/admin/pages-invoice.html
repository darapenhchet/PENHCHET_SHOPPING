...
<!-- Mirrored from teamfox.co/themes/pleasure/app/admin1/pages-invoice.html by HTTrack Website Copier/3.x [XR&CO'2013], Thu, 25 Jun 2015 06:37:23 GMT -->
<head>
	<meta charset="utf-8">
	<meta http-equiv="X-UA-Compatible" content="IE=edge">

	<title>PLEASURE - Invoice</title>
...
<body>
	...
	<div class="content">
		...
		<div class="page-header full-content">
			<div class="row">
				<div class="col-sm-6">
					<h1>Invoice <small>short description</small></h1>
				</div><!--.col-->
				<div class="col-sm-6">
					<ol class="breadcrumb">
					...
					<div class="panel-heading">
						<div class="panel-title">
							...
							<div class="panel-buttons">
								<button type="button" class="btn btn-primary print-trigger">Print</button>
							</div><!--.panel-buttons-->
						</div><!--.panel-title-->
					</div><!--.panel-heading-->
							...
							<div class="invoice-heading">
								...
								<div class="row customer-row">
									<div class="col-md-6 col-xs-6 company">
										<a href="#" class="company-logo"><img src="../../assets/admin1/img/logo-blue-large%402x.png" alt=""></a>
										<h5>TeamFox</h5>
								...
								<table class="table table-hover">
									...
									<tbody>
										...
										<tr>
											<td>2</td>
											<td>
												Analytics Tool Membership
												<small>Dynamically procrastinate B2C users after installed base benefits.</small>
											</td>
										...
										<tr>
											<td>3</td>
											<td>
												Project Management Tool<small>Collaboratively administrate empowered markets via plug-and-play networks.</small>
											</td>
		...
		<div class="footer-links margin-top-40">
			<div class="row no-gutters">
				<div class="col-xs-6 bg-indigo">
					<a href="pages-404.html" target="_blank">
			...
			<ul>
				...
				<li>
					...
					<ul class="child-menu">
						...
						<li data-open-after="true"><a href="pages-invoice.html">Invoice</a></li>
	...
	<!-- BEGIN PLUGINS AREA -->
	<script src="../../assets/globals/plugins/jsbarcode/JsBarcode.all.min.js"></script>
	<!-- END PLUGINS AREA -->

	<!-- PLUGINS INITIALIZATION AND SETTINGS -->
	<script src="../../assets/globals/scripts/invoice.js"></script>
...
<!-- Mirrored from teamfox.co/themes/pleasure/app/admin1/pages-invoice.html by HTTrack Website Copier/3.x [XR&CO'2013], Thu, 25 Jun 2015 06:37:25 GMT -->
</html>