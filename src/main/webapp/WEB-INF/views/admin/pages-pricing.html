...
<!-- Mirrored from teamfox.co/themes/pleasure/app/admin1/pages-pricing.html by HTTrack Website Copier/3.x [XR&CO'2013], Thu, 25 Jun 2015 06:37:25 GMT -->
<head>
	<meta charset="utf-8">
	<meta http-equiv="X-UA-Compatible" content="IE=edge">

	<title>PLEASURE - Pricing Tables</title>
...
<body>
	...
	<div class="content">
		...
		<div class="page-header full-content">
			<div class="row">
				<div class="col-sm-6">
					<h1>Pricing Tables <small>short description</small></h1>
				</div><!--.col-->
				<div class="col-sm-6">
					<ol class="breadcrumb">
		...
		<div class="row">
			<div class="col-md-4">
				<div class="card card-pricing card-pricing-simple">
					...
					<div class="card-heading">
						<h4>LIGHT</h4>
						<h5>
							<span><i class="currency">$</i><i class="price">9</i> <i class="renewal">per month</i></span>
						</h5>
					</div><!--.card-heading-->

					<div class="card-body">
						<ul class="pricing-features pricing-features-hover text-center">
					...
					<div class="card-footer">
						<a href="#" class="btn btn-block btn-primary">Start Free Trial</a>
					</div><!--.card-footer-->
			...
			<div class="col-md-4">
				<div class="card card-pricing card-pricing-simple active">

					<div class="card-heading">
						<h4>REGULAR</h4>
						<h5>
							<span><i class="currency">$</i><i class="price">49</i> <i class="renewal">per month</i></span>
						</h5>
					</div><!--.card-heading-->
			...
			<div class="col-md-4">
				<div class="card card-pricing card-pricing-simple">
					...
					<div class="card-heading">
						<h4>EXTENDED</h4>
						<h5>
							<span><i class="currency">$</i><i class="price">99</i> <i class="renewal">per month</i></span>
						</h5>
					</div><!--.card-heading-->
			...
			<div class="col-md-3">
				<div class="card card-pricing card-pricing-dark">
					...
					<div class="card-heading">
						<h4>PROFESSIONAL</h4>
						<h5>
							<span><i class="currency">$</i><i class="price">69</i> <i class="renewal">per month</i></span>
						</h5>
					</div><!--.card-heading-->
		...
		<div class="row">
			...
			<div class="col-md-4">
				<div class="card card-pricing card-pricing-justified">
					...
					<div class="card-heading">
						<h4>LIGHT</h4>
						<h5>
							<span><i class="currency">$</i><i class="price">9</i>/<i class="renewal">mo</i></span>
						</h5>
					</div><!--.card-heading-->

					<div class="card-body">
						<ul class="pricing-features pricing-features-hover">
							<li>Memory <span class="feature">1 GB</span></li>
							<li>Processor <span class="feature">1 Core</span></li>
							<li>SSD Disk <span class="feature">150 GB</span></li>
							<li>Transfer <span class="feature">5 TB</span></li>
							<li>24/7 Customer Support <span><i class="fa fa-check"></i></span></li>
							<li class="disabled">Private Networking</li>
							<li class="disabled">DNS Management</li>
							<li class="disabled">SSL</li>
						</ul>
					</div><!--.card-body-->
			...
			<div class="col-md-4">
				<div class="card card-pricing card-pricing-justified active">

					<div class="card-heading">
						<h4>REGULAR</h4>
						<h5>
							<span><i class="currency">$</i><i class="price">49</i>/<i class="renewal">mo</i></span>
						</h5>
					</div><!--.card-heading-->

					<div class="card-body">
						<ul class="pricing-features pricing-features-hover">
							<li>Memory <span class="feature">2 GB</span></li>
							<li>Processor <span class="feature">2 Core</span></li>
							<li>SSD Disk <span class="feature">200 GB</span></li>
							<li>Transfer <span class="feature">10 TB</span></li>
							<li>24/7 Customer Support <span><i class="fa fa-check"></i></span></li>
							<li>Private Networking <span><i class="fa fa-check"></i></span></li>
							<li>DNS Management <span><i class="fa fa-check"></i></span></li>
							<li class="disabled">SSL</li>
						</ul>
					</div><!--.card-body-->
			...
			<div class="col-md-4">
				<div class="card card-pricing card-pricing-justified">
					...
					<div class="card-heading">
						<h4>PREMIUM</h4>
						<h5>
							<span><i class="currency">$</i><i class="price">99</i>/<i class="renewal">mo</i></span>
						</h5>
					</div><!--.card-heading-->

					<div class="card-body">
						<ul class="pricing-features pricing-features-hover">
							<li>Memory <span class="feature">5 GB</span></li>
							<li>Processor <span class="feature">4 Core</span></li>
							<li>SSD Disk <span class="feature">250 GB</span></li>
							<li>Transfer <span class="feature">20 TB</span></li>
							<li>24/7 Customer Support <span><i class="fa fa-check"></i></span></li>
							<li>Private Networking <span><i class="fa fa-check"></i></span></li>
							<li>DNS Management <span><i class="fa fa-check"></i></span></li>
							<li>SSL <span><i class="fa fa-check"></i></span></li>
						</ul>
					</div><!--.card-body-->
			...
			<table class="table table-condensed table-hover">
				<thead>
					<tr>
						<th></th>
						<th>
							<span class="pack">LIGHT</span>
							<span class="price-container">
								<i class="currency">$</i><i class="price">9</i> <i class="renewal">month</i>
							</span>
						</th>
						<th class="active">
							<span class="pack">REGULAR</span>
							<span class="price-container">
								<i class="currency">$</i><i class="price">49</i> <i class="renewal">month</i>
							</span>
						</th>
						<th>
							<span class="pack">PREMIUM</span>
							<span class="price-container">
								<i class="currency">$</i><i class="price">99</i> <i class="renewal">month</i>
							</span>
						</th>
					</tr>
				</thead>
				<tbody>
					<tr>
						<td class="categories">Memory</td>
						<td>1 GB</td>
						<td class="active">2 GB</td>
						<td>5 GB</td>
					</tr>
					<tr>
						<td class="categories">Processor</td>
						<td>1 Core</td>
						<td class="active">2 Core</td>
						<td>4 Core</td>
					</tr>
					<tr>
						<td class="categories">SSD Disk</td>
						<td>150 GB</td>
						<td class="active">200 GB</td>
						<td>250 GB</td>
					</tr>
					<tr>
						<td class="categories">Transfer</td>
						<td>5 TB</td>
						<td class="active">10 TB</td>
						<td>20 TB</td>
					</tr>
					<tr>
						<td class="categories">Private Networking</td>
						<td><i class="fa fa-times"></i></td>
						<td class="active"><i class="fa fa-check"></i></td>
						<td><i class="fa fa-check"></i></td>
					</tr>
					<tr>
						<td class="categories">SSL</td>
						<td><i class="fa fa-times"></i></td>
						<td class="active"><i class="fa fa-times"></i></td>
						<td><i class="fa fa-check"></i></td>
					</tr>
				</tbody>
				<tfoot>
					<tr>
						<th></th>
						<th><a href="#" class="btn btn-block btn-primary">Order Now</a></th>
						<th class="active"><a href="#" class="btn btn-block btn-primary">Order Now</a></th>
						<th><a href="#" class="btn btn-block btn-primary">Order Now</a></th>
					</tr>
				</tfoot>
			</table>
			...
			<ul>
				...
				<li>
					...
					<ul class="child-menu">
						...
						<li data-open-after="true"><a href="pages-pricing.html">Pricing Tables</a></li>
