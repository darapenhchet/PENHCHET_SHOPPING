...
<!-- Mirrored from teamfox.co/themes/pleasure/app/admin1/pages-search-results.html by HTTrack Website Copier/3.x [XR&CO'2013], Thu, 25 Jun 2015 06:37:25 GMT -->
<head>
	<meta charset="utf-8">
	<meta http-equiv="X-UA-Compatible" content="IE=edge">

	<title>PLEASURE - Search Results</title>
				...
				<div class="panel">
					<div class="panel-heading">
						...
						<ul class="nav nav-tabs with-panel portlet-handle-cancel">
							<li class="active"><a href="#search-file" data-toggle="tab">File</a></li>
							<li><a href="#search-news" data-toggle="tab">News</a></li>
							<li><a href="#search-users" data-toggle="tab">Users</a></li>
						</ul>
					</div><!--.panel-heading-->
									...
									<ul class="search-list list-hover">
										<li>
											...
											<div class="search-result">
												<h6><a href="#">Checklist Before Submitting.pdf</a></h6>
												<p class="source"><a href="#">/Users/Teamfox/Documents/Envato/Themeforest/Checklist Before Submitting.pdf</a></p>
										...
										<li>
											<div class="file-icon"><a href="#"><i class="fa fa-file-excel-o excel"></i></a></div><!--.file-icon-->
											<div class="search-result">
												<h6><a href="#">Teamfox-annual-report.xls</a></h6>
												<p class="source"><a href="#">http://www.teamfox.co/files/Teamfox-annual-report.xls</a></p>
												<ul class="list-inline">
													<li>4.3MB</li>
										...
										<li>
											<div class="file-icon"><a href="#"><i class="fa fa-file-word-o word"></i></a></div><!--.file-icon-->
											<div class="search-result">
												<h6><a href="#">License Aggrement.docx</a></h6>
												<p class="source"><a href="#">/Users/Teamfox/Documents/Envato/Themeforest/License Aggrement.docx</a></p>
												<ul class="list-inline">
													<li>2.9MB</li>
										...
										<li>
											<div class="file-icon"><a href="#"><i class="fa fa-file-powerpoint-o powerpoint"></i></a></div><!--.file-icon-->
											<div class="search-result">
												<h6><a href="#">Presantation of new <span class="highlight">theme</span>s.pptx</a></h6>
												<p class="source"><a href="#">/Users/Teamfox/Documents/Envato/Themeforest/Presantation of new themes.pptx</a></p>
												<ul class="list-inline">
													<li>5.6MB</li>
													<li><i class="fa fa-calendar-o"></i> 08.18.2014</li>
										...
										<li>
											<div class="file-icon"><a href="#"><i class="fa fa-file-audio-o audio"></i></a></div><!--.file-icon-->
											<div class="search-result">
												<h6><a href="#"><span class="highlight">Theme</span> Song.wav</a></h6>
												<p class="source"><a href="#">/Users/Teamfox/Documents/Teamfox/Theme Song.wav</a></p>
												<ul class="list-inline">
													<li>2.7MB</li>
										...
										<li>
											<div class="file-icon"><a href="#"><i class="fa fa fa-file-archive-o"></i></a></div><!--.file-icon-->
											<div class="search-result">
												<h6><a href="#">Pleasure-Dashboard.zip</a></h6>
												<p class="source"><a href="#">http://www.teamfox.co/files/Pleasure-Dashboard.zip</a></p>
												<ul class="list-inline">
													<li>3.5MB</li>
										...
										<li>
											<div class="file-icon"><a href="#"><i class="fa fa-file-image-o image"></i></a></div><!--.file-icon-->
											<div class="search-result">
												<h6><a href="#">Teamfox-Logo.jpg</a></h6>
												<p class="source"><a href="#">http://www.teamfox.co/images/teamfox-Logo.jpg</a></p>
												<ul class="list-inline">
													<li>108KB</li>
										...
										<li>
											<div class="file-icon"><a href="#"><i class="fa fa-file-text-o text"></i></a></div><!--.file-icon-->
											<div class="search-result">
												<h6><a href="#">LICENSE.txt</a></h6>
												<p class="source"><a href="#">http://www.teamfox.co/LICENSE.txt</a></p>
												<ul class="list-inline">
													<li>5KB</li>
										...
										<li>
											<div class="file-icon"><a href="#"><i class="fa fa-file-o file"></i></a></div><!--.file-icon-->
											<div class="search-result">
												<h6><a href="#">.htaccess</a></h6>
												<p class="source"><a href="#">http://www.teamfox.co/.htaccess</a></p>
												<ul class="list-inline">
													<li>5KB</li>
										...
										<li>
											<div class="file-icon"><a href="#"><i class="fa fa-file-video-o video"></i></a></div><!--.file-icon-->
											<div class="search-result">
												<h6><a href="#">Last Summer with best friend.mp4</a></h6>
												<p class="source"><a href="#">http://www.different-theme-domain.com/video/Last Summer with best friend.mp4</a></p>
												<ul class="list-inline">
													<li>1.2GB</li>
										...
										<li>
											<div class="file-icon"><a href="#"><i class="fa fa-file-code-o code"></i></a></div><!--.file-icon-->
											<div class="search-result">
												<h6><a href="#">main.min.js</a></h6>
												<p class="source"><a href="#">http://www.teamfox.co/assets/js/main.min.js</a></p>
												<ul class="list-inline">
													<li>88KB</li>
								...
								<div class="search-results">
									<div class="row">
										<div class="col-md-6">
											...
											<div class="card card-news">
												<div class="card-heading bg-black bg-image bg-opaque7 sample-bg-image5">
													<a href="#" class="author"><img src="../../assets/globals/img/faces/20.jpg" alt=""></a>
													<h3 class="card-title">Solutions <small>1h ago</small></h3><!--.card-title-->
												</div><!--.card-heading-->
										...
										<div class="col-md-6">
											...
											<div class="card card-news">
												<div class="card-heading bg-black bg-image bg-opaque7 sample-bg-image6">
													<a href="#" class="author"><img src="../../assets/globals/img/faces/15.jpg" alt=""></a>
													<h3 class="card-title"><i class="heading-icon fa fa-life-ring"></i> Not so much time <small>4h ago</small></h3><!--.card-title-->
												</div><!--.card-heading-->
										...
										<div class="col-md-6">
											...
											<div class="card card-news">
												<div class="card-heading bg-black bg-image bg-opaque7 sample-bg-image8">
													<a href="#" class="author"><img src="../../assets/globals/img/faces/21.jpg" alt=""></a>
													<h3 class="card-title"><i class="heading-icon fa fa-life-ring"></i> Travel Plan <small>1d ago</small></h3><!--.card-title-->
												</div><!--.card-heading-->
										...
										<div class="col-md-6">
											...
											<div class="card card-news">
												<div class="card-heading bg-black bg-image bg-opaque7 sample-bg-image13">
													<a href="#" class="author"><img src="../../assets/globals/img/faces/13.jpg" alt=""></a>
													<h3 class="card-title"><i class="heading-icon fa fa-life-ring"></i> Writing Documentation <small>1w ago</small></h3><!--.card-title-->
												</div><!--.card-heading-->
									...
									<div class="col-md-4">
										<div class="card card-user">
											<div class="card-heading heading-center text-color-white">
												...
												<h3 class="card-title"><a href="#">Mariana Barboza</a></h3>
												<div class="subhead">Lead Marketing Manager</div>
											</div><!--.card-heading-->

											<div class="card-body">
												<p>I'm Mariana, a Lead Marketing Manager from Brazil &amp; currently working on <a href="#">Sety</a>, <a href="#">T-Project</a> and <a href="#">TeamFox</a>.</p>
									...
									<div class="col-md-4">
										<div class="card card-user turquoise">
											<div class="card-heading heading-center text-color-white">
												...
												<h3 class="card-title"><a href="#">Beverly Turner</a></h3>
												<div class="subhead">Chief Brand Associate</div>
											</div><!--.card-heading-->

											<div class="card-body">
												<p>I'm Beverly Turner, a Chief Brand Associate from Brazil &amp; currently working on <a href="#">Sety</a>, <a href="#">T-Project</a> and <a href="#">TeamFox</a>.</p>
												<ul class="social-links">
													<li><a href="#"><i class="fa fa-github"></i></a></li>
													<li><a href="#"><i class="fa fa-twitter"></i></a></li>
													<li><a href="#"><i class="fa fa-linkedin"></i></a></li>
									...
									<div class="col-md-4">
										<div class="card card-user amethyst">
											<div class="card-heading heading-center text-color-white">
												...
												<h3 class="card-title"><a href="#">Teresa Kelly</a></h3>
												<div class="subhead">Regional Solutions Supervisor</div>
											</div><!--.card-heading-->

											<div class="card-body">
												<p>I'm Teresa, a Regional Solutions Supervisor from Brazil &amp; currently working on <a href="#">Sety</a>, <a href="#">T-Project</a> and <a href="#">TeamFox</a>.</p>
												<ul class="social-links">
													<li><a href="#"><i class="fa fa-github"></i></a></li>
													<li><a href="#"><i class="fa fa-twitter"></i></a></li>
													<li><a href="#"><i class="fa fa-linkedin"></i></a></li>
									...
									<div class="col-md-4">
										<div class="card card-user wet-asphalt">
											<div class="card-heading heading-center text-color-white">
												...
												<h3 class="card-title"><a href="#">Jennifer Martinez</a></h3>
												<div class="subhead">Dynamic Response Assistant</div>
											</div><!--.card-heading-->

											<div class="card-body">
												<p>I'm Jennifer, a Dynamic Response Assistant from Brazil &amp; currently working on <a href="#">Sety</a>, <a href="#">T-Project</a> and <a href="#">TeamFox</a>.</p>
												<ul class="social-links">
													<li><a href="#"><i class="fa fa-github"></i></a></li>
													<li><a href="#"><i class="fa fa-twitter"></i></a></li>
													<li><a href="#"><i class="fa fa-linkedin"></i></a></li>
									...
									<div class="col-md-4">
										<div class="card card-user carrot">
											<div class="card-heading heading-center text-color-white">
												...
												<h3 class="card-title"><a href="#">Andrea Rivera</a></h3>
												<div class="subhead">Internal Quality Planner</div>
											</div><!--.card-heading-->

											<div class="card-body">
												<p>I'm Andrea, an Internal Quality Planner from Brazil &amp; currently working on <a href="#">Sety</a>, <a href="#">T-Project</a> and <a href="#">TeamFox</a>.</p>
												<ul class="social-links">
													<li><a href="#"><i class="fa fa-github"></i></a></li>
													<li><a href="#"><i class="fa fa-twitter"></i></a></li>
													<li><a href="#"><i class="fa fa-linkedin"></i></a></li>
									...
									<div class="col-md-4">
										<div class="card card-user pomegranate">
											<div class="card-heading heading-center text-color-white">
												...
												<h3 class="card-title"><a href="#">Marilyn Gomez</a></h3>
												<div class="subhead">Product Usability Specialist</div>
											</div><!--.card-heading-->

											<div class="card-body">
												<p>I'm Marilyn, a Product Usability Specialist from Brazil &amp; currently working on <a href="#">Sety</a>, <a href="#">T-Project</a> and <a href="#">TeamFox</a>.</p>
												<ul class="social-links">
													<li><a href="#"><i class="fa fa-github"></i></a></li>
													<li><a href="#"><i class="fa fa-twitter"></i></a></li>
													<li><a href="#"><i class="fa fa-linkedin"></i></a></li>
			...
			<ul>
				...
				<li>
					...
					<ul class="child-menu">
						...
						<li data-open-after="true"><a href="pages-search-results.html">Search Results</a></li>
