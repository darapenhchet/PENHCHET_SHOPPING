...
<!-- Mirrored from teamfox.co/themes/pleasure/app/admin1/pages-timeline.html by HTTrack Website Copier/3.x [XR&CO'2013], Thu, 25 Jun 2015 06:37:25 GMT -->
<head>
	<meta charset="utf-8">
	<meta http-equiv="X-UA-Compatible" content="IE=edge">

	<title>PLEASURE - Timeline</title>
...
<body>
	...
	<div class="content">
		...
		<div class="page-header full-content">
			<div class="row">
				<div class="col-sm-6">
					<h1>Timeline <small>short description</small></h1>
				</div><!--.col-->
				<div class="col-sm-6">
					<ol class="breadcrumb">
			...
			<div class="col-md-12">
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>MIRROR TIMELINE</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">
						...
						<div class="timeline">
							<div class="frame">
									...
									<span class="timeline-date">17 October 2014</span>
									<div class="timeline-bubble">
										<h4>Without Cross-Media</h4>
							...
							<div class="frame">
								...
								<span class="timeline-date">17 September 2014</span>
								<div class="timeline-content">

									<div class="widget widget-event">
										<div class="widget-heading widget-bgimage sample-bg-image12">
										</div><!--.widget-heading-->
							...
							<div class="frame">
								...
								<span class="timeline-date">17 August 2014</span>
								<div class="timeline-bubble">
							...
							<div class="frame">
								...
								<span class="timeline-date">17 July 2014</span>
								<div class="timeline-content">

									<div class="widget widget-quote">
										<div class="widget-full-bg widget-bgimage sample-bg-image11"></div>
										<div class="widget-body text-color-white">
											<div class="quote">
		...
		<div class="row">
			<div class="col-md-6">
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>ONE SIDE TIMELINE</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">
			...
			<div class="col-md-6">
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>ONE SIDE TIMELINE RTL</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">

						<div class="timeline single rtl">
							<div class="frame">
								<div class="timeline-badge">
									<i class="fa fa-headphones"></i>
								</div><!--.timeline-badge-->
			...
			<ul>
				...
				<li>
					...
					<ul class="child-menu">
						...
						<li data-open-after="true"><a href="pages-timeline.html">Timeline</a></li>
