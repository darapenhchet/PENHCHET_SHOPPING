...
<!-- Mirrored from teamfox.co/themes/pleasure/app/admin1/panels-ajax.html by HTTrack Website Copier/3.x [XR&CO'2013], Thu, 25 Jun 2015 06:32:45 GMT -->
<head>
	<meta charset="utf-8">
	<meta http-equiv="X-UA-Compatible" content="IE=edge">

	<title>PLEASURE - Ajax Panels</title>
...
<body>
	...
	<div class="content">
		...
		<div class="page-header full-content bg-teal">
			<div class="row">
				<div class="col-sm-6">
					<h1>Ajax Panels <small>short description</small></h1>
				</div><!--.col-->
				<div class="col-sm-6">
					<ol class="breadcrumb">
						<li><a href="#"><i class="ion-home"></i></a></li>
						<li><a href="#">Panels</a></li>
						<li><a href="#" class="active">Ajax Panels</a></li>
					</ol>
				</div><!--.col-->
			</div><!--.row-->
		</div><!--.page-header-->
		...
		<div class="row">
				...
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title">
							<h4>REFRESH WHOLE BODY CONTENT</h4>
							<div class="panel-action">
								<a href="javascript:;" data-init-load="true" data-toggle="reload" data-ajax-target="demo/ajax.html" data-ajax-selector="inside"></a>
							</div><!--.panel-action-->
						</div><!--.panel-title-->
					</div><!--.panel-heading-->
			...
			<div class="col-md-6">
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title">
							<h4>TO THE SELECTOR</h4>
							<div class="panel-action">
								<a href="javascript:;" data-toggle="reload" data-ajax-target="demo/ajax.html" data-ajax-selector="#ajax-selector"></a>
							</div><!--.panel-action-->
						</div><!--.panel-title-->
					</div><!--.panel-heading-->
					<div class="panel-body">
						<p>Collaboratively administrate empowered markets via plug-and-play networks. Dynamically procrastinate B2C users after installed base benefits.</p>
						<div id="ajax-selector" class="text-primary">This content will change after click the refresh button.</div><!--#ajax-selector-->
					</div><!--.panel-body-->
				</div><!--.panel-->
			</div><!--.col-->
		...
		<div class="row">
			...
			<div class="col-md-6">
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title">
							<h4>PREPEND THE CONTENT</h4>
							<div class="panel-action">
								<a href="javascript:;" data-toggle="reload" data-ajax-target="demo/ajax.html" data-ajax-selector="prepend"></a>
							</div><!--.panel-action-->
						</div><!--.panel-title-->
					</div><!--.panel-heading-->
					<div class="panel-body">
			...
			<div class="col-md-6">
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title">
							<h4>APPEND THE CONTENT</h4>
							<div class="panel-action">
								<a href="javascript:;" data-toggle="reload" data-ajax-target="demo/ajax.html" data-ajax-selector="append"></a>
							</div><!--.panel-action-->
						</div><!--.panel-title-->
					</div><!--.panel-heading-->
					<div class="panel-body">
		...
		<div class="row">
			...
			<div class="col-md-6">
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title">
							<h4>TOASTR NOTIFICATON SUCCESS</h4>
							<div class="panel-action">
								<a href="javascript:;" data-toggle="reload" data-ajax-target="demo/ajax.html" data-ajax-selector="inside" data-ajax-notify="toastr"></a>
							</div><!--.panel-action-->
						</div><!--.panel-title-->
					</div><!--.panel-heading-->
					<div class="panel-body">
			...
			<div class="col-md-6">
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title">
							<h4>ION SOUNDS CALLBACK</h4>
							<div class="panel-action">
								<a href="javascript:;" data-toggle="reload" data-ajax-target="demo/ajax.html" data-ajax-selector="inside" data-ajax-notify-sound="water_droplet_3" class="panel-link"></a>
							</div><!--.panel-action-->
						</div><!--.panel-title-->
					</div><!--.panel-heading-->
					<div class="panel-body">
		...
		<div class="footer-links margin-top-40">
			<div class="row no-gutters">
				<div class="col-xs-6 bg-teal">
					<a href="panels-styling.html">
						<span class="state">Panels</span>
						<span>Styled Panels</span>
			...
			<ul>
				...
				<li>
					...
					<ul class="child-menu">
						...
						<li data-open-after="true"><a href="panels-ajax.html">Ajax Panels</a></li>
					</ul>
				</li>
				<li>
...
<!-- Mirrored from teamfox.co/themes/pleasure/app/admin1/panels-ajax.html by HTTrack Website Copier/3.x [XR&CO'2013], Thu, 25 Jun 2015 06:32:48 GMT -->
</html>