...
<!-- Mirrored from teamfox.co/themes/pleasure/app/admin1/panels-draggable.html by HTTrack Website Copier/3.x [XR&CO'2013], Thu, 25 Jun 2015 06:32:45 GMT -->
<head>
	<meta charset="utf-8">
	<meta http-equiv="X-UA-Compatible" content="IE=edge">

	<title>PLEASURE - Draggable Panels</title>
...
<body>
	...
	<div class="content">
		...
		<div class="page-header full-content bg-teal">
			<div class="row">
				<div class="col-sm-6">
					<h1>Draggable Panels <small>short description</small></h1>
				</div><!--.col-->
				<div class="col-sm-6">
					<ol class="breadcrumb">
						<li><a href="#"><i class="ion-home"></i></a></li>
						<li><a href="#">Panels</a></li>
						<li><a href="#" class="active">Draggable</a></li>
					</ol>
				</div><!--.col-->
			</div><!--.row-->
		</div><!--.page-header-->
		...
		<div class="row draggable-portlets">
			...
			<div class="col-md-6 portlets" id="portlet_1">
				<div class="panel">
					<div class="panel-heading portlet-handle">
						<div class="panel-title"><h4>BASIC DRAGGABLE PANEL</h4></div>
					</div><!--.panel-heading-->
			...
			<div class="col-md-6 portlets" id="portlet_2">
				<div class="panel">
					<div class="panel-heading portlet-handle">
						<div class="panel-title"><h4>BASIC DRAGGABLE PANEL</h4></div>
					</div><!--.panel-heading-->
			...
			<div class="col-md-6 portlets" id="portlet_3">
				<div class="panel">
					<div class="panel-heading portlet-handle">
						<div class="panel-title">
							<h4>HANDLE CANCEL</h4>
							<div class="panel-action portlet-handle-cancel">
								<a href="javascript:;" data-toggle="fake-reload" class="initially-hidden"></a>
			...
			<div class="col-md-6 portlets" id="portlet_4">
				<div class="panel">
					<div class="panel-heading portlet-handle">
						<div class="panel-title">
							<h4>HANDLE CANCEL</h4>
							<div class="panel-buttons">
								<div class="btn-group portlet-handle-cancel">
			...
			<div class="col-md-6 portlets" id="portlet_5">
				<div class="panel">
					<div class="panel-heading portlet-handle">
						<div class="panel-title">
							<h4>HANDLE CANCEL</h4>
							<div class="progress progress-striped active portlet-handle-cancel">
			...
			<div class="col-md-6 portlets" id="portlet_6">
				<div class="panel">
					<div class="panel-heading portlet-handle">
						<div class="panel-title">
							<h4>HANDLE CANCEL</h4>
							<div class="panel-inputs portlet-handle-cancel">
			...
			<ul>
				...
				<li>
					...
					<ul class="child-menu">
						...
						<li data-open-after="true"><a href="panels-draggable.html">Draggable Panels</a></li>
