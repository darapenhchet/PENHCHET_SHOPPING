...
<!-- Mirrored from teamfox.co/themes/pleasure/app/admin1/panels-styling.html by HTTrack Website Copier/3.x [XR&CO'2013], Thu, 25 Jun 2015 06:32:45 GMT -->
<head>
	<meta charset="utf-8">
	<meta http-equiv="X-UA-Compatible" content="IE=edge">

	<title>PLEASURE - Styled Panels</title>
...
<body>
	...
	<div class="content">
		...
		<div class="page-header full-content bg-teal">
			<div class="row">
				<div class="col-sm-6">
					<h1>Styled Panels <small>short description</small></h1>
				</div><!--.col-->
				<div class="col-sm-6">
					<ol class="breadcrumb">
						<li><a href="#"><i class="ion-home"></i></a></li>
						<li><a href="#">Panels</a></li>
						<li><a href="#" class="active">Styled Panels</a></li>
					</ol>
				</div><!--.col-->
			</div><!--.row-->
		</div><!--.page-header-->
		...
		<div class="row">
			...
			<div class="col-md-3">
				<div class="panel indigo">
					<div class="panel-heading">
						<div class="panel-title"><h4>INDIGO</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">
						<p>Collaboratively administrate empowered markets via plug-and-play networks.</p>
					</div><!--.panel-body-->
			...
			<div class="col-md-3">
				<div class="panel blue">
					<div class="panel-heading">
						<div class="panel-title"><h4>BLUE</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">
						<p>Collaboratively administrate empowered markets via plug-and-play networks.</p>
					</div><!--.panel-body-->
			...
			<div class="col-md-3">
				<div class="panel light-blue">
					<div class="panel-heading">
						<div class="panel-title"><h4>LIGHT BLUE</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">
						<p>Collaboratively administrate empowered markets via plug-and-play networks.</p>
					</div><!--.panel-body-->
			...
			<div class="col-md-3">
				<div class="panel cyan">
					<div class="panel-heading">
						<div class="panel-title"><h4>CYAN</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">
						<p>Collaboratively administrate empowered markets via plug-and-play networks.</p>
					</div><!--.panel-body-->
		...
		<div class="row">
			...
			<div class="col-md-3">
				<div class="panel teal">
					<div class="panel-heading">
						<div class="panel-title"><h4>TEAL</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">
						<p>Collaboratively administrate empowered markets via plug-and-play networks.</p>
					</div><!--.panel-body-->
			...
			<div class="col-md-3">
				<div class="panel green">
					<div class="panel-heading">
						<div class="panel-title"><h4>GREEN</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">
						<p>Collaboratively administrate empowered markets via plug-and-play networks.</p>
					</div><!--.panel-body-->
			...
			<div class="col-md-3">
				<div class="panel light-green">
					<div class="panel-heading">
						<div class="panel-title"><h4>LIGHT GREEN</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">
						<p>Collaboratively administrate empowered markets via plug-and-play networks.</p>
					</div><!--.panel-body-->
			...
			<div class="col-md-3">
				<div class="panel lime">
					<div class="panel-heading">
						<div class="panel-title"><h4>LIME</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">
						<p>Collaboratively administrate empowered markets via plug-and-play networks.</p>
					</div><!--.panel-body-->
		...
		<div class="row">
			...
			<div class="col-md-3">
				<div class="panel yellow">
					<div class="panel-heading">
						<div class="panel-title"><h4>YELLOW</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">
						<p>Collaboratively administrate empowered markets via plug-and-play networks.</p>
					</div><!--.panel-body-->
			...
			<div class="col-md-3">
				<div class="panel amber">
					<div class="panel-heading">
						<div class="panel-title"><h4>AMBER</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">
						<p>Collaboratively administrate empowered markets via plug-and-play networks.</p>
					</div><!--.panel-body-->
			...
			<div class="col-md-3">
				<div class="panel orange">
					<div class="panel-heading">
						<div class="panel-title"><h4>ORANGE</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">
						<p>Collaboratively administrate empowered markets via plug-and-play networks.</p>
					</div><!--.panel-body-->
			...
			<div class="col-md-3">
				<div class="panel deep-orange">
					<div class="panel-heading">
						<div class="panel-title"><h4>DEEP ORANGE</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">
						<p>Collaboratively administrate empowered markets via plug-and-play networks.</p>
					</div><!--.panel-body-->
		...
		<div class="row">
			...
			<div class="col-md-4">
				<div class="panel brown">
					<div class="panel-heading">
						<div class="panel-title"><h4>BROWN</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">
						<p>Collaboratively administrate empowered markets via plug-and-play networks.</p>
					</div><!--.panel-body-->
			...
			<div class="col-md-4">
				<div class="panel grey">
					<div class="panel-heading">
						<div class="panel-title"><h4>GREY</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">
						<p>Collaboratively administrate empowered markets via plug-and-play networks.</p>
					</div><!--.panel-body-->
			...
			<div class="col-md-4">
				<div class="panel blue-grey">
					<div class="panel-heading">
						<div class="panel-title"><h4>BLUE GREY</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">
						<p>Collaboratively administrate empowered markets via plug-and-play networks.</p>
					</div><!--.panel-body-->
			...
			<ul>
				...
				<li>
					...
					<ul class="child-menu">
						...
						<li data-open-after="true"><a href="panels-styling.html">Styled Panels</a></li>
