...
<!-- Mirrored from teamfox.co/themes/pleasure/app/admin1/panels.html by HTTrack Website Copier/3.x [XR&CO'2013], Thu, 25 Jun 2015 06:32:44 GMT -->
<head>
	<meta charset="utf-8">
	<meta http-equiv="X-UA-Compatible" content="IE=edge">

	<title>PLEASURE - Panel Types</title>
...
<body>
	...
	<div class="content">
		...
		<div class="page-header full-content bg-teal">
			<div class="row">
				<div class="col-sm-6">
					<h1>Panel Types <small>short description</small></h1>
				</div><!--.col-->
				<div class="col-sm-6">
					<ol class="breadcrumb">
						<li><a href="#"><i class="ion-home"></i></a></li>
						<li><a href="#">Panels</a></li>
						<li><a href="#" class="active">Panel Types</a></li>
					</ol>
				</div><!--.col-->
			</div><!--.row-->
		</div><!--.page-header-->
		...
		<div class="row">
			<div class="col-md-4">
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>LIGHT FOOTER</h4></div>
					</div><!--.panel-heading-->
			...
			<div class="col-md-4">
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>DARK FOOTER</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">
						<p>Collaboratively administrate empowered markets via plug-and-play networks. Dynamically procrastinate B2C users after installed base benefits.</p>
					</div><!--.panel-body-->
			...
			<div class="col-md-4">
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>TRANSPARENT FOOTER</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">
						<p>Collaboratively administrate empowered markets via plug-and-play networks. Dynamically procrastinate B2C users after installed base benefits.</p>
					</div><!--.panel-body-->
					<div class="panel-footer footer-transparent text-dark">
						<ul class="justified-list">
							<li><i class="ion-android-favorite-outline"></i></li>
							<li><i class="ion-android-radio-button-off"></i></li>
							<li><i class="ion-android-checkbox-outline-blank"></i></li>
		...
		<div class="row">
			<div class="col-md-4">
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>LIGHT TRANSLUCENT FOOTER</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body without-padding">
						<div class="list-gallery">
							<div class="card tile card-black card-image bg-image sample-bg-image9 margin-0">
							</div><!--.card-->
						</div><!--.row-->
					</div><!--.panel-body-->
					<div class="panel-footer footer-light footer-translucent">
						<ul class="justified-list">
							<li><i class="ion-android-favorite-outline"></i></li>
							<li><i class="ion-android-radio-button-off"></i></li>
							<li><i class="ion-android-checkbox-outline-blank"></i></li>
			...
			<div class="col-md-4">
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>DARK TRANSLUCENT FOOTER</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body without-padding">
						<div class="list-gallery">
			...
			<div class="col-md-4">
				<div class="panel">
					...
					<div class="panel-body without-padding">
						<div class="list-gallery">
							<div class="card tile card-black card-image bg-image sample-bg-image10 margin-0">
							</div><!--.card-->
						</div><!--.row-->
					</div><!--.panel-body-->
					<div class="panel-footer footer-translucent footer-transparent">
						<ul class="justified-list">
							<li><i class="ion-android-favorite-outline"></i></li>
							<li><i class="ion-android-radio-button-off"></i></li>
							<li><i class="ion-android-checkbox-outline-blank"></i></li>
		...
		<div class="row">
			<div class="col-md-4">
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>MATERIAL COLOR FOOTER</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">
						<p>Collaboratively administrate empowered markets via plug-and-play networks. Dynamically procrastinate B2C users after installed base benefits.</p>
					</div><!--.panel-body-->
			...
			<div class="col-md-4">
				<div class="panel">
					...
					<div class="panel-footer footer-pink">
						<ul class="justified-list">
							<li><i class="ion-android-favorite-outline"></i></li>
							<li><i class="ion-android-radio-button-off"></i></li>
							<li><i class="ion-android-checkbox-outline-blank"></i></li>
			...
			<div class="col-md-4">
				<div class="panel">
					...
					<div class="panel-footer footer-purple">
						<ul class="justified-list">
							<li><i class="ion-android-favorite-outline"></i></li>
							<li><i class="ion-android-radio-button-off"></i></li>
							<li><i class="ion-android-checkbox-outline-blank"></i></li>
		...
		<div class="row">
			...
			<div class="col-md-4">
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>BASIC PANEL <small>more description</small></h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">
			...
			<div class="col-md-4">
				<div class="panel panel-with-border">
					<div class="panel-heading">
						<div class="panel-title"><h4>WITH BORDER</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">
						<p>Collaboratively administrate empowered markets via plug-and-play networks. Dynamically procrastinate B2C users after installed base benefits. Dramatically visualize customer directed convergence without revolutionary ROI.</p>
					</div><!--.panel-body-->
			...
			<div class="col-md-4">
				<div class="panel panel-with-shadow">
					<div class="panel-heading">
						<div class="panel-title"><h4>WITH SHADOW</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">
						<p>Collaboratively administrate empowered markets via plug-and-play networks. Dynamically procrastinate B2C users after installed base benefits. Dramatically visualize customer directed convergence without revolutionary ROI.</p>
					</div><!--.panel-body-->
		...
		<div class="row">
			...
			<div class="col-md-4">
				<div class="panel panel-transparent">
					<div class="panel-heading">
						<div class="panel-title"><h4>TRANSPARENT PANEL</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">
						<p>Collaboratively administrate empowered markets via plug-and-play networks. Dynamically procrastinate B2C users after installed base benefits. Dramatically visualize customer directed convergence without revolutionary ROI.</p>
					</div><!--.panel-body-->
			...
			<div class="col-md-8">
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>ACTION BUTTONS</h4>
						<div class="panel-action">
							<a href="javascript:;" data-toggle="dropdown" id="panelDropdown" class="initially-hidden"></a>
							<ul class="dropdown-menu pull-right" role="menu" aria-labelledby="panelDropdown">
		...
		<div class="row">
						...
						<div class="panel-title">
							...
							<div class="steps-pull-right">
								<ul class="wizard-steps">
									<li class="step"><a href="#" class="btn btn-primary">1</a></li>
									<li class="step"><a href="#" class="btn btn-white">2</a></li>
									<li class="step"><a href="#" class="btn btn-white">3</a></li>
								</ul>
			...
			<div class="col-md-6">
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>BUTTON GROUP</h4>
						<div class="panel-buttons">
							<div class="btn-group btn-merged">
								<button type="button" class="btn btn-flat btn-default">Cancel</button>
								<button type="button" class="btn btn-flat btn-primary">Confirm</button>
							</div>
						</div><!--.panel-buttons-->
						</div><!--.panel-title-->
					</div><!--.panel-heading-->
		...
		<div class="row">
			...
			<div class="col-md-4">
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>PROGRESS BAR</h4>
			...
			<div class="col-md-4">
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>TABS</h4></div><!--.panel-title-->
						<ul class="nav nav-tabs with-panel">
							<li class="active"><a href="#panel-tab1" data-toggle="tab" class="btn-ripple">Tab 1</a></li>
							<li><a href="#panel-tab2" data-toggle="tab" class="btn-ripple">Tab 2</a></li>
							<li><a href="#panel-tab3" data-toggle="tab" class="btn-ripple">Tab 3</a></li>
						</ul>
					</div><!--.panel-heading-->
					<div class="panel-body">
						<div class="tab-content with-panel">
							<div id="panel-tab1" class="tab-pane active">
								<p>Tab 1 Collaboratively administrate empowered markets via plug-and-play networks. Dynamically procrastinate B2C users after installed base benefits. Dramatically visualize customer directed convergence without revolutionary ROI.</p>
							</div><!--.tab-pane-->
							<div id="panel-tab2" class="tab-pane">
								<p>Tab 2 Collaboratively administrate empowered markets via plug-and-play networks. Dynamically procrastinate B2C users after installed base benefits. Dramatically visualize customer directed convergence without revolutionary ROI.</p>
							</div><!--.tab-pane-->
							<div id="panel-tab3" class="tab-pane">
								<p>Tab 3 Collaboratively administrate empowered markets via plug-and-play networks. Dynamically procrastinate B2C users after installed base benefits. Dramatically visualize customer directed convergence without revolutionary ROI.</p>
							</div><!--.tab-pane-->
						</div><!--.tab-content-->
					</div><!--.panel-body-->
				</div><!--.panel-->
			...
			<div class="col-md-4">
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>INPUT BAR</h4>
						<div class="panel-inputs">
							<div class="input-group">
								<input type="text" class="form-control input-circle-left" placeholder="search...">
								<span class="input-group-btn">
									<button class="btn btn-circle-right btn-default" type="submit">Find</button>
								</span>
							</div>
						</div>
						</div><!--.panel-title-->
		...
		<div class="footer-links margin-top-40">
			<div class="row no-gutters">
				...
				<div class="col-xs-6 bg-teal">
					<a href="panels-draggable.html">
						<span class="state">Panels</span>
						<span>Draggable Panels</span>
		...
		<div class="menu-layer">
			<ul>
				...
				<li>
					...
					<ul class="child-menu">
						<li data-open-after="true"><a href="panels.html">Panel Types</a></li>
