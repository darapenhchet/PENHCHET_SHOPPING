...
<!-- Mirrored from teamfox.co/themes/pleasure/app/admin1/table-bootstrap-table.html by HTTrack Website Copier/3.x [XR&CO'2013], Thu, 25 Jun 2015 06:36:05 GMT -->
<head>
	<meta charset="utf-8">
	<meta http-equiv="X-UA-Compatible" content="IE=edge">

	<title>PLEASURE - Bootstrap Tables</title>
...
<body>
	...
	<div class="content">
		...
		<div class="page-header full-content bg-blue-grey">
			<div class="row">
				<div class="col-sm-6">
					<h1>Bootstrap Table <small>short description</small></h1>
				</div><!--.col-->
				<div class="col-sm-6">
					<ol class="breadcrumb">
						<li><a href="#"><i class="ion-home"></i></a></li>
						<li><a href="#">Tables</a></li>
						<li><a href="#" class="active">Bootstrap Table</a></li>
					</ol>
				</div><!--.col-->
			</div><!--.row-->
		</div><!--.page-header-->
			...
			<div class="col-md-12">
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>BASIC TABLE</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">

						<table data-toggle="table" data-url="demo/bootstrap-table/data1.json" data-cache="false" data-height="300">
							<thead>
								<tr>
		...
		<div class="row">
			<div class="col-md-6">
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>ALIGNING COLUMNS</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">

						<table data-toggle="table" data-url="demo/bootstrap-table/data1.json" data-height="300">
							<thead>
								<tr>
			...
			<div class="col-md-6">
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>SORTING</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">

						<table data-toggle="table" data-url="demo/bootstrap-table/data1.json" data-height="300" data-sort-name="name" data-sort-order="desc">
							<thead>
								<tr>
		...
		<div class="row">
			<div class="col-md-12">
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>SHOW HIDE COLUMNS</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">

						<table data-toggle="table" data-url="demo/bootstrap-table/data3.json" data-height="300" data-show-columns="true" data-id-field="id">
							<thead>
								<tr>
		...
		<div class="row">
			<div class="col-md-12">
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>SEARCH BAR AND PAGINATION</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">

						<table data-toggle="table" data-url="demo/bootstrap-table/data2.json" data-height="400" data-pagination="true" data-search="true">
							<thead>
								<tr>
		...
		<div class="row">
			<div class="col-md-12">
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>TABLE EVENTS</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">

						<div class="well well-sm margin-bottom-10" id="events-result">
							Here is the result of event.
						</div>

						<table class="bs-table-events" data-url="demo/bootstrap-table/data1.json" data-height="300" data-search="true">
							<thead>
								<tr>
									<th data-field="state" data-checkbox="true"></th>
		...
		<div class="row">
			<div class="col-md-12">
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>VIA JAVASCRIPT</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">

						<table class="bs-table-viajs"></table>
			...
			<ul>
				...
				<li>
					...
					<ul class="child-menu">
						...
						<li data-open-after="true"><a href="table-bootstrap-table.html">BS Table</a></li>
...
<!-- Mirrored from teamfox.co/themes/pleasure/app/admin1/table-bootstrap-table.html by HTTrack Website Copier/3.x [XR&CO'2013], Thu, 25 Jun 2015 06:36:07 GMT -->
</html>