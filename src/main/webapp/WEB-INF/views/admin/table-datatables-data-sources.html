...
<!-- Mirrored from teamfox.co/themes/pleasure/app/admin1/table-datatables-data-sources.html by HTTrack Website Copier/3.x [XR&CO'2013], Thu, 25 Jun 2015 06:36:14 GMT -->
<head>
	<meta charset="utf-8">
	<meta http-equiv="X-UA-Compatible" content="IE=edge">

	<title>PLEASURE - Datatable Data Sources</title>
...
<body>
	...
	<div class="content">
		...
		<div class="page-header full-content bg-blue-grey">
			<div class="row">
				<div class="col-sm-6">
					<h1>Datatable <small>Data Sources</small></h1>
				</div><!--.col-->
				<div class="col-sm-6">
					<ol class="breadcrumb">
						<li><a href="#"><i class="ion-home"></i></a></li>
						<li><a href="#">Tables</a></li>
						<li><a href="#" class="active">Datatable Data Sources</a></li>
					</ol>
				</div><!--.col-->
			</div><!--.row-->
		</div><!--.page-header-->
			...
			<div class="col-md-12">
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>JAVASCRIPT SOURCED DATA</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">

						<div class="overflow-table">
						<table class="display datatables-js-sourced">
							<thead>
								<tr>
									<th>Engine</th>
									<th>Browser</th>
		...
		<div class="row">
			<div class="col-md-12">
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>SERVER-SIDE PROCESSING</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">

						<div class="overflow-table">
						<table class="display datatables-serverside">
							<thead>
								<tr>
									<th>Name</th>
									<th>Position</th>
		...
		<div class="row">
			<div class="col-md-12">
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>SERVER-SIDE ROW DETAILS</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">

						<div class="overflow-table">
						<table class="display datatables-serverside-row-details">
							<thead>
								<tr>
									<th></th>
									<th>First name</th>
			...
			<ul>
				...
				<li>
					...
					<ul class="child-menu">
						...
						<li data-open-after="true"><a href="table-datatables-data-sources.html">DataTable Data Sources</a></li>
...
<!-- Mirrored from teamfox.co/themes/pleasure/app/admin1/table-datatables-data-sources.html by HTTrack Website Copier/3.x [XR&CO'2013], Thu, 25 Jun 2015 06:36:15 GMT -->
</html>