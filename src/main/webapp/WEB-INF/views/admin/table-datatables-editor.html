...
<!-- Mirrored from teamfox.co/themes/pleasure/app/admin1/table-datatables-editor.html by HTTrack Website Copier/3.x [XR&CO'2013], Thu, 25 Jun 2015 06:36:15 GMT -->
<head>
	<meta charset="utf-8">
	<meta http-equiv="X-UA-Compatible" content="IE=edge">

	<title>PLEASURE - Datatables Editor</title>
			...
			<div class="col-md-12">
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>CRUD OPERATIONS</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">

						<div class="overflow-table">
						<table class="display datatables-crud">
							<thead>
								<tr>
							...
							<tbody>
								<tr>
									...
									<td><button class="btn btn-danger btn-xs dt-delete"><span class="glyphicon glyphicon-trash"></span></button></td>
								</tr>
								<tr>
									<td><input type="checkbox" class="checkboxes" value="1"></td>
		...
		<div class="footer-links margin-top-40">
			<div class="row no-gutters">
				<div class="col-xs-6 bg-blue-grey">
					<a href="table-datatables-data-sources.html">
						<span class="state">Tables</span>
						<span>Datatables Data Sources</span>
				...
				<div class="col-xs-6 bg-blue-grey">
					<a href="table-datatables-extensions.html">
						<span class="state">Tables</span>
						<span>Datatables Extensions</span>
			...
			<ul>
				...
				<li>
					...
					<ul class="child-menu">
						...
						<li data-open-after="true"><a href="table-datatables-editor.html">DataTable Editor</a></li>
...
<!-- Mirrored from teamfox.co/themes/pleasure/app/admin1/table-datatables-editor.html by HTTrack Website Copier/3.x [XR&CO'2013], Thu, 25 Jun 2015 06:36:17 GMT -->
</html>