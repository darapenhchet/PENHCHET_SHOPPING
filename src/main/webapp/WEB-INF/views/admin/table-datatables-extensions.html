...
<!-- Mirrored from teamfox.co/themes/pleasure/app/admin1/table-datatables-extensions.html by HTTrack Website Copier/3.x [XR&CO'2013], Thu, 25 Jun 2015 06:36:17 GMT -->
<head>
	<meta charset="utf-8">
	<meta http-equiv="X-UA-Compatible" content="IE=edge">

	<title>PLEASURE - Datatable Extensions</title>
...
<body>
	...
	<div class="content">
		...
		<div class="page-header full-content bg-blue-grey">
			<div class="row">
				<div class="col-sm-6">
					<h1>Datatable Extensions</h1>
				</div><!--.col-->
				<div class="col-sm-6">
					<ol class="breadcrumb">
						<li><a href="#"><i class="ion-home"></i></a></li>
						<li><a href="#">Tables</a></li>
						<li><a href="#" class="active">Datatable Extension</a></li>
					</ol>
				</div><!--.col-->
			</div><!--.row-->
		</div><!--.page-header-->
			...
			<div class="col-md-12">
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>EXPORT BUTTONS</h4></div>
					</div><!--.panel-heading-->
		...
		<div class="row">
			<div class="col-md-12">
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>SCROLLER</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">

						<div class="overflow-table">
						<table class="display datatables-scroller-basic">
							<thead>
								<tr>
									<th>Name</th>
									<th>Position</th>
		...
		<div class="row">
			<div class="col-md-12">
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>RESPONSIVE COLUMN CONTROLLED CHILD ROWS</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">

						<div class="overflow-table">
						<table class="display nowrap datatables-responsive-column">
							<thead>
								<tr>
									<th></th>
									<th>Name</th>
			...
			<div class="col-md-12">
				<div class="panel">
					...
					<div class="panel-body">
						...
						<div class="colvis-button-container"></div>
						<div class="overflow-table">
						<table class="display datatables-colvis-basic">
							<thead>
								<tr>
									<th>Name</th>
									<th>Position</th>
		...
		<div class="row">
			<div class="col-md-12">
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>COLUMN RE-ORDER</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">

						<div class="overflow-table">
						<table class="display datatables-colreorder">
							<thead>
								<tr>
									<th>Name</th>
									<th>Position</th>
		...
		<div class="footer-links margin-top-40">
			<div class="row no-gutters">
				<div class="col-xs-6 bg-blue-grey">
					<a href="table-datatables-editor.html">
						<span class="state">Tables</span>
						<span>Datatables Editors</span>
			...
			<ul>
				...
				<li>
					...
					<ul class="child-menu">
						...
						<li data-open-after="true"><a href="table-datatables-extensions.html">DataTable Extensions</a></li>
					</ul>
				</li>
				<li>
	...
	$(document).ready(function () {
		Pleasure.init();
		Layout.init();
		TablesDataTablesExtensions.init();
	});
	</script>
	<!-- END INITIALIZATION-->
...
<!-- Mirrored from teamfox.co/themes/pleasure/app/admin1/table-datatables-extensions.html by HTTrack Website Copier/3.x [XR&CO'2013], Thu, 25 Jun 2015 06:36:26 GMT -->
</html>