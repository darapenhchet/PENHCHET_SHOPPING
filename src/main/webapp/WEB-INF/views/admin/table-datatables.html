...
<!-- Mirrored from teamfox.co/themes/pleasure/app/admin1/table-datatables.html by HTTrack Website Copier/3.x [XR&CO'2013], Thu, 25 Jun 2015 06:36:08 GMT -->
<head>
	<meta charset="utf-8">
	<meta http-equiv="X-UA-Compatible" content="IE=edge">

	<title>PLEASURE - Datatables</title>
...
<body>
	...
	<div class="content">
		...
		<div class="page-header full-content bg-blue-grey">
			<div class="row">
				<div class="col-sm-6">
					<h1>Datatables <small>short description</small></h1>
				</div><!--.col-->
				<div class="col-sm-6">
					<ol class="breadcrumb">
			...
			<div class="row no-gutters">
				...
				<div class="col-xs-6 bg-blue-grey">
					<a href="table-datatables-data-sources.html">
						<span class="state">Tables</span>
						<span>Datatable Data Sources</span>
			...
			<ul>
				...
				<li>
					...
					<ul class="child-menu">
						...
						<li data-open-after="true"><a href="table-datatables.html">DataTables</a></li>
...
<!-- Mirrored from teamfox.co/themes/pleasure/app/admin1/table-datatables.html by HTTrack Website Copier/3.x [XR&CO'2013], Thu, 25 Jun 2015 06:36:14 GMT -->
</html>