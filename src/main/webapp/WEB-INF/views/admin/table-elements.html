...
<!-- Mirrored from teamfox.co/themes/pleasure/app/admin1/table-elements.html by HTTrack Website Copier/3.x [XR&CO'2013], Thu, 25 Jun 2015 06:36:05 GMT -->
<head>
	<meta charset="utf-8">
	<meta http-equiv="X-UA-Compatible" content="IE=edge">

	<title>PLEASURE - Table Elements</title>
...
<body>
	...
	<div class="content">
		...
		<div class="page-header full-content bg-blue-grey">
			<div class="row">
				<div class="col-sm-6">
					<h1>Table Elements <small>short description</small></h1>
				</div><!--.col-->
				<div class="col-sm-6">
					<ol class="breadcrumb">
			...
			<div class="col-md-12">
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>TABLE ELEMENTS</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">
						...
						<div class="row example-row">
							<div class="col-md-3">Striped Table</div><!--.col-md-3-->
							<div class="col-md-9">
						...
						<div class="row example-row">
							<div class="col-md-3">Bordered Table</div><!--.col-md-3-->
							<div class="col-md-9">
						...
						<div class="row example-row">
							<div class="col-md-3">Hoverable Rows</div><!--.col-md-3-->
							<div class="col-md-9">
						...
						<div class="row example-row">
							<div class="col-md-3">Condensed Table</div><!--.col-md-3-->
							<div class="col-md-9">
						...
						<div class="row example-row">
							<div class="col-md-3">Contextual Rows</div><!--.col-md-3-->
							<div class="col-md-9">
								<table class="table">
									<thead>
										<tr>
		...
		<div class="menu-layer">
			<ul>
				...
				<li>
					...
					<ul class="child-menu">
						<li data-open-after="true"><a href="table-elements.html">Elements</a></li>
