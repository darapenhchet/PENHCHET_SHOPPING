...
<!-- Mirrored from teamfox.co/themes/pleasure/app/admin1/table-responsive.html by HTTrack Website Copier/3.x [XR&CO'2013], Thu, 25 Jun 2015 06:36:05 GMT -->
<head>
	<meta charset="utf-8">
	<meta http-equiv="X-UA-Compatible" content="IE=edge">

	<title>PLEASURE - Responsive Table</title>
...
<body>
	...
	<div class="content">
		...
		<div class="page-header full-content bg-blue-grey">
			<div class="row">
				<div class="col-sm-6">
					<h1>Responsive Table <small>short description</small></h1>
				</div><!--.col-->
				<div class="col-sm-6">
					<ol class="breadcrumb">
						<li><a href="#"><i class="ion-home"></i></a></li>
						<li><a href="#">Table</a></li>
						<li><a href="#" class="active">Responsive Table</a></li>
					</ol>
				</div><!--.col-->
			</div><!--.row-->
		</div><!--.page-header-->
			...
			<div class="col-md-12">
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>BOOTSTRAP RESPONSIVE TABLE</h4></div>
					</div><!--.panel-heading-->
		...
		<div class="row">
			<div class="col-md-12">
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>THE UNSEEN COLUMN</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">
		...
		<div class="row">
			<div class="col-md-12">
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>FLIP SCROLL</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">
		...
		<div class="row">
			<div class="col-md-12">
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>NO MORE TABLE</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">
		...
		<div class="footer-links margin-top-40">
			<div class="row no-gutters">
				...
				<div class="col-xs-6 bg-blue-grey">
					<a href="table-bootstrap-table.html">
						<span class="state">Tables</span>
			...
			<ul>
				...
				<li>
					...
					<ul class="child-menu">
						...
						<li data-open-after="true"><a href="table-responsive.html">Responsive Tables</a></li>
