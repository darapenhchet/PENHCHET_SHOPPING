...
<!-- Mirrored from teamfox.co/themes/pleasure/app/admin1/ui-elements-dialogs.html by HTTrack Website Copier/3.x [XR&CO'2013], Thu, 25 Jun 2015 06:32:43 GMT -->
<head>
	<meta charset="utf-8">
	<meta http-equiv="X-UA-Compatible" content="IE=edge">

	<title>PLEASURE - UI Elements Dialogs</title>
...
<body>
	...
	<div class="content">
		...
		<div class="page-header full-content bg-red">
			<div class="row">
				<div class="col-sm-6">
					<h1>Dialogs <small>small description</small></h1>
				</div><!--.col-->
				<div class="col-sm-6">
					<ol class="breadcrumb">
			...
			<div class="col-md-12">
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>MODAL DIALOGS</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">

						<div class="row example-row">
							<div class="col-md-3">Default Modal</div><!--.col-md-3-->
							<div class="col-md-9">
						...
						<div class="row example-row">
							<div class="col-md-3">Large Modal</div><!--.col-md-3-->
							<div class="col-md-9">
								<button class="btn btn-default" data-toggle="modal" data-target="#largeModal">Launch Large Modal</button>
							</div><!--.col-md-9-->
						</div><!--.row-->

						<div class="row example-row">
							<div class="col-md-3">Small Modal</div><!--.col-md-3-->
							<div class="col-md-9">
								<button class="btn btn-default" data-toggle="modal" data-target="#smallModal">Launch Small Modal</button>
							</div><!--.col-md-9-->
						</div><!--.row-->

						<div class="row example-row">
							<div class="col-md-3">From Right Modal</div><!--.col-md-3-->
							<div class="col-md-9">
								<button class="btn btn-pink" data-toggle="modal" data-target="#panel-modal2">Launch From Right Modal</button>
							</div><!--.col-md-9-->
						</div><!--.row-->

						<div class="row example-row">
							<div class="col-md-3">From Right Left Modal</div><!--.col-md-3-->
							<div class="col-md-9">
								<button class="btn btn-pink" data-toggle="modal" data-target="#panel-modal3">Launch From Left Modal</button>
							</div><!--.col-md-9-->
						</div><!--.row-->

						<div class="row example-row">
							<div class="col-md-3">Full Height Modal</div><!--.col-md-3-->
							<div class="col-md-9">
								<button class="btn btn-indigo" data-toggle="modal" data-target="#panel-modal4">Launch Full Height Modal</button>
							</div><!--.col-md-9-->
						</div><!--.row-->
		...
		<div class="modal scale fade" id="largeModal" tabindex="-1" role="dialog" aria-hidden="true">
			<div class="modal-dialog modal-lg">
				<div class="modal-content">
					...
					<div class="modal-body">It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that.
					</div>
				</div><!--.modal-content-->
			</div><!--.modal-dialog-->
		</div><!--.modal-->
		...
		<div class="modal fade full-height from-left" id="panel-modal3" tabindex="-1" role="dialog" aria-hidden="true">
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						<h4 class="modal-title">Panel Modal</h4>
			...
			<ul>
				...
				<li>
					...
					<ul class="child-menu">
						...
						<li data-open-after="true"><a href="ui-elements-dialogs.html">Dialogs</a></li>
