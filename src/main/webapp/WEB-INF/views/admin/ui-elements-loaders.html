...
<!-- Mirrored from teamfox.co/themes/pleasure/app/admin1/ui-elements-loaders.html by HTTrack Website Copier/3.x [XR&CO'2013], Thu, 25 Jun 2015 06:32:44 GMT -->
<head>
	<meta charset="utf-8">
	<meta http-equiv="X-UA-Compatible" content="IE=edge">

	<title>PLEASURE - Loaders</title>
...
<body>
	...
	<div class="content">
		...
		<div class="page-header full-content">
			<div class="row">
				<div class="col-sm-6">
					<h1>Loaders <small>small description</small></h1>
				</div><!--.col-->
				<div class="col-sm-6">
					<ol class="breadcrumb">
						<li><a href="#"><i class="ion-home"></i></a></li>
						<li><a href="#">UI Elements</a></li>
						<li><a href="#" class="active">Loaders</a></li>
					</ol>
				</div><!--.col-->
			</div><!--.row-->
		</div><!--.page-header-->
			...
			<div class="col-md-8 col-centered">
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>LOADERS</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">

						<div class="row example-row">
							<div class="col-md-3">Indeterminate</div><!--.col-->
							<div class="col-md-9">
						...
						<div class="row example-row">
							<div class="col-md-3">Determinate</div><!--.col-->
							<div class="col-md-9">
								<div class="loading-bar determinate margin-top-10"></div>
							</div><!--.col-->
						</div><!--.row-->

						<div class="row example-row">
							<div class="col-md-3">Determinate Center</div><!--.col-->
							<div class="col-md-9">
								<div class="loading-bar determinate-center margin-top-10"></div>
							</div><!--.col-->
						</div><!--.row-->
		...
		<div class="row row-centered">
			<div class="col-md-8 col-centered">
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>COLOR OPTIONS</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">

						<div class="row example-row">
							<div class="col-md-3">Material Colors</div><!--.col-->
							<div class="col-md-9">
								<div class="loading-bar loading-red determinate margin-top-10 margin-bottom-20"></div>
								<div class="loading-bar loading-pink determinate margin-bottom-20"></div>
								<div class="loading-bar loading-purple determinate margin-bottom-40"></div>

								<div class="loading-bar loading-indigo determinate margin-bottom-20"></div>
								<div class="loading-bar loading-blue determinate margin-bottom-20"></div>
								<div class="loading-bar loading-light-blue determinate margin-bottom-20"></div>
								<div class="loading-bar loading-cyan determinate margin-bottom-40"></div>

								<div class="loading-bar loading-teal determinate margin-bottom-20"></div>
								<div class="loading-bar loading-green determinate margin-bottom-20"></div>
								<div class="loading-bar loading-light-green determinate margin-bottom-40"></div>

								<div class="loading-bar loading-lime determinate margin-bottom-20"></div>
								<div class="loading-bar loading-yellow determinate margin-bottom-20"></div>
								<div class="loading-bar loading-amber determinate margin-bottom-40"></div>

								<div class="loading-bar loading-orange determinate margin-bottom-20"></div>
								<div class="loading-bar loading-deep-orange determinate margin-bottom-40"></div>

								<div class="loading-bar loading-brown determinate margin-bottom-20"></div>
								<div class="loading-bar loading-grey determinate margin-bottom-20"></div>
								<div class="loading-bar loading-blue-grey determinate margin-bottom-20"></div>
			...
			<ul>
				...
				<li>
					...
					<ul class="child-menu">
						...
						<li data-open-after="true"><a href="ui-elements-loaders.html">Loaders</a></li>
					</ul>
				</li>
				<li>
