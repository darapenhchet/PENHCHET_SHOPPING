...
<!-- Mirrored from teamfox.co/themes/pleasure/app/admin1/ui-elements-notifications.html by HTTrack Website Copier/3.x [XR&CO'2013], Thu, 25 Jun 2015 06:32:43 GMT -->
<head>
	<meta charset="utf-8">
	<meta http-equiv="X-UA-Compatible" content="IE=edge">

	<title>PLEASURE - Notifications</title>
...
<body>
	...
	<div class="content">
		...
		<div class="page-header full-content bg-red">
			<div class="row">
				<div class="col-sm-6">
					<h1>Notifications <small>small description</small></h1>
				</div><!--.col-->
				<div class="col-sm-6">
					<ol class="breadcrumb">
			...
			<div class="col-md-12">
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>TOASTR NOTIFICATIONS</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">
						...
						<table class="table table-hover table-striped">
							<tbody>
								<tr class="active">
									<td>Basic</td>
									<td><button class="btn btn-default toastr-notify">Basic</button></td>
								</tr>

								<tr>
									<td>Types</td>
									<td>
										<button class="btn btn-success toastr-notify" data-toastr-type="success">Success</button>
										<button class="btn btn-warning toastr-notify" data-toastr-type="warning">Warning</button>
										<button class="btn btn-danger toastr-notify" data-toastr-type="error">Error</button>
									</td>
								</tr>
								...
								<tr>
									<td>Title &amp; Content</td>
									<td>
										<button class="btn btn-default toastr-notify" data-toastr-title="Custom Title" data-toastr-notification="Custom notification content via data attr">Custom Title</button>
									</td>
								</tr>

								<tr>
									<td>Without close button</td>
									<td>
										<button class="btn btn-indigo toastr-notify" data-toastr-close-button="false">Launch</button>
									</td>
								</tr>

								<tr>
									<td>Sticky notifications</td>
									<td>
										<button class="btn btn-cyan toastr-notify" data-toastr-sticky="true">Launch</button>
									</td>
								</tr>

								<tr>
									<td>Notification positions</td>
									<td>
										<button class="btn btn-default toastr-notify" data-toastr-close-others="true" data-toastr-position="toast-top-right">Top Right</button>
										<button class="btn btn-default toastr-notify" data-toastr-close-others="true" data-toastr-position="toast-bottom-right">Bottom Right</button>
										<button class="btn btn-default toastr-notify" data-toastr-close-others="true" data-toastr-position="toast-bottom-left">Bottom Left</button>
										<button class="btn btn-default toastr-notify" data-toastr-close-others="true" data-toastr-position="toast-top-left">Top Left</button>
								...
								<tr>
									<td>Full width</td>
									<td>
										<button class="btn btn-default toastr-notify" data-toastr-close-others="true" data-toastr-position="toast-top-full-width">Top Full Width</button>
			...
			<ul>
				...
				<li>
					...
					<ul class="child-menu">
						...
						<li data-open-after="true"><a href="ui-elements-notifications.html">Notifications</a></li>
