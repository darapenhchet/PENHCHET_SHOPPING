...
<!-- Mirrored from teamfox.co/themes/pleasure/app/admin1/ui-elements-social-buttons.html by HTTrack Website Copier/3.x [XR&CO'2013], Thu, 25 Jun 2015 06:32:43 GMT -->
<head>
	<meta charset="utf-8">
	<meta http-equiv="X-UA-Compatible" content="IE=edge">

	<title>PLEASURE - Social Buttons</title>
...
<body>
	...
	<div class="content">
		...
		<div class="page-header full-content bg-red">
			<div class="row">
				<div class="col-sm-6">
					<h1>Social Buttons <small>small description</small></h1>
				</div><!--.col-->
				<div class="col-sm-6">
					<ol class="breadcrumb">
						<li><a href="#"><i class="ion-home"></i></a></li>
						<li><a href="#">UI Elements</a></li>
						<li><a href="#" class="active">Social Buttons</a></li>
					</ol>
				</div><!--.col-->
			</div><!--.row-->
		</div><!--.page-header-->
			...
			<div class="col-md-12">
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>SOCIAL BUTTONS</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">

						<div class="row example-buttons">
							<div class="col-md-3">Default Buttons</div><!--.col-md-3-->
							<div class="col-md-9">
								<a class="btn btn-block btn-social btn-adn"><i class="fa fa-adn"></i> Sign in with App.net</a>
								...
								<a class="btn btn-block btn-social btn-microsoft"><i class="fa fa-windows"></i> Sign in with Microsoft</a>
								<a class="btn btn-block btn-social btn-openid"><i class="fa fa-openid"></i> Sign in with OpenID</a>
								<a class="btn btn-block btn-social btn-pinterest"><i class="fa fa-pinterest"></i> Sign in with Pinterest</a>
								<a class="btn btn-block btn-social btn-reddit"><i class="fa fa-reddit"></i> Sign in with Reddit</a>
								<a class="btn btn-block btn-social btn-soundcloud"><i class="fa fa-soundcloud"></i> Sign in with SoundCloud</a>
								...
								<a class="btn btn-block btn-social btn-vimeo"><i class="fa fa-vimeo-square"></i> Sign in with Vimeo</a>
								<a class="btn btn-block btn-social btn-vk"><i class="fa fa-vk"></i> Sign in with VK</a>
								<a class="btn btn-block btn-social btn-yahoo"><i class="fa fa-yahoo"></i> Sign in with Yahoo!</a>

							</div><!--.col-md-9-->
						</div><!--.row-->

						<div class="row example-buttons">
							<div class="col-md-3">Only Icons</div><!--.col-md-3-->
							<div class="col-md-9">
						...
						<div class="row example-buttons">
							...
							<div class="col-md-9">
								<a class="btn btn-block btn-lg btn-social btn-github"><i class="fa fa-github"></i> Sign in with GitHub</a>
								<a class="btn btn-block btn-social btn-github"><i class="fa fa-github"></i> Sign in with GitHub</a>
								<a class="btn btn-block btn-sm btn-social btn-github"><i class="fa fa-github"></i> Sign in with GitHub</a>
								<a class="btn btn-block btn-xs btn-social btn-github"><i class="fa fa-github"></i> Sign in with GitHub</a>
							</div><!--.col-md-9-->
						</div><!--.row-->
			...
			<ul>
				...
				<li>
					...
					<ul class="child-menu">
						...
						<li data-open-after="true"><a href="ui-elements-social-buttons.html">Social Buttons</a></li>
...
<!-- Mirrored from teamfox.co/themes/pleasure/app/admin1/ui-elements-social-buttons.html by HTTrack Website Copier/3.x [XR&CO'2013], Thu, 25 Jun 2015 06:32:44 GMT -->
</html>