...
<!-- Mirrored from teamfox.co/themes/pleasure/app/admin1/ui-elements-tabs.html by HTTrack Website Copier/3.x [XR&CO'2013], Thu, 25 Jun 2015 06:32:44 GMT -->
<head>
	<meta charset="utf-8">
	<meta http-equiv="X-UA-Compatible" content="IE=edge">

	<title>PLEASURE - Tabs</title>
...
<body>
	...
	<div class="content">
		...
		<div class="page-header full-content bg-red">
			<div class="row">
				<div class="col-sm-6">
					<h1>Tabs <small>short description</small></h1>
				</div><!--.col-->
				<div class="col-sm-6">
					<ol class="breadcrumb">
						<li><a href="#"><i class="ion-home"></i></a></li>
						<li><a href="#">UI Elements</a></li>
						<li><a href="#" class="active">Tabs</a></li>
					</ol>
				</div><!--.col-->
			</div><!--.row-->
		</div><!--.page-header-->
			...
			<div class="col-md-12">
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>TABS</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">

						<div class="row example-row">
							<div class="col-md-3">Default Tabs</div><!--.col-md-3-->
							<div class="col-md-9">
								...
								<ul class="nav nav-tabs" role="tablist">
									...
									<li class="dropdown">
										<a href="#" class="dropdown-toggle" data-toggle="dropdown">Dropdown <i class="fa fa-chevron-down"></i></a>
										<ul class="dropdown-menu" role="menu">
											<li><a href="#tab1_3" tabindex="-1" data-toggle="tab">Option 1</a></li>
											<li><a href="#tab1_4" tabindex="-1" data-toggle="tab">Option 2</a></li>
											<li><a href="#tab1_5" tabindex="-1" data-toggle="tab">Option 3</a></li>
											<li><a href="#tab1_6" tabindex="-1" data-toggle="tab">Option 4</a></li>
										</ul>
									</li>
								</ul>
						...
						<div class="row example-row">
							<div class="col-md-3">Right Aligned Tabs</div><!--.col-md-3-->
							<div class="col-md-9">

								<ul class="nav nav-tabs tabs-right-aligned" role="tablist">
									<li class="active"><a href="#tab2_1" data-toggle="tab">Home</a></li>
									<li><a href="#tab2_2" data-toggle="tab">Profile</a></li>
									<li><a href="#tab2_3" data-toggle="tab">Messages</a></li>
								</ul>
						...
						<div class="row example-row">
							<div class="col-md-3">Bottom Tabs</div><!--.col-md-3-->
							<div class="col-md-9">
								...
								<ul class="nav nav-tabs tabs-bottom tabs-right-aligned" role="tablist">
									<li class="active"><a href="#tab3_1" data-toggle="tab">Home</a></li>
									<li><a href="#tab3_2" data-toggle="tab">Profile</a></li>
									<li><a href="#tab3_2" data-toggle="tab">Messages</a></li>
								</ul>
						...
						<div class="row example-row">
							...
							<div class="col-md-9">
								...
								<ul class="nav nav-tabs nav-justified" role="tablist">
									<li class="active"><a href="#tab4_1" data-toggle="tab">Home</a></li>
									<li><a href="#tab4_2" data-toggle="tab">Profile</a></li>
									<li><a href="#tab4_3" data-toggle="tab">Messages</a></li>
								</ul>
								<div class="tab-content">
		...
		<div class="row">
			<div class="col-md-12">
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>STYLED TABS</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">
						...
						<div class="row no-gutters">
								...
								<div class="col-md-6">
									<div class="col-md-3">
										<ul class="nav nav-tabs tabs-left">
											<li class="active"><a href="#tab9_1" data-toggle="tab">Home</a></li>
											<li><a href="#tab9_2" data-toggle="tab">Profile</a></li>
											<li><a href="#tab9_3" data-toggle="tab">Messages</a></li>
										</ul>
									</div>
									<div class="col-md-9">
										<div class="tab-content">
							...
							<div class="styled-tabs tab-danger">
								<div class="col-md-6">
									<div class="col-md-9">
										<div class="tab-content">
											<div class="tab-pane active" id="tab10_1">
												<h5>Home</h5>
												<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries</p>
											</div>
											<div class="tab-pane" id="tab10_2">
												<h5>Profile</h5>
												<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries</p>
											</div>
											<div class="tab-pane" id="tab10_3">
												<h5>Messages</h5>
												<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries</p>
											</div>
										</div>
									...
									<div class="col-md-3">
										<ul class="nav nav-tabs tabs-right">
											<li class="active"><a href="#tab10_1" data-toggle="tab">Home</a></li>
											<li><a href="#tab10_2" data-toggle="tab">Profile</a></li>
											<li><a href="#tab10_3" data-toggle="tab">Messages</a></li>
										</ul>
									</div>
								</div><!--.col-md-6-->
							</div><!--.styled-tabs-->
		...
		<div class="row">
				...
				<div class="panel-group accordion" id="accordion">
					<div class="panel">
						<div class="panel-heading active">
							<a class="panel-title" data-toggle="collapse" data-parent="#accordion" href="#collapseOne">ACCORDION PANEL 1</a>
						</div>
					...
					<div class="panel">
						<div class="panel-heading">
							<a class="panel-title" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo">ACCORDION PANEL 2</a>
						</div>
					...
					<div class="panel">
						<div class="panel-heading">
							<a class="panel-title" data-toggle="collapse" data-parent="#accordion" href="#collapseThree">ACCORDION PANEL 3</a>
						</div>
			...
			<div class="col-md-6">
				<div class="panel-group toggle" id="accordion2">
					<div class="panel">
						<div class="panel-heading active">
							<a class="panel-title" data-toggle="collapse" href="#collapse4">TOGGLE PANEL 1</a>
						</div>
					...
					<div class="panel">
						<div class="panel-heading">
							<a class="panel-title" data-toggle="collapse" href="#collapse5">TOGGLE PANEL 2</a>
						</div>
					...
					<div class="panel">
						<div class="panel-heading">
							<a class="panel-title" data-toggle="collapse" href="#collapse6">TOGGLE PANEL 3</a>
						</div>
		...
		<div class="footer-links margin-top-40">
			<div class="row no-gutters">
				<div class="col-xs-6 bg-red">
					<a href="ui-elements-font-icons.html">
			...
			<ul>
				...
				<li>
					...
					<ul class="child-menu">
						...
						<li data-open-after="true"><a href="ui-elements-tabs.html">Tabs &amp; Accordions</a></li>
