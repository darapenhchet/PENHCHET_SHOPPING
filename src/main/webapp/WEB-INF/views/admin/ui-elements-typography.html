...
<!-- Mirrored from teamfox.co/themes/pleasure/app/admin1/ui-elements-typography.html by HTTrack Website Copier/3.x [XR&CO'2013], Thu, 25 Jun 2015 06:32:44 GMT -->
<head>
	<meta charset="utf-8">
	<meta http-equiv="X-UA-Compatible" content="IE=edge">

	<title>PLEASURE - Typography</title>
...
<body>
	...
	<div class="content">
		...
		<div class="page-header full-content bg-red">
			<div class="row">
				<div class="col-sm-6">
					<h1>Typography <small>short description</small></h1>
				</div><!--.col-->
				<div class="col-sm-6">
					<ol class="breadcrumb">
						<li><a href="#"><i class="ion-home"></i></a></li>
						<li><a href="#">UI Elements</a></li>
						<li><a href="#" class="active">Typography</a></li>
					</ol>
				</div><!--.col-->
			</div><!--.row-->
		</div><!--.page-header-->
			...
			<div class="col-md-12">
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>TYPOGRAPHY</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">

						<div class="row example-row">
							<div class="col-md-3">Headings</div><!--.col-md-3-->
							<div class="col-md-9">
								<h1>HEADING 1</h1>
								<h2>HEADING 2</h2>
								<h3>HEADING 3</h3>
						...
						<div class="row example-row">
							<div class="col-md-3">Drop Caps</div><!--.col-md-3-->
							<div class="col-md-9">
								<div class="row">
									<div class="col-md-6 margin-bottom-20">
										<span class="drop-caps drop-caps-default">M</span>auris eleifend est et turpis. Duis id erat. Suspendisse potenti. Aliquam vulputate, pede vel vehicula accumsan, mi neque rutrum erat, eu congue orci lorem eget lorem. Vestibulum non ante. Class aptent taciti sociosqu
									</div>
									<div class="col-md-6 margin-bottom-20">
										<span class="drop-caps drop-caps-primary">M</span>auris eleifend est et turpis. Duis id erat. Suspendisse potenti. Aliquam vulputate, pede vel vehicula accumsan, mi neque rutrum erat, eu congue orci lorem eget lorem. Vestibulum non ante. Class aptent taciti sociosqu
									</div>
									<div class="col-md-6 margin-bottom-20">
										<span class="drop-caps drop-caps-info">M</span>auris eleifend est et turpis. Duis id erat. Suspendisse potenti. Aliquam vulputate, pede vel vehicula accumsan, mi neque rutrum erat, eu congue orci lorem eget lorem. Vestibulum non ante. Class aptent taciti sociosqu
									</div>
									<div class="col-md-6 margin-bottom-20">
										<span class="drop-caps drop-caps-warning">M</span>auris eleifend est et turpis. Duis id erat. Suspendisse potenti. Aliquam vulputate, pede vel vehicula accumsan, mi neque rutrum erat, eu congue orci lorem eget lorem. Vestibulum non ante. Class aptent taciti sociosqu
									</div>
								</div>
							</div><!--.col-md-9-->
						</div><!--.row-->
						...
						<div class="row example-row">
							<div class="col-md-3">Blockquote</div><!--.col-md-3-->
							<div class="col-md-9">
								...
								<blockquote class="blockquote-danger pull-right">
									"Create an <i>okay</i> design and take a screenshot from an angle no one will ever see it at. Now add a lot of blur."
									<small>by <cite>Zach Inglis</cite></small>
								</blockquote>
						...
						<div class="row example-row">
							<div class="col-md-3">Alignments</div><!--.col-md-3-->
							<div class="col-md-9">
						...
						<div class="row example-row">
							<div class="col-md-3">Text States</div><!--.col-md-3-->
							<div class="col-md-9">
		...
		<div class="footer-links margin-top-40">
			<div class="row no-gutters">
				...
				<div class="col-xs-6 bg-red">
					<a href="ui-elements-loaders.html">
						<span class="state">UI Elements</span>
						<span>Loaders</span>
			...
			<ul>
				...
				<li>
					...
					<ul class="child-menu">
						...
						<li data-open-after="true"><a href="ui-elements-typography.html">Typography</a></li>
