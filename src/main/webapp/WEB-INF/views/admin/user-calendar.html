...
<!-- Mirrored from teamfox.co/themes/pleasure/app/admin1/user-calendar.html by HTTrack Website Copier/3.x [XR&CO'2013], Thu, 25 Jun 2015 06:36:27 GMT -->
<head>
	<meta charset="utf-8">
	<meta http-equiv="X-UA-Compatible" content="IE=edge">

	<title>PLEASURE - Calendar</title>
	...
	<!-- BEGIN PLUGINS CSS -->
	<link rel="stylesheet" href="../../assets/globals/plugins/fullcalendar/dist/fullcalendar.min.css">
...
<body>
	...
	<div class="content">
		...
		<div class="page-header full-content">
			<div class="row">
				<div class="col-sm-6">
					<h1>Calendar <small>short description</small></h1>
				</div><!--.col-->
				<div class="col-sm-6">
					<ol class="breadcrumb">
							...
							<div class="col-md-3">
								<div id="external-events">
									...
									<div class="draggable-events">
										<div class="fc-event"><span>Eat</span> <button type="button" class="close">&times;</button></div>
										<div class="fc-event"><span>Pray</span> <button type="button" class="close">&times;</button></div>
										<div class="fc-event"><span>Love</span> <button type="button" class="close">&times;</button></div>
										</div><!--.draggable-events-->
									<p>
					...
					<ul class="child-menu">
						<li>
							...
							<ul class="child-menu">
								...
								<li data-open-after="true"><a href="user-calendar.html">Calendar</a></li>
							</ul>
						</li>
	...
	<!-- BEGIN PLUGINS AREA -->
	<script src="../../assets/globals/plugins/fullcalendar/dist/fullcalendar.min.js"></script>
	<!-- END PLUGINS AREA -->

	<!-- PLUGINS INITIALIZATION AND SETTINGS -->
	<script src="../../assets/globals/scripts/calendar.js"></script>
...
<!-- Mirrored from teamfox.co/themes/pleasure/app/admin1/user-calendar.html by HTTrack Website Copier/3.x [XR&CO'2013], Thu, 25 Jun 2015 06:36:28 GMT -->
</html>