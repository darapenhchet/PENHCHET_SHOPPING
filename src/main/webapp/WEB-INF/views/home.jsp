...
<head>
	...
	<title>PENHCHET SHOPPING - One Page Parallax</title>
	...
	* To change the hover link color and active selector border color,
	...
	<div class="header">
		<div class="container">
			...
			<div class="logo">
				<img src="${pageContext.request.contextPath}/resources/assets/one-page-parallax/img/logo.jpg" alt="Pleasure">
			</div><!--.logo-->
			...
			* data-anchor="slide1" attribute is useful when user clicks the data-nav-link, the window moves the related slide.
			...
			<div class="btn-action">
				<a href="login" class="btn btn-indigo" target="_blank">LOGIN</a>
			</div><!--.btn-action-->
	...
	* data-nav="remove" attribute hides the active navigation border when this slide in viewport.
	...
	<div class="slide bg-image" data-nav="remove" style="background-image: url('${pageContext.request.contextPath}/resources/assets/one-page-parallax/img/bg-hero.jpg');">
		...
		<div class="container">
			<div class="row">
				<div class="col-md-9">
					<h1 class="text-indigo text-light-shadow">GET THE MOST <span data-typer-targets="UNIQUE, ADVANCED, ESSENTIAL">ADVANCED</span><br>THEME WITH PLEASURE.</h1>
					<p class="caption text-light-shadow">Pleasure offers lots of cards, plugins, color options and various layouts.<br>Buy it on ThemeForest and create your pages today!</p>
				</div><!--.col-->
			</div><!--.row-->
	...
	* data-nav="slide1" attribute is an identifier for data-nav-links.
	...
	<div class="footer bg-black">
		<div class="container">
			...
			<div class="copyright v-text">PENHCHET SHOPPING &copy; 2015</div>
